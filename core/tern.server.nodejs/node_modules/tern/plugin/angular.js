    ...
    function gather(prop, obj, depth, useObjAsVal) {
      ...
      for (var i = 0; i < completions.length; ++i) {
        ...
        if ((wrapAsObjs ? c.name : c) == prop) {
          if (c.type === '?' || c.type === '[?]') {
            var val = obj;
            if (!useObjAsVal) val = obj ? obj.props[prop] : infer.ANull;
            infer.resetGuessing();
      ...
      //if (query.types || query.docs || query.urls || query.origins) {
        var val = useObjAsVal ? obj : obj.props[prop];
        ...
        for ( var prop in scopeProps) {
          if (startsWithString(prop, word)) {
            ...
            if (!scopeProps[prop].repeat) {
              ...
              //    controllerName));
              gather(prop, null, null);
            }
            //if (obj)
            //infer.forAllPropertiesOf(obj.type ? obj.type : obj, gather);
          }
        }
      }
