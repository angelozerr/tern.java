(function(mod) {
  ...
  function findCompletions(_angular, files, expression, scope, angularType,
    ...
    function createCompletionIfMatch(prop, obj) {
      if (startsWithString(prop, word)) {
        completions.push(createCompletion(prop, obj, scope, query));
      }
    }
  ...
  function createCompletion(name, node, scope, query) {
	  ...
	  if (scope) {
	    if (scope.module) completion.module = scope.module;
	    if (scope.controller) completion.controller = scope.controller;
	  }
  	  return completion;
  }
