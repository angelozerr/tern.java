(function(mod) {
     ...
     if (module) {
       ...
       for (var fieldName in fields) {
           ...
           if (field.type === "controller") {
        	   controllers.push({name: fieldName, field : field});
           }         
       }
     }
	 return controllers;
  ...
  function getLocalControllers(file) {
	  var controllers = [];
  ...
  function findControllers(_angular, file, completions, expression, scope) {
	  ...
	  if (moduleName) {
		...
		controllers = getModuleControllers(moduleName, _angular);		
		 ...
		 controllers = getLocalControllers(file);		  
	  }
  ...
  function findModels(_angular, file, completions, expression, scope) {
	  var moduleName = scope.module;
    ...
    run : function(server, query, file) {
      ...
      switch (angularType) {
		...
		case 'controller':
			// find controller
			findControllers(_angular, file, completions, expression, scope);
			break;
		default:
			findModels(_angular, file, completions, expression, scope);
			break;
      }
      return result;
    }
