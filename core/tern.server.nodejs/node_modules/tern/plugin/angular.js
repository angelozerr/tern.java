(function(mod) {
  ...
  function findCompletions(_angular, files, expression, scope, angularType,
    ...
    default:
      ...
      var moduleName = scope.module, controllers = scope.controllers, scopeProps = scope.props;
      if (controllers) {
          ...
          if (context) {
            ...
            for ( var i = 0; i < context.length; i++) {
              ...
              if (scopeProps && scopeProps[prop] && scopeProps[prop].repeat) {
                ...
                if (arr && arr.type) root = arr.type.getProp("<i>").getType();
              } else {
        ...
        for ( var prop in scopeProps) {
          if (startsWithString(prop, word)) {
            ...
            if (scopeProps[prop].repeat) {
              ...
              if (arr && arr.type) obj = arr.type.getProp("<i>").getType();
            }
