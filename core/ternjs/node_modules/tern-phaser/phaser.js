(function(mod) {
 ...
 "<anonymous>": {
  ...
  "AABB": {
   "!type": "fn(options: ?)",
   "!doc": "Axis aligned bounding box class."
  },
  "Broadphase": {
   "!type": "fn()",
   "!doc": "Base class for broadphase implementations."
  },
  "NaiveBroadphase": {
   "!type": "fn()",
   "!doc": "Naive broadphase implementation. Does N^2 tests."
  },
  "Narrowphase": {
   "!type": "fn()",
   "!doc": "Narrowphase. Creates contacts and friction given shapes and transforms."
  },
  "Ray": {
   "!type": "fn(options: +anonymousRayOptions)",
   "!doc": "A line with a start and end point that is used to intersect shapes. For an example, see {{#crossLink \"World/raycast:method\"}}World.raycast{{/crossLink}}"
  },
  "RaycastResult": {
   "!type": "fn()",
   "!doc": "Storage for Ray casting hit data."
  },
  "SAPBroadphase": {
   "!type": "fn()",
   "!doc": "Sweep and prune broadphase along one axis."
  },
  "Constraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, type: number, options: ?)",
   "!doc": "Base constraint class."
  },
  "DistanceConstraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: +anonymousDistanceConstraintOptions)",
   "!doc": "Constraint that tries to keep the distance between two bodies constant."
  },
  "GearConstraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "Constrains the angle of two bodies to each other to be equal. If a gear ratio is not one, the angle of bodyA must be a multiple of the angle of bodyB."
  },
  "LockConstraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "Locks the relative position and rotation between two bodies."
  },
  "PrismaticConstraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "Constraint that only allows bodies to move along a line, relative to each other. See <a href=\"http://www.iforce2d.net/b2dtut/joints-prismatic\">this tutorial</a>. Also called \"slider constraint\"."
  },
  "RevoluteConstraint": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "Connects two bodies at given offset points, letting them rotate relative to each other around this point."
  ...
  "AngleLockEquation": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "Locks the relative angle between two bodies. The constraint tries to keep the dot product between two vectors, local in each body, to zero. The local angle in body i is a parameter."
  },
  "ContactEquation": {
   "!type": "fn(bodyA: +Body, bodyB: +Body)",
   "!doc": "Non-penetration constraint equation. Tries to make the contactPointA and contactPointB vectors coincide, while keeping the applied force repulsive."
  },
  "Equation": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, minForce: number, maxForce: number)",
   "!doc": "Base class for constraint equations."
  },
  "FrictionEquation": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, slipForce: number)",
   "!doc": "Constrains the slipping in a contact along a tangent"
  },
  ...
  "RotationalVelocityEquation": {
   "!type": "fn(bodyA: +Body, bodyB: +Body)",
   "!doc": "Syncs rotational velocity of two bodies, or sets a relative velocity (motor)."
  },
  "EventEmitter": {
   "!type": "fn()",
   "!doc": "Base class for objects that dispatches events."
  },
  "ContactMaterial": {
   "!type": "fn(materialA: +Material, materialB: +Material, options: ?)",
   "!doc": "Defines what happens when two materials meet, such as what friction coefficient to use. You can also set other things such as restitution, surface velocity and constraint parameters."
  },
  "Material": {
   "!type": "fn(id: number)",
   "!doc": "Defines a physics material."
  ...
  "Body": {
   "!type": "fn(, options: ?)",
   "!doc": "A rigid body. Has got a center of mass, position, velocity and a number of\nshapes that are used for collisions."
  },
  "LinearSpring": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "A spring, connecting two bodies.\n\nThe Spring explicitly adds force and angularForce to the bodies."
  },
  "RotationalSpring": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "A rotational spring, connecting two bodies rotation. This spring explicitly adds angularForce (torque) to the bodies.\n\nThe spring can be combined with a {{#crossLink \"RevoluteConstraint\"}}{{/crossLink}} to make, for example, a mouse trap."
  },
  "Spring": {
   "!type": "fn(bodyA: +Body, bodyB: +Body, options: ?)",
   "!doc": "A spring, connecting two bodies. The Spring explicitly adds force and angularForce to the bodies and does therefore not put load on the constraint solver."
  },
  "TopDownVehicle": {
  ...
  "Capsule": {
   ...
   "!doc": "Capsule shape class."
  },
  "Circle": {
   "!type": "fn(options: +options)",
   "!doc": "Circle shape class."
  },
  "Convex": {
   "!type": "fn(options: +anonymousConvexOptions)",
   "!doc": "Convex shape class."
  },
  "Heightfield": {
   "!type": "fn(options: +anonymousHeightfieldOptions)",
   "!doc": "Heightfield shape class. Height data is given as an array. These data points are spread out evenly with a distance \"elementWidth\"."
  },
  "Line": {
   "!type": "fn(options: +anonymousLineOptions)",
   "!doc": "Line shape class. The line shape is along the x direction, and stretches from [-length/2, 0] to [length/2,0]."
  },
  "Particle": {
   "!type": "fn(options: ?)",
   "!doc": "Particle shape class."
  },
  "Plane": {
   "!type": "fn(options: ?)",
   "!doc": "Plane shape class. The plane is facing in the Y direction."
  },
  "Shape": {
   "!type": "fn(options: +anonymousShapeOptions)",
   "!doc": "Base class for shapes."
  },
  "GSSolver": {
   "!type": "fn(options: ?)",
   "!doc": "Iterative Gauss-Seidel constraint equation solver."
  },
  "Solver": {
   "!type": "fn()",
   "!doc": "Base class for constraint solvers."
  },
  "ContactEquationPool": {
   "!type": "fn()"
  },
  ...
  "OverlapKeeper": {
   "!type": "fn()",
   "!doc": "Keeps track of overlaps in the current state and the last step state."
  },
  "OverlapKeeperRecord": {
   "!type": "fn(bodyA: +Body, shapeA: +Shape, bodyB: +Body, shapeB: +Shape)",
   "!doc": "Overlap data container for the OverlapKeeper"
  },
  ...
  "Island": {
   "!type": "fn()",
   "!doc": "An island of bodies connected with equations."
  },
  "IslandManager": {
   "!type": "fn(options: ?)",
   "!doc": "Splits the system of bodies and equations into independent islands"
  },
  "IslandNode": {
   "!type": "fn(body: +Body)",
   "!doc": "Holds a body and keeps track of some additional properties needed for graph traversal."
  },
  "World": {
   "!type": "fn(options: ?)",
   "!doc": "The dynamics world, where all bodies and constraints live."
  }
 },
 "<anonymous>~Polygon": {
  "prototype": {
