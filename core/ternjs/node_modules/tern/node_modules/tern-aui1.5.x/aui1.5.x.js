  ...
  "_yui": {
   ...
   "aui_datatype": {
    ...
    "DatepickerManager": {
     ...
     "!url": "http://alloyui.com/versions/1.5.x/api/classes/DatepickerManager.html"
    }
   },
   "aui_delayed_task": {
    "DelayedTask": {
     "!type": "fn(config: +yui.Object, fn: fn(), scope: +yui.Object, args: ?)",
   ...
   "aui_io": {
    "A": {
     ...
     "io": {
      ...
      "prototype": {
       "A.io.request": {
        "!type": "fn(uri: string, config: +yui.Object) -> +aui_io.IORequest",
   ...
   "aui_toolbar": {
    "Toolbar": {
     ...
     "!url": "http://alloyui.com/versions/1.5.x/api/classes/Toolbar.html"
    }
   },
   "aui_tooltip": {
    "Tooltip": {
