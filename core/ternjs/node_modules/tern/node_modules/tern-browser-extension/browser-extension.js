(function(root, mod) {
  ...
  function findCompletions(file, query) {
    ...
    var text = argNode.raw, quote = text.charAt(0);
    ...
    var completions = [];
    completionType.complete(completions, query, file, word, text, wordStart);
  ...
  function completeCSSSelectors(completions, query, file, word, text, wordStart) {
    var hasHash = text.charAt(wordStart + 1) == "#";
