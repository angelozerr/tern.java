...
import tern.server.protocol.angular.AbstractAngularModelDefinitionTest;

public class NodejsAngularModelDefinitionTest extends
		AbstractAngularModelDefinitionTest {
