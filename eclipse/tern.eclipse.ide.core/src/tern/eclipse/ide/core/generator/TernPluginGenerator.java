package tern.eclipse.ide.core.generator;
...
public class TernPluginGenerator implements IGenerator
 {
  ...
  protected final String TEXT_1 = "(function(mod) {" + NL + "  if (typeof exports == \"object\" && typeof module == \"object\") // CommonJS" + NL + "    return mod(require(\"../lib/infer\"), require(\"../lib/tern\"));" + NL + "  if (typeof define == \"function\" && define.amd) // AMD" + NL + "    return define([ \"../lib/infer\", \"../lib/tern\" ], mod);" + NL + "  mod(tern, tern);" + NL + "})(function(infer, tern) {" + NL + "  \"use strict\";" + NL + "" + NL + "  tern.registerPlugin(\"";
