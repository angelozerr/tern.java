...
(function(k){function m(a,b){var e,j,w,x,f,l,c,d,o,h=b&&b.split("/"),g=q.map,n=g&&g["*"]||{};if(a&&a.charAt(0)===".")if(b){h=h.slice(0,h.length-1);a=h.concat(a.split("/"));for(d=0;d<a.length;d+=1)if(e=a[d],e===".")a.splice(d,1),d-=1;else if(e==="..")if(d===1&&(a[2]===".."||a[0]===".."))break;else d>0&&(a.splice(d-1,2),d-=2);a=a.join("/")}else a.indexOf("./")===0&&(a=a.substring(2));if((h||n)&&g){e=a.split("/");for(d=e.length;d>0;d-=1){j=e.slice(0,d).join("/");if(h)for(o=h.length;o>0;o-=1)if(w=g[h.slice(0,
o).join("/")])if(w=w[j]){x=w;f=d;break}if(x)break;!l&&n&&n[j]&&(l=n[j],c=d)}!x&&l&&(x=l,f=c);x&&(e.splice(0,f,x),a=e.join("/"))}return a}function p(a,e){return function(){return b.apply(k,s.call(arguments,0).concat([a,e]))}}function i(a){return function(b){return m(b,a)}}function c(a){return function(b){l[a]=b}}function d(a){if(n.call(o,a)){var b=o[a];delete o[a];r[a]=!0;g.apply(k,b)}if(!n.call(l,a)&&!n.call(r,a))throw Error("No "+a);return l[a]}function f(a){var b,e=a?a.indexOf("!"):-1;e>-1&&(b=
a.substring(0,e),a=a.substring(e+1,a.length));return[b,a]}function h(a){return function(){return q&&q.config&&q.config[a]||{}}}var g,b,a,e,l={},o={},q={},r={},n=Object.prototype.hasOwnProperty,s=[].slice;a=function(a,b){var e,j=f(a),w=j[0],a=j[1];w&&(w=m(w,b),e=d(w));w?a=e&&e.normalize?e.normalize(a,i(b)):m(a,b):(a=m(a,b),j=f(a),w=j[0],a=j[1],w&&(e=d(w)));return{f:w?w+"!"+a:a,n:a,pr:w,p:e}};e={require:function(a){return p(a)},exports:function(a){var b=l[a];return typeof b!=="undefined"?b:l[a]={}},
module:function(a){return{id:a,uri:"",exports:l[a],config:h(a)}}};g=function(b,f,h,j){var w,x,D,y,g=[],q,j=j||b;if(typeof h==="function"){f=!f.length&&h.length?["require","exports","module"]:f;for(y=0;y<f.length;y+=1)if(D=a(f[y],j),x=D.f,x==="require")g[y]=e.require(b);else if(x==="exports")g[y]=e.exports(b),q=!0;else if(x==="module")w=g[y]=e.module(b);else if(n.call(l,x)||n.call(o,x)||n.call(r,x))g[y]=d(x);else if(D.p)D.p.load(D.n,p(j,!0),c(x),{}),g[y]=l[x];else throw Error(b+" missing "+x);f=h.apply(l[b],
g);if(b)if(w&&w.exports!==k&&w.exports!==l[b])l[b]=w.exports;else if(f!==k||!q)l[b]=f}else b&&(l[b]=h)};requirejs=require=b=function(f,l,c,j,w){if(typeof f==="string")return e[f]?e[f](l):d(a(f,l).f);else f.splice||(q=f,l.splice?(f=l,l=c,c=null):f=k);l=l||function(){};typeof c==="function"&&(c=j,j=w);j?g(k,f,l,c):setTimeout(function(){g(k,f,l,c)},4);return b};b.config=function(a){q=a;return b};define=function(a,b,e){b.splice||(e=b,b=[]);!n.call(l,a)&&!n.call(o,a)&&(o[a]=[a,b,e])};define.amd={jQuery:!0}})();
define("almond",function(){});
define("orion/editor/shim",[],function(){if(!Object.create)Object.create=function(k,m){function p(){}p.prototype=k;var i=new p;if(m)for(var c in m)m.hasOwnProperty(c)&&(i[c]=m[c].hasOwnProperty("value")?m[c].value:function(){if(arguments.length>0)return m[c].get();else m[c].set(arguments)});return i};if(!Object.keys)Object.keys=function(k){var m=[],p;for(p in k)k.hasOwnProperty(p)&&m.push(p);return m};if(!Function.prototype.bind)Function.prototype.bind=function(k){var m=this,p=Array.prototype.slice.call(arguments,
1);return p.length?function(){return arguments.length?m.apply(k,p.concat(Array.prototype.slice.call(arguments))):m.apply(k,p)}:function(){return arguments.length?m.apply(k,arguments):m.call(k)}};if(!Array.isArray)Array.isArray=function(k){return Object.prototype.toString.call(k)==="[object Array]"};if(!Array.prototype.indexOf)Array.prototype.indexOf=function(k){for(var m=0;m<this.length;m++)if(this[m]===k)return m;return-1};if(!Array.prototype.forEach)Array.prototype.forEach=function(k){for(var m=
0;m<this.length;m++)k(this[m],m)};if(!Array.prototype.map)Array.prototype.map=function(k){for(var m=Array(this.length),p=0;p<this.length;p++)m[p]=k(this[p]);return m};if(!Array.prototype.reduce)Array.prototype.reduce=function(k,m){var p,i=!1;1<arguments.length&&(p=m,i=!0);for(var c=0;this.length>c;++c)i?p=k(p,this[c],c,this):(p=this[c],i=!0);return p};if(!String.prototype.trim)String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")};if(!String.prototype.trimLeft)String.prototype.trimLeft=
...
(function(){function k(c,d,f,h,g,b){d[c]&&(f.push(c),(d[c]===!0||d[c]===1)&&h.push(g+c+"/"+b))}function m(c,d,f,h,g){d=h+d+"/"+g;require._fileExists(c.toUrl(d+".js"))&&f.push(d)}function p(c,d,f){for(var h in d)d.hasOwnProperty(h)&&(!c.hasOwnProperty(h)||f)?c[h]=d[h]:typeof d[h]==="object"&&p(c[h],d[h],f)}var i=/(^.*(^|\/)nls(\/|$))([^\/]*)\/?([^\/]*)/;define("i18n",["module"],function(c){var d=c.config?c.config():{};return{version:"2.0.1+",load:function(f,c,g,b){b=b||{};if(b.locale)d.locale=b.locale;
var a=i.exec(f),e=a[1],l=a[4],o=a[5],q=l.split("-"),r=[],n={},s,u="";if(a[5])e=a[1],f=e+o;else{o=a[4];l=d.locale;if(!l)l=d.locale=typeof navigator==="undefined"?"root":(navigator.language||navigator.userLanguage||"root").toLowerCase();q=l.split("-")}if(b.isBuild){r.push(f);m(c,"root",r,e,o);for(s=0;s<q.length;s++)b=q[s],u+=(u?"-":"")+b,m(c,u,r,e,o);c(r,function(){g()})}else c([f],function(a){var b=[],j;k("root",a,b,r,e,o);for(s=0;s<q.length;s++)j=q[s],u+=(u?"-":"")+j,k(u,a,b,r,e,o);c(r,function(){var j,
x,f;for(j=b.length-1;j>-1&&b[j];j--){f=b[j];x=a[f];if(x===!0||x===1)x=c(e+f+"/"+o);p(n,x)}g(n)})})}}})})();define("orion/editor/i18n",{load:function(k,m,p){m.specified&&m.specified("orion/bootstrap")?m(["orion/i18n!"+k],function(i){p(i)}):p({})}});
...
define("orion/editor/nls/messages",["orion/editor/i18n!orion/editor/nls/messages","orion/editor/nls/root/messages"],function(k,m){var p={root:m},i;for(i in k)k.hasOwnProperty(i)&&typeof p[i]==="undefined"&&(p[i]=k[i]);return p});
define("orion/editor/eventTarget",[],function(){function k(){}k.addMixin=function(m){var p=k.prototype,i;for(i in p)p.hasOwnProperty(i)&&(m[i]=p[i])};k.prototype={addEventListener:function(k,p,i){if(!this._eventTypes)this._eventTypes={};var c=this._eventTypes[k];c||(c=this._eventTypes[k]={level:0,listeners:[]});c.listeners.push({listener:p,useCapture:i})},dispatchEvent:function(k){var p=k.type;this._dispatchEvent("pre"+p,k);this._dispatchEvent(p,k);this._dispatchEvent("post"+p,k)},_dispatchEvent:function(k,
p){var i=this._eventTypes?this._eventTypes[k]:null;if(i){var c=i.listeners;try{if(i.level++,c)for(var d=0,f=c.length;d<f;d++)if(c[d]){var h=c[d].listener;typeof h==="function"?h.call(this,p):h.handleEvent&&typeof h.handleEvent==="function"&&h.handleEvent(p)}}finally{if(i.level--,i.compact&&i.level===0){for(d=c.length-1;d>=0;d--)c[d]||c.splice(d,1);c.length===0&&delete this._eventTypes[k];i.compact=!1}}}},isListening:function(k){return!this._eventTypes?!1:this._eventTypes[k]!==void 0},removeEventListener:function(k,
p,i){if(this._eventTypes){var c=this._eventTypes[k];if(c){for(var d=c.listeners,f=0,h=d.length;f<h;f++){var g=d[f];if(g&&g.listener===p&&g.useCapture===i){c.level!==0?(d[f]=null,c.compact=!0):d.splice(f,1);break}}d.length===0&&delete this._eventTypes[k]}}}};return{EventTarget:k}});define("orion/regex",[],function(){return{escape:function(k){return k.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&")},parse:function(k){return(k=/^\s*\/(.+)\/([gim]{0,3})\s*$/.exec(k))?{pattern:k[1],flags:k[2]}:null}}});
define("orion/util",[],function(){var k=navigator.userAgent,m=k.indexOf("MSIE")!==-1||k.indexOf("Trident")!==-1?document.documentMode:void 0,p=parseFloat(k.split("Firefox/")[1]||k.split("Minefield/")[1])||void 0,i=k.indexOf("Opera")!==-1?parseFloat(k.split("Version/")[1]):void 0,c=parseFloat(k.split("Chrome/")[1])||void 0,d=k.indexOf("Safari")!==-1&&!c,f=parseFloat(k.split("WebKit/")[1])||void 0,h=k.indexOf("Android")!==-1,g=k.indexOf("iPad")!==-1,k=k.indexOf("iPhone")!==-1,b=g||k,a=navigator.platform.indexOf("Mac")!==
-1,e=navigator.platform.indexOf("Win")!==-1,l=navigator.platform.indexOf("Linux")!==-1,o="ontouchstart"in document.createElement("input");return{formatMessage:function(a){var b=arguments;return a.replace(/\$\{([^\}]+)\}/g,function(a,e){return b[(e<<0)+1]})},createElement:function(a,b){return a.createElementNS?a.createElementNS("http://www.w3.org/1999/xhtml",b):a.createElement(b)},isIE:m,isFirefox:p,isOpera:i,isChrome:c,isSafari:d,isWebkit:f,isAndroid:h,isIPad:g,isIPhone:k,isIOS:b,isMac:a,isWindows:e,
isLinux:l,isTouch:o,platformDelimiter:e?"\r\n":"\n"}});
define("orion/editor/textModel",["orion/editor/eventTarget","orion/regex","orion/util"],function(k,m,p){function i(c,d){this._lastLineIndex=-1;this._text=[""];this._lineOffsets=[0];this.setText(c);this.setLineDelimiter(d)}i.prototype={destroy:function(){},find:function(c){if(this._text.length>1)this._text=[this._text.join("")];var d=c.string,f=c.regex,h=d,g="",b=c.caseInsensitive;if(h)if(f){if(d=m.parse(h))h=d.pattern,g=d.flags}else h=d.replace(/([\\$\^*\/+?\.\(\)|{}\[\]])/g,"\\$&"),b&&(h=h.replace(/[iI\u0130\u0131]/g,
"[Ii\u0130\u0131]"));var a=null,e;if(h){var d=c.reverse,l=c.wrap,f=c.wholeWord,o=c.start||0,c=c.end,q=c!==null&&c!==void 0;g.indexOf("g")===-1&&(g+="g");g.indexOf("m")===-1&&(g+="m");b&&g.indexOf("i")===-1&&(g+="i");f&&(h="\\b"+h+"\\b");var i=this._text[0],n,s,u=0;q&&(b=o<c?o:c,i=i.substring(b,o<c?c:o),u=b);var t=RegExp(h,g);if(d)e=function(){var a=null;for(t.lastIndex=0;;){s=t.lastIndex;n=t.exec(i);if(s===t.lastIndex)return null;if(n){if(!(n.index+u<o)){if(!l||a)break;o=i.length+u}a={start:n.index+
u,end:t.lastIndex+u}}else break}if(a)o=a.start;return a};else{if(!q)t.lastIndex=o;e=function(){for(;;){s=t.lastIndex;n=t.exec(i);if(s===t.lastIndex)break;if(n)return{start:n.index+u,end:t.lastIndex+u};if(!(s!==0&&l))break}return null}}a=e()}return{next:function(){var b=a;b&&(a=e());return b},hasNext:function(){return a!==null}}},getCharCount:function(){for(var c=0,d=0;d<this._text.length;d++)c+=this._text[d].length;return c},getLine:function(c,d){var f=this.getLineCount();if(!(0<=c&&c<f))return null;
var h=this._lineOffsets[c];if(c+1<f){f=this.getText(h,this._lineOffsets[c+1]);if(d)return f;for(var h=f.length,g;(g=f.charCodeAt(h-1))===10||g===13;)h--;return f.substring(0,h)}else return this.getText(h)},getLineAtOffset:function(c){var d=this.getCharCount();if(!(0<=c&&c<=d))return-1;var f=this.getLineCount();if(c===d)return f-1;var h,g,b=this._lastLineIndex;if(0<=b&&b<f&&(h=this._lineOffsets[b],g=b+1<f?this._lineOffsets[b+1]:d,h<=c&&c<g))return b;for(var a=f,e=-1;a-e>1;)if(b=Math.floor((a+e)/2),
h=this._lineOffsets[b],g=b+1<f?this._lineOffsets[b+1]:d,c<=h)a=b;else if(c<g){a=b;break}else e=b;return this._lastLineIndex=a},getLineCount:function(){return this._lineOffsets.length},getLineDelimiter:function(){return this._lineDelimiter},getLineEnd:function(c,d){var f=this.getLineCount();if(!(0<=c&&c<f))return-1;if(c+1<f){f=this._lineOffsets[c+1];if(d)return f;for(var h=this.getText(Math.max(this._lineOffsets[c],f-2),f),g=h.length,b;(b=h.charCodeAt(g-1))===10||b===13;)g--;return f-(h.length-g)}else return this.getCharCount()},
getLineStart:function(c){return!(0<=c&&c<this.getLineCount())?-1:this._lineOffsets[c]},getText:function(c,d){c===void 0&&(c=0);d===void 0&&(d=this.getCharCount());if(c===d)return"";for(var f=0,h=0,g;h<this._text.length;){g=this._text[h].length;if(c<=f+g)break;f+=g;h++}for(var b=f,a=h;h<this._text.length;){g=this._text[h].length;if(d<=f+g)break;f+=g;h++}if(a===h)return this._text[a].substring(c-b,d-f);b=this._text[a].substring(c-b);f=this._text[h].substring(0,d-f);return b+this._text.slice(a+1,h).join("")+
f},onChanging:function(c){return this.dispatchEvent(c)},onChanged:function(c){return this.dispatchEvent(c)},setLineDelimiter:function(c,d){c==="auto"&&(c=void 0,this.getLineCount()>1&&(c=this.getText(this.getLineEnd(0),this.getLineEnd(0,!0))));this._lineDelimiter=c?c:p.platformDelimiter;if(d){var f=this.getLineCount();if(f>1){for(var h=Array(f),g=0;g<f;g++)h[g]=this.getLine(g);this.setText(h.join(this._lineDelimiter))}}},setText:function(c,d,f){c===void 0&&(c="");d===void 0&&(d=0);f===void 0&&(f=
this.getCharCount());if(!(d===f&&c==="")){for(var h=this.getLineAtOffset(d),g=this.getLineAtOffset(f),b=d,a=f-d,e=g-h,l=c.length,o=0,q=this.getLineCount(),i=0,n=0,s=0,u=[];;){i!==-1&&i<=s&&(i=c.indexOf("\r",s));n!==-1&&n<=s&&(n=c.indexOf("\n",s));if(n===-1&&i===-1)break;s=i!==-1&&n!==-1?i+1===n?n+1:(i<n?i:n)+1:i!==-1?i+1:n+1;u.push(d+s);o++}this.onChanging({type:"Changing",text:c,start:b,removedCharCount:a,addedCharCount:l,removedLineCount:e,addedLineCount:o});u.length===0&&(s=this.getLineStart(h),
g=g+1<q?this.getLineStart(g+1):this.getCharCount(),d!==s&&(c=this.getText(s,d)+c,d=s),f!==g&&(c+=this.getText(f,g),f=g));s=l-a;for(g=h+e+1;g<q;g++)this._lineOffsets[g]+=s;if(u.length<5E4)h=[h+1,e].concat(u),Array.prototype.splice.apply(this._lineOffsets,h);else{s=h+1;this._lineOffsets.splice(s,e);for(q=0;q<u.length;q+=5E4)h=[s,0].concat(u.slice(q,Math.min(u.length,q+5E4))),Array.prototype.splice.apply(this._lineOffsets,h),s+=5E4}for(s=q=0;s<this._text.length;){g=this._text[s].length;if(d<=q+g)break;
q+=g;s++}h=q;for(u=s;s<this._text.length;){g=this._text[s].length;if(f<=q+g)break;q+=g;s++}g=this._text[s];d=this._text[u].substring(0,d-h);f=g.substring(f-q);u=[u,s-u+1];d&&u.push(d);c&&u.push(c);f&&u.push(f);Array.prototype.splice.apply(this._text,u);if(this._text.length===0)this._text=[""];this.onChanged({type:"Changed",start:b,removedCharCount:a,addedCharCount:l,removedLineCount:e,addedLineCount:o})}}};k.EventTarget.addMixin(i.prototype);return{TextModel:i}});
define("orion/keyBinding",["orion/util"],function(k){function m(i,c,d,f,h,g){this.type=g||"keydown";this.keyCode=typeof i==="string"&&this.type==="keydown"?i.toUpperCase().charCodeAt(0):i;this.mod1=c!==void 0&&c!==null?c:!1;this.mod2=d!==void 0&&d!==null?d:!1;this.mod3=f!==void 0&&f!==null?f:!1;this.mod4=h!==void 0&&h!==null?h:!1}function p(i){this.keys=i}m.prototype={getKeys:function(){return[this]},match:function(i,c){if(c!==void 0){if(c!==0)return!1}else if(i instanceof Array){if(i.length>1)return!1;
i=i[0]}return i.type!==this.type?!1:this.keyCode===i.keyCode||this.keyCode===String.fromCharCode(k.isOpera?i.which:i.charCode!==void 0?i.charCode:i.keyCode)?this.mod1!==(k.isMac?i.metaKey:i.ctrlKey)?!1:this.type==="keydown"&&this.mod2!==i.shiftKey?!1:this.mod3!==i.altKey?!1:k.isMac&&this.mod4!==i.ctrlKey?!1:!0:!1},equals:function(i){return!i?!1:this.keyCode!==i.keyCode?!1:this.mod1!==i.mod1?!1:this.mod2!==i.mod2?!1:this.mod3!==i.mod3?!1:this.mod4!==i.mod4?!1:this.type!==i.type?!1:!0}};p.prototype=
...
KeySequence:p}});
define("orion/editor/keyModes",["orion/keyBinding","orion/util"],function(k,m){function p(c){if(c)this._view=c,this._keyBindings=this.createKeyBindings(),this._keyBindingIndex=0}function i(c){p.call(this,c)}p.prototype={createKeyBindings:function(){return[]},getKeyBindings:function(c){for(var d=[],f=this._keyBindings,h=0;h<f.length;h++)f[h].actionID===c&&d.push(f[h].keyBinding);return d},getView:function(){return this._view},isActive:function(){return this._view.getKeyModes().indexOf(this)!==-1},
match:function(c){if(c.type==="keydown")switch(c.keyCode){case 16:case 17:case 18:case 91:return}for(var d=this._keyBindingIndex,f=this._matchingKeyBindings||this._keyBindings,h=[],g=0;g<f.length;g++){var b=f[g],a=b.keyBinding.match(c,d);if(a===!0)return this._keyBindingIndex=0,this._matchingKeyBindings=null,b.actionID;else typeof a==="number"&&h.push(b)}if(h.length===0)this._keyBindingIndex=0,this._matchingKeyBindings=null;else return this._keyBindingIndex++,this._matchingKeyBindings=h,"noop"},setKeyBinding:function(c,
d){for(var f=this._keyBindings,h=0;h<f.length;h++){var g=f[h];if(g.keyBinding.equals(c)){d?g.actionID=d:g.predefined?g.actionID="noop":f.splice(h,1);return}}d&&f.push({keyBinding:c,actionID:d})},setView:function(c){this._view=c}};i.prototype=new p;i.prototype.createKeyBindings=function(){var c=k.KeyBinding,d=[];d.push({actionID:"lineUp",keyBinding:new c(38),predefined:!0});d.push({actionID:"lineDown",keyBinding:new c(40),predefined:!0});d.push({actionID:"charPrevious",keyBinding:new c(37),predefined:!0});
...
define("orion/editor/textTheme",["require","orion/editor/eventTarget","orion/util"],function(k,m,p){function i(c){c=c||{};this._document=c.document||document}var c={};i.getTheme=function(d){var d=d||"default",f=c[d];f||(f=c[d]=new i);return f};i.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(c,f){var h=this,g=h._themeClass;h._themeClass=c;this._load(c,f,function(){h.onThemeChanged({type:"ThemeChanged",oldValue:g,newValue:h.getThemeClass()})})},onThemeChanged:function(c){return this.dispatchEvent(c)},
buildStyleSheet:function(c,f){function h(b,a,e){a&&(g.push("."+c+" ."+b+" {"),g.push("\t"+(e?"background-color":"color")+": "+a+";"),g.push("}"))}var g=[];g.push("");g.push("."+c+" {");f.fontFamily&&g.push("\tfont-family: "+f.fontFamily+";");f.fontSize&&g.push("\tfont-size: "+f.fontSize+";");f.fontSize&&g.push("\tcolor: "+f.text+";");g.push("}");g.push("."+c+".textview {");f.background&&g.push("\tbackground-color: "+f.background+";");g.push("}");h("ruler.annotations",f.annotationRuler,!0);h("ruler.lines",
f.annotationRuler,!0);h("ruler.folding",f.annotationRuler,!0);h("ruler.overview",f.overviewRuler,!0);h("rulerLines",f.lineNumber,!1);h("rulerLines.even",f.lineNumberEven,!1);h("rulerLines.odd",f.lineNumberOdd,!1);h("annotationLine.currentLine",f.currentLine,!0);h("entity-name-tag",f.keyword,!1);h("entity-other-attribute-name",f.attribute,!1);h("string-quoted",f.string,!1);h("meta.annotation.currentLine",f.currentLine,!0);h("keyword",f.keyword,!1);h("string",f.string,!1);h("comment",f.comment,!1);
h("comment.block.documentation",f.comment,!1);h("keyword.other.documentation.markup",f.comment,!1);return g.join("\n")},_createStyle:function(c,f,h,g){var b=this._document,c="orion-theme-"+c,a=b.getElementById(c);if(a){if(g||a.firstChild.data===f)return;a.removeChild(a.firstChild);a.appendChild(b.createTextNode(f))}else g?(a=p.createElement(b,"link"),a.rel="stylesheet",a.type="text/css",a.href=f,a.addEventListener("load",function(){h()})):(a=p.createElement(b,"style"),a.appendChild(b.createTextNode(f))),
a.id=c,(b.getElementsByTagName("head")[0]||b.documentElement).appendChild(a);g||h()},_load:function(c,f,h){if(c)if(typeof f==="string")this._createStyle(c,f,h);else if(f=f.href,f.substring(f.length-4)!==".css"&&(f+=".css"),/^\//.test(f)||/[a-zA-Z0-9]+:\/\//i.test(f)||!k.toUrl)this._createStyle(c,f,h,!0);else{var g=this;k(["text!"+f],function(b){g._createStyle(c,b,h,!1)})}else h()}};m.EventTarget.addMixin(i.prototype);return{TextTheme:i}});
define("orion/editor/util",[],function(){return{contains:function(k,m){if(!m)return!1;if(!k.compareDocumentPosition){for(var p=m;p;){if(k===p)return!0;p=p.parentNode}return!1}return k===m||(k.compareDocumentPosition(m)&16)!==0},addEventListener:function(k,m,p,i){typeof k.addEventListener==="function"?k.addEventListener(m,p,i===!0):k.attachEvent("on"+m,p)},removeEventListener:function(k,m,p,i){typeof k.removeEventListener==="function"?k.removeEventListener(m,p,i===!0):k.detachEvent("on"+m,p)}}});
define("orion/editor/textView","i18n!orion/editor/nls/messages,orion/editor/textModel,orion/editor/keyModes,orion/editor/eventTarget,orion/editor/textTheme,orion/editor/util,orion/util".split(","),function(k,m,p,i,c,d,f){function h(j,a,b){if(b){a.className="";for(var b=a.attributes,e=b.length;e-- >0;)(!f.isIE||f.isIE>=9||f.isIE<9&&b[e].specified)&&a.removeAttribute(b[e].name)}if(j){if(j.styleClass)a.className=j.styleClass;if(b=j.style)for(var c in b)b.hasOwnProperty(c)&&(a.style[c]=b[c]);if(j=j.attributes)for(var l in j)j.hasOwnProperty(l)&&
a.setAttribute(l,j[l])}}function g(j){return j instanceof Array?j.slice(0):j}function b(j,a){if(!j)return a;if(!a)return j;for(var b in a)a.hasOwnProperty(b)&&(j.hasOwnProperty(b)||(j[b]=a[b]));return j}function a(j,w){if(j===w)return!0;if(j&&!w||!j&&w)return!1;if(j&&j.constructor===String||w&&w.constructor===String)return!1;if(j instanceof Array||w instanceof Array){if(!(j instanceof Array&&w instanceof Array))return!1;if(j.length!==w.length)return!1;for(var b=0;b<j.length;b++)if(!a(j[b],w[b]))return!1;
...
a=parseInt(a,10)||0;b=parseInt(b,10)||0;e=parseInt(e,10)||0;c=parseInt(c,10)||0;f.left+=a;f.top+=b;f.right+=e;f.bottom+=c;j._trim=f}return f}function q(j,a,b){this.start=j;this.end=a;this.caret=b}function r(j){this.left=j.left;this.top=j.top;this.right=j.right;this.bottom=j.bottom}function n(j,a,b){this.view=j;this.lineIndex=a;this._lineDiv=b}function s(j){this._init(j||{})}var u=d.addEventListener,t=d.removeEventListener,v=function(){function j(j){this.options=j}j.prototype.play=function(){var j=
typeof this.options.duration==="number"?this.options.duration:350,a=this.options.easing||this.defaultEasing,b=this.options.onAnimate||function(){},e=this.options.curve[0],c=this.options.curve[1],f=c-e,l=-1,d,o=this;this.interval=this.options.window.setInterval(function(){l=l===-1?(new Date).getTime():l;var h=((new Date).getTime()-l)/j;h<1?(h=a(h),d=e+h*f,b(d)):(b(c),o.stop())},typeof this.options.rate==="number"?this.options.rate:20)};j.prototype.stop=function(){this.options.window.clearInterval(this.interval);
...
this.start:this.end},toString:function(){return"start="+this.start+" end="+this.end+(this.caret?" caret is at start":" caret is at end")},isEmpty:function(){return this.start===this.end},equals:function(j){return this.caret===j.caret&&this.start===j.start&&this.end===j.end}};r.prototype={toString:function(){return"{l="+this.left+", t="+this.top+", r="+this.right+", b="+this.bottom+"}"}};n.prototype={create:function(j,a){if(!this._lineDiv){var b=this._lineDiv=this._createLine(j,a,this.lineIndex);b._line=
this;return b}},_createLine:function(j,w,b){var e=this.view,c=e._model,l=c.getLine(b),d=c.getLineStart(b),o={type:"LineStyle",textView:e,lineIndex:b,lineText:l,lineStart:d};if(l.length<2E3)e.onLineStyle(o);c=w||f.createElement(j.ownerDocument,"div");if(!w||!a(w.viewStyle,o.style)){h(o.style,c,w);if(w)w._trim=null;c.viewStyle=o.style;c.setAttribute("role","presentation")}c.lineIndex=b;b=[];this._createRanges(o.ranges,l,0,l.length,d,{tabOffset:0,ranges:b});l=" ";!e._fullSelection&&f.isIE<9&&(l="\ufeff");
o={text:l,style:e._metrics.largestFontStyle,ignoreChars:1};b.length===0||!b[b.length-1].style||b[b.length-1].style.tagName!=="div"?b.push(o):b.splice(b.length-1,0,o);var g,n,i,q,r,l=e=0,t,s;if(w){if(n=w.modelChangedEvent)n.removedLineCount===0&&n.addedLineCount===0?(s=n.start-d,t=n.addedCharCount-n.removedCharCount):s=-1,w.modelChangedEvent=void 0;n=w.firstChild}for(d=0;d<b.length;d++){o=b[d];q=o.text;e+=q.length;g=o.style;if(n)if(r=n.firstChild.data,i=n.viewStyle,r===q&&a(g,i)){l+=r.length;n._rectsCache=
void 0;g=n=n.nextSibling;continue}else for(;n;){if(s!==-1){i=e;i>=s&&(i-=t);r=(r=n.firstChild.data)?r.length:0;if(l+r>i)break;l+=r}i=n.nextSibling;c.removeChild(n);n=i}g=this._createSpan(c,q,g,o.ignoreChars);n?c.insertBefore(g,n):c.appendChild(g);if(w)w.lineWidth=void 0}if(w)for(j=g?g.nextSibling:null;j;)i=j.nextSibling,w.removeChild(j),j=i;else j.appendChild(c);return c},_createRanges:function(j,w,b,e,c,f){if(!(b>e)){if(j)for(var l=0;l<j.length;l++){var d=j[l];if(!(d.end<c+b)){var o=Math.max(c+b,
...
j=f.createElement(j.ownerDocument,l);b&&b.html?(j.innerHTML=b.html,j.ignore=!0):b&&b.node?(j.appendChild(b.node),j.ignore=!0):j.appendChild(d.createTextNode(b&&b.text?b.text:a));h(b,j);if(l==="a"){var o=c._getWindow();u(j,"click",function(j){return c._handleLinkClick(j?j:o.event)},!1)}j.viewStyle=b;if(e)j.ignoreChars=e;return j},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(j,a){var b=this._ensureCreated(),
e=this.view;if(j===void 0)return this._getLineBoundingClientRect(b,!0);var c=e._model,l=b.ownerDocument,d=this.lineIndex,o=null;if(j<c.getLineEnd(d)){d=c.getLineStart(d);for(c=b.firstChild;c;){if(!c.ignore){var g=c.firstChild,h=g.length;c.ignoreChars&&(h-=c.ignoreChars);if(d+h>j){o=j-d;if(g.length===1)o=new r(c.getBoundingClientRect());else if(e._isRangeRects)l=l.createRange(),l.setStart(g,o),l.setEnd(g,o+1),o=new r(l.getBoundingClientRect());else if(f.isIE){if(l=l.body.createTextRange(),l.moveToElementText(c),
l.collapse(),(d=o===0&&f.isIE===8)&&(o=1),l.moveEnd("character",o+1),l.moveStart("character",o),o=new r(l.getBoundingClientRect()),d)o.left=c.getClientRects()[0].left}else{var n=g.data;c.removeChild(g);c.appendChild(l.createTextNode(n.substring(0,o)));var i=f.createElement(l,"span");i.appendChild(l.createTextNode(n.substring(o,o+1)));c.appendChild(i);c.appendChild(l.createTextNode(n.substring(o+1)));o=new r(i.getBoundingClientRect());c.innerHTML="";c.appendChild(g);this._createdDiv||(l=e._getSelection(),
(d<=l.start&&l.start<d+h||d<=l.end&&l.end<d+h)&&e._updateDOMSelection())}f.isIE&&(l=b.ownerDocument.defaultView||b.ownerDocument.parentWindow,b=l.screen.logicalXDPI/l.screen.deviceXDPI,l=l.screen.logicalYDPI/l.screen.deviceYDPI,o.left*=b,o.right*=b,o.top*=l,o.bottom*=l);break}d+=h}c=c.nextSibling}}b=this.getBoundingClientRect();if(!o)e._wrapMode?(e=this.getClientRects(),o=e[e.length-1],o.left=o.right,o.left+=b.left,o.top+=b.top,o.right+=b.left,o.bottom+=b.top):(o=new r(b),o.left=o.right);if(a||a===
...
j<a[b].bottom)return b;return a.length-1},getLineStart:function(j){if(!this.view._wrapMode||j===0)return this.view._model.getLineStart(j);var a=this.getClientRects();return this.getOffset(a[j].left+1,a[j].top+1)},getOffset:function(j,a){var b=this.view,e=b._model,c=this.lineIndex,l=e.getLineStart(c),o=e.getLineEnd(c);if(l===o)return l;var d=this._ensureCreated(),g=this.getBoundingClientRect(),h,n;if(b._wrapMode){h=this.getClientRects();if(a<h[0].top)a=h[0].top;for(var i=0;i<h.length;i++)if(n=h[i],
n.top<=a&&a<n.bottom)break;if(j<n.left)j=n.left;j>n.right&&(j=n.right-1)}else j<0&&(j=0),j>g.right-g.left&&(j=g.right-g.left);var q=d.ownerDocument,i=q.defaultView||q.parentWindow,r=f.isIE?i.screen.logicalXDPI/i.screen.deviceXDPI:1,t=f.isIE?i.screen.logicalYDPI/i.screen.deviceYDPI:1,i=l,s=d.firstChild;a:for(;s;){if(!s.ignore){var v=s.firstChild,d=v.length;s.ignoreChars&&(d-=s.ignoreChars);var u,k,p;h=this._getClientRects(s,g);for(var m=0;m<h.length;m++)if(n=h[m],n.left<=j&&j<n.right&&(!b._wrapMode||
n.top<=a&&a<n.bottom)){var m=n.left+g.left,A;if(f.isIE||b._isRangeRects){for(var q=b._isRangeRects?q.createRange():q.body.createTextRange(),z=d,C=-1;z-C>1;){var J=Math.floor((z+C)/2);h=C+1;n=J===d-1&&s.ignoreChars?v.length:J+1;A=h===0&&f.isIE===8;b._isRangeRects?(q.setStart(v,h),q.setEnd(v,n)):(A&&(h=1),q.moveToElementText(s),q.move("character",h),q.moveEnd("character",n-h));h=q.getClientRects();for(var N=!1,L=0;L<h.length;L++)if(n=h[L],u=(A?m:n.left)*r-g.left,p=n.right*r-g.left,k=n.top*t-g.top,n=
n.bottom*t-g.top,u<=j&&j<p&&(!b._wrapMode||k<=a&&a<n)){N=!0;break}N?z=J:C=J}i+=z;h=z;n=z===d-1&&s.ignoreChars?v.length:Math.min(z+1,v.length);b._isRangeRects?(q.setStart(v,h),q.setEnd(v,n)):(q.moveToElementText(s),q.move("character",h),q.moveEnd("character",n-h));h=q.getClientRects();b=!1;h.length>0&&(n=h[0],u=(A?m:n.left)*r-g.left,p=n.right*r-g.left,b=j>u+(p-u)/2);g=i-l;e=e.getLine(c);c=e.charCodeAt(g);55296<=c&&c<=56319&&b?g<e.length&&(c=e.charCodeAt(g+1),56320<=c&&c<=57343&&(i+=1)):56320<=c&&c<=
57343&&!b&&g>0&&(c=e.charCodeAt(g-1),55296<=c&&c<=56319&&(i-=1));b&&i++}else{e=[];for(c=0;c<d;c++)e.push("<span>"),c===d-1?e.push(v.data.substring(c)):e.push(v.data.substring(c,c+1)),e.push("</span>");s.innerHTML=e.join("");for(e=s.firstChild;e;){n=e.getBoundingClientRect();u=n.left-g.left;p=n.right-g.left;if(u<=j&&j<p){j>u+(p-u)/2&&i++;break}i++;e=e.nextSibling}if(!this._createdDiv)s.innerHTML="",s.appendChild(v),g=b._getSelection(),(i<=g.start&&g.start<i+d||i<=g.end&&g.end<i+d)&&b._updateDOMSelection()}break a}i+=
d}s=s.nextSibling}return Math.min(o,Math.max(l,i))},getNextOffset:function(j,a){if(a.unit==="line"){var b=this.view._model,e=b.getLineAtOffset(j);if(a.count>0)return a.count--,b.getLineEnd(e);a.count++;return b.getLineStart(e)}return a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS"?this._getNextOffset_W3C(j,a):f.isIE?this._getNextOffset_IE(j,a):this._getNextOffset_W3C(j,a)},_getNextOffset_W3C:function(j,a){function b(j){return 33<=j&&j<=47||58<=j&&j<=64||91<=j&&j<=94||j===96||123<=j&&j<=
126}function e(j){return j===32||j===9}var c=this.view._model,l=c.getLineAtOffset(j),f=c.getLine(l),o=c.getLineStart(l),c=c.getLineEnd(l),l=f.length,d=j-o,g,h=a.count<0?-1:1;if(a.unit==="word"||a.unit==="wordend"||a.unit==="wordWS"||a.unit==="wordendWS")for(var n,i,q;a.count!==0;){if(a.count>0){if(d===l)return c;g=f.charCodeAt(d);n=b(g);i=!n&&!e(g);for(d++;d<l;){g=f.charCodeAt(d);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=b(g);if(a.unit==="wordend"){if(!q&&n)break}else if(q&&!n)break;g=!q&&!e(g)}else g=
!e(g);if(a.unit==="wordend"||a.unit==="wordendWS"){if(!g&&i)break}else if(g&&!i)break;i=g;n=q;d++}}else{if(d===0)return o;d--;g=f.charCodeAt(d);n=b(g);for(i=!n&&!e(g);0<d;){g=f.charCodeAt(d-1);if(a.unit!=="wordWS"&&a.unit!=="wordendWS"){q=b(g);if(a.unit==="wordend"){if(q&&!n)break}else if(!q&&n)break;g=!q&&!e(g)}else g=!e(g);if(a.unit==="wordend"||a.unit==="wordendWS"){if(g&&!i)break}else if(!g&&i)break;i=g;n=q;d--}}a.count-=h}else for(;a.count!==0&&0<=d+h&&d+h<=l;)d+=h,g=f.charCodeAt(d),56320<=g&&
...
a){var b=new q(j,j,!1);this._doMove(a,b);return b.getCaret()},getOptions:function(){var j;if(arguments.length===0)j=this._defaultOptions();else if(arguments.length===1){if(j=arguments[0],typeof j==="string")return g(this["_"+j])}else{j={};for(var a in arguments)arguments.hasOwnProperty(a)&&(j[arguments[a]]=void 0)}for(var b in j)j.hasOwnProperty(b)&&(j[b]=g(this["_"+b]));return j},getModel:function(){return this._model},getOffsetAtLocation:function(j,a){if(!this._clientDiv)return 0;var b=this._getLineIndex(a),
...
j.preventDefault&&j.preventDefault(),!1},_getModelOffset:function(j,a){if(j){var b;b=j.tagName==="DIV"?j:j.parentNode.parentNode;var e=0,c=b.lineIndex;if(j.tagName!=="DIV")for(b=b.firstChild;b;){var l=b.firstChild;if(l===j){b.ignoreChars&&(e-=b.ignoreChars);e+=a;break}b.ignoreChars&&(e-=b.ignoreChars);e+=l.data.length;b=b.nextSibling}return Math.max(0,e)+this._model.getLineStart(c)}},_updateSelectionFromDOM:function(){var j=this._getWindow().getSelection(),a=this._getModelOffset(j.anchorNode,j.anchorOffset),
j=this._getModelOffset(j.focusNode,j.focusOffset);a===void 0||j===void 0||this._setSelection(new q(a,j),!1,!1)},_handleSelectionChange:function(){if(this._imeOffset===-1)if(f.isAndroid){var j=this._getWindow();this._selTimer&&j.clearTimeout(this._selTimer);var a=this;this._selTimer=j.setTimeout(function(){if(a._clientDiv)a._selTimer=null,a._updateSelectionFromDOM()},250)}else this._updateSelectionFromDOM()},_handleTextInput:function(j){if(!this._ignoreEvent(j)){this._imeOffset=-1;var a=this._getWindow().getSelection();
if(a.anchorNode!==this._anchorNode||a.focusNode!==this._focusNode||a.anchorOffset!==this._anchorOffset||a.focusOffset!==this._focusOffset){for(var b=a.anchorNode;b;){if(b.lineIndex!==void 0)break;b=b.parentNode}if(b){var e=this._model,c=b.lineIndex,l=e.getLine(c),f=l,d=0,e=e.getLineStart(c);if(a.rangeCount>0)a.getRangeAt(0).deleteContents(),c=b.ownerDocument.createTextNode(j.data),a.getRangeAt(0).insertNode(c),d=this._getDOMText(b,c),f=d.text,d=d.offset,c.parentNode.removeChild(c);b.lineRemoved=!0;
for(b=0;l.charCodeAt(b)===f.charCodeAt(b)&&b<d;)b++;a=l.length-1;for(c=f.length-l.length;l.charCodeAt(a)===f.charCodeAt(a+c)&&a+c>=d+j.data.length;)a--;a++;l=f.substring(b,a+c);b+=e;a+=e;this._modifyContent({text:l,start:b,end:a,_ignoreDOMSelection:!0},!0)}}else this._doContent(j.data);j.preventDefault()}},_handleTouchStart:function(j){this._commitIME();var a=this._getWindow();if(this._touchScrollTimer)this._vScrollDiv.style.display="none",this._hScrollDiv.style.display="none",a.clearInterval(this._touchScrollTimer),
this._touchScrollTimer=null;var b=j.touches;if(b.length===1){var b=b[0],e=b.clientX,c=b.clientY;this._touchStartX=e;this._touchStartY=c;if(f.isAndroid&&(c<b.pageY-a.pageYOffset||e<b.pageX-a.pageXOffset))e=b.pageX-a.pageXOffset,c=b.pageY-a.pageYOffset;a=this.convert({x:e,y:c},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(a.x,a.y);this._touchStartTime=j.timeStamp;this._touching=!0}},_handleTouchMove:function(j){var a=j.touches;if(a.length===1){a=a[0];this._touchCurrentX=a.clientX;
this._touchCurrentY=a.clientY;if(!this._touchScrollTimer&&j.timeStamp-this._touchStartTime<200){this._vScrollDiv.style.display="block";if(!this._wrapMode)this._hScrollDiv.style.display="block";var b=this,e=this._getWindow();this._touchScrollTimer=e.setInterval(function(){var j=0,a=0;if(b._touching)j=b._touchStartX-b._touchCurrentX,a=b._touchStartY-b._touchCurrentY,b._touchSpeedX=j/10,b._touchSpeedY=a/10,b._touchStartX=b._touchCurrentX,b._touchStartY=b._touchCurrentY;else if(Math.abs(b._touchSpeedX)<
...
"function"&&(a=a.match(j),a!==void 0))return this.invokeAction(a);return!1},_doMove:function(j,a){var b=this._model,e=a.getCaret(),c=b.getLineAtOffset(e);if(!j.count)j.count=1;for(;j.count!==0;){var l=b.getLineStart(c);if(j.count<0&&e===l)if(c>0)j.unit==="character"&&j.count++,c--,a.extend(b.getLineEnd(c));else break;else if(j.count>0&&e===b.getLineEnd(c))if(c+1<b.getLineCount())j.unit==="character"&&j.count--,c++,a.extend(b.getLineStart(c));else break;else{var f=!1;j.expandTab&&j.unit==="character"&&
(e-l)%this._tabSize===0&&(f=!/[^ ]/.test(b.getText(l,e)));f?(a.extend(e-this._tabSize),j.count+=j.count<0?1:-1):(l=this._getLine(c),a.extend(l.getNextOffset(e,j)),l.destroy())}e=a.getCaret()}return a},_doBackspace:function(j){var a=this._getSelection();if(a.isEmpty()){if(!j.count)j.count=1;j.count*=-1;j.expandTab=this._expandTab;this._doMove(j,a)}this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doCase:function(j){var a=this._getSelection();this._doMove(j,a);var b=this.getText(a.start,
a.end);this._setSelection(a,!0);switch(j.type){case "lower":b=b.toLowerCase();break;case "capitalize":b=b.replace(/(?:^|\s)\S/g,function(j){return j.toUpperCase()});break;case "reverse":j="";for(a=0;a<b.length;a++){var e=b[a],c=e.toLowerCase(),e=c!==e?c:e.toUpperCase();j+=e}b=j;break;default:b=b.toUpperCase()}this._doContent(b);return!0},_doContent:function(j){var a=this._getSelection();if(this._overwriteMode&&a.isEmpty()){var b=this._model,e=b.getLineAtOffset(a.end);a.end<b.getLineEnd(e)&&(b=this._getLine(e),
a.extend(b.getNextOffset(a.getCaret(),{unit:"character",count:1})),b.destroy())}this._modifyContent({text:j,start:a.start,end:a.end,_ignoreDOMSelection:!0},!0)},_doCopy:function(j){var a=this._getSelection();return!a.isEmpty()?this._setClipboardText(this._getBaseText(a.start,a.end),j):!0},_doCursorNext:function(j){var a=this._getSelection();!a.isEmpty()&&!j.select?a.start=a.end:this._doMove(j,a);j.select||a.collapse();this._setSelection(a,!0);return!0},_doCursorPrevious:function(j){var a=this._getSelection();
if(!a.isEmpty()&&!j.select)a.end=a.start;else{if(!j.count)j.count=1;j.count*=-1;this._doMove(j,a)}j.select||a.collapse();this._setSelection(a,!0);return!0},_doCut:function(j){var a=this._getSelection();return!a.isEmpty()?(a=this._getBaseText(a.start,a.end),this._doContent(""),this._setClipboardText(a,j)):!0},_doDelete:function(j){var a=this._getSelection();a.isEmpty()&&this._doMove(j,a);this._modifyContent({text:"",start:a.start,end:a.end},!0);return!0},_doEnd:function(j){var a=this._getSelection(),
...
if(a&&a.noCursor)e.end=e.start,this._setSelection(e,!0);return!0},_doHome:function(a){var b=this._getSelection(),e=this._model,c;if(a.ctrl)b.extend(0),c=function(){};else{var l=b.getCaret(),f=e.getLineAtOffset(l);this._wrapMode?(e=this._getLine(f),l=e.getLineIndex(l),l=e.getLineStart(l),e.destroy()):l=e.getLineStart(f);b.extend(l)}a.select||b.collapse();this._setSelection(b,!0,!0,c);return!0},_doLineDown:function(a){var b=this._model,e=this._getSelection(),c=e.getCaret(),l=b.getLineAtOffset(c),d=
this._getLine(l),o=this._columnX,g=1,h=!1;if(o===-1||a.wholeLine||a.select&&f.isIE)o=a.wholeLine?b.getLineEnd(l+1):c,o=d.getBoundingClientRect(o).left;(c=d.getLineIndex(c))<d.getLineCount()-1?g=d.getClientRects(c+1).top+1:(c=b.getLineCount()-1,h=l===c,a.count&&a.count>0?l=Math.min(l+a.count,c):l++);c=!1;if(h){if(a.select||f.isMac||f.isLinux)e.extend(b.getCharCount()),c=!0}else d.lineIndex!==l&&(d.destroy(),d=this._getLine(l)),e.extend(d.getOffset(o,g)),c=!0;c&&(a.select||e.collapse(),this._setSelection(e,
!0,!0));this._columnX=o;d.destroy();return!0},_doLineUp:function(a){var b=this._model,e=this._getSelection(),c=e.getCaret(),l=b.getLineAtOffset(c),d=this._getLine(l),o=this._columnX,g=!1,h;if(o===-1||a.wholeLine||a.select&&f.isIE)o=a.wholeLine?b.getLineStart(l-1):c,o=d.getBoundingClientRect(o).left;(c=d.getLineIndex(c))>0?h=d.getClientRects(c-1).top+1:(g=l===0,g||(a.count&&a.count>0?l=Math.max(l-a.count,0):l--,h=this._getLineHeight(l)-1));c=!1;if(g){if(a.select||f.isMac||f.isLinux)e.extend(0),c=!0}else d.lineIndex!==
l&&(d.destroy(),d=this._getLine(l)),e.extend(d.getOffset(o,h)),c=!0;c&&(a.select||e.collapse(),this._setSelection(e,!0,!0));this._columnX=o;d.destroy();return!0},_doNoop:function(){return!0},_doPageDown:function(a){var b=this,e=this._model,c=this._getSelection(),l=c.getCaret(),d=e.getLineAtOffset(l),o=e.getLineCount(),g=this._getScroll(),e=this._getClientHeight(),h,n;if(this._lineHeight){h=this._columnX;g=this._getBoundsAtOffset(l);if(h===-1||a.select&&f.isIE)h=g.left;l=this._getLineIndex(g.top+e);
n=this._getLine(l);d=this._getLinePixel(l);l=n.getOffset(h,g.top+e-d);e=n.getBoundingClientRect(l);n.destroy();c.extend(l);a.select||c.collapse();this._setSelection(c,!0,!0,function(){b._columnX=h},e.top+d-g.top);return!0}if(d<o-1){var i=this._getLineHeight(),q=Math.min(o-d-1,Math.floor(e/i)),q=Math.max(1,q);h=this._columnX;if(h===-1||a.select&&f.isIE)n=this._getLine(d),h=n.getBoundingClientRect(l).left,n.destroy();n=this._getLine(d+q);c.extend(n.getOffset(h,0));n.destroy();a.select||c.collapse();
a=o*i;l=g.y+q*i;l+e>a&&(l=a-e);this._setSelection(c,!0,!0,function(){b._columnX=h},l-g.y)}return!0},_doPageUp:function(a){var b=this,e=this._model,c=this._getSelection(),l=c.getCaret(),d=e.getLineAtOffset(l),o=this._getScroll(),g=this._getClientHeight(),h;if(this._lineHeight){h=this._columnX;o=this._getBoundsAtOffset(l);if(h===-1||a.select&&f.isIE)h=o.left;l=this._getLineIndex(o.bottom-g);e=this._getLine(l);d=this._getLinePixel(l);l=e.getOffset(h,o.bottom-g-d);g=e.getBoundingClientRect(l);e.destroy();
c.extend(l);a.select||c.collapse();this._setSelection(c,!0,!0,function(){b._columnX=h},g.top+d-o.top);return!0}if(d>0){var n=this._getLineHeight(),g=Math.max(1,Math.min(d,Math.floor(g/n)));h=this._columnX;if(h===-1||a.select&&f.isIE)e=this._getLine(d),h=e.getBoundingClientRect(l).left,e.destroy();e=this._getLine(d-g);c.extend(e.getOffset(h,this._getLineHeight(d-g)-1));e.destroy();a.select||c.collapse();a=Math.max(0,o.y-g*n);this._setSelection(c,!0,!0,function(){b._columnX=h},a-o.y)}return!0},_doPaste:function(a){var b=
this;return this._getClipboardText(a,function(a){a&&(f.isLinux&&b._lastMouseButton===2&&(new Date).getTime()-b._lastMouseTime<=b._clickTime&&b._setSelectionTo(b._lastMouseX,b._lastMouseY),b._doContent(a))})!==null},_doScroll:function(a){var b=a.type,e=this._model,c=e.getLineCount(),a=this._getClientHeight(),l=this._getLineHeight();c*=l;var f=this._getScroll().y,d;switch(b){case "textStart":d=0;break;case "textEnd":d=c-a;break;case "pageDown":d=f+a;break;case "pageUp":d=f-a;break;case "lineDown":d=
f+l;break;case "lineUp":d=f-l;break;case "centerLine":b=this._getSelection(),d=e.getLineAtOffset(b.start),e=(e.getLineAtOffset(b.end)-d+1)*l,d=d*l-a/2+e/2}d!==void 0&&(d=Math.min(Math.max(0,d),c-a),this._scrollViewAnimated(0,d-f,function(){}));return!0},_doSelectAll:function(){var a=this._model,b=this._getSelection();b.setCaret(0);b.extend(a.getCharCount());this._setSelection(b,!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var a="\t";if(this._expandTab)var b=this._model,a=this._getSelection().getCaret(),
e=b.getLineAtOffset(a),b=b.getLineStart(e),a=Array(this._tabSize-(a-b)%this._tabSize+1).join(" ");this._doContent(a);return!0}},_doShiftTab:function(){return!this._tabMode||this._readonly?void 0:!0},_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var a=
this._model,b=this._getSelection(),e=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),c=b.getCaret(),l=a.getLineCount(),d=a.getLineAtOffset(c),o;if(this._autoScrollDir==="up"||this._autoScrollDir==="down")c=this._autoScrollY/this._getLineHeight(),c=c<0?Math.floor(c):Math.ceil(c),o=Math.max(0,Math.min(l-1,d+c));else if(this._autoScrollDir==="left"||this._autoScrollDir==="right")o=this._getLineIndex(e.y),d=this._getLine(d),e.x+=d.getBoundingClientRect(c,!1).left,d.destroy();
o===0&&(f.isMac||f.isLinux)?b.extend(0):o===l-1&&(f.isMac||f.isLinux)?b.extend(a.getCharCount()):(d=this._getLine(o),b.extend(d.getOffset(e.x,e.y-this._getLinePixel(o))),d.destroy());this._setSelection(b,!0)},_autoScrollTimer:function(){this._autoScroll();var a=this;this._autoScrollTimerID=this._getWindow().setTimeout(function(){a._autoScrollTimer()},this._AUTO_SCROLL_RATE)},_calculateLineHeightTimer:function(a){if(this._lineHeight&&!this._calculateLHTimer){var b=this._model.getLineCount(),e=0;if(a){for(var a=
0,c=(new Date).getTime(),l=0;e<b;)if(this._lineHeight[e]||(a++,l||(l=e),this._lineHeight[e]=this._calculateLineHeight(e)),e++,(new Date).getTime()-c>100)break;this.redrawRulers(0,b);this._queueUpdate()}a=this._getWindow();if(e!==b){var f=this;this._calculateLHTimer=a.setTimeout(function(){f._calculateLHTimer=null;f._calculateLineHeightTimer(!0)},0)}else if(this._calculateLHTimer)a.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=void 0}},_calculateLineHeight:function(a){var a=this._getLine(a),
b=a.getBoundingClientRect();a.destroy();return Math.max(1,b.bottom-b.top)},_calculateMetrics:function(){var a=this._clientDiv,b=a.ownerDocument,e=f.createElement(b,"div");e.style.lineHeight="normal";var c={type:"LineStyle",textView:this,0:0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(c);h(c.style,e);e.style.position="fixed";e.style.left="-1000px";var d=f.createElement(b,"span");d.appendChild(b.createTextNode(" "));e.appendChild(d);var g=f.createElement(b,"span");g.style.fontStyle=
"italic";g.appendChild(b.createTextNode(" "));e.appendChild(g);var n=f.createElement(b,"span");n.style.fontWeight="bold";n.appendChild(b.createTextNode(" "));e.appendChild(n);c=f.createElement(b,"span");c.style.fontWeight="bold";c.style.fontStyle="italic";c.appendChild(b.createTextNode(" "));e.appendChild(c);a.appendChild(e);var i=e.getBoundingClientRect(),d=d.getBoundingClientRect(),g=g.getBoundingClientRect(),n=n.getBoundingClientRect(),c=c.getBoundingClientRect(),d=d.bottom-d.top,g=g.bottom-g.top,
n=n.bottom-n.top,q=c.bottom-c.top,r=0,c=i.bottom-i.top<=0,i=Math.max(1,i.bottom-i.top);g>d&&(r=1);n>g&&(r=2);q>n&&(r=3);var t;if(r!==0){t={style:{}};if((r&1)!==0)t.style.fontStyle="italic";if((r&2)!==0)t.style.fontWeight="bold"}d=o(e);a.removeChild(e);q=l(this._viewDiv);e=f.createElement(b,"div");e.style.position="fixed";e.style.left="-1000px";e.style.paddingLeft=q.left+"px";e.style.paddingTop=q.top+"px";e.style.paddingRight=q.right+"px";e.style.paddingBottom=q.bottom+"px";e.style.width="100px";e.style.height=
"100px";q=f.createElement(b,"div");q.style.width="100%";q.style.height="100%";e.appendChild(q);a.appendChild(e);r=e.getBoundingClientRect();g=q.getBoundingClientRect();n=0;if(!this._singleMode)e.style.overflow="hidden",q.style.height="200px",n=e.clientWidth,e.style.overflow="scroll",n-=e.clientWidth;a.removeChild(e);q={left:g.left-r.left,top:g.top-r.top,right:r.right-g.right,bottom:r.bottom-g.bottom};g=r=0;if(!c&&(this._wrapOffset||this._marginOffset))e=f.createElement(b,"div"),e.style.position="fixed",
e.style.left="-1000px",e.innerHTML=Array(this._wrapOffset+1).join(" "),a.appendChild(e),r=e.getBoundingClientRect(),r=Math.ceil(r.right-r.left),e.innerHTML=Array(this._marginOffset+1).join(" "),g=e.getBoundingClientRect(),g=Math.ceil(g.right-g.left),a.removeChild(e);return{lineHeight:i,largestFontStyle:t,lineTrim:d,viewPadding:q,scrollWidth:n,wrapWidth:r,marginWidth:g,invalid:c}},_cancelAnimation:function(){if(this._animation)this._animation.stop(),this._animation=null},_clearSelection:function(a){var b=
this._getSelection();if(b.isEmpty())return!1;a==="next"?b.start=b.end:b.end=b.start;this._setSelection(b,!0);return!0},_commitIME:function(){if(this._imeOffset!==-1){this._scrollDiv.focus();this._clientDiv.focus();var a=this._model,b=a.getLineAtOffset(this._imeOffset),e=a.getLineStart(b),c=this._getDOMText(this._getLineNode(b)).text,a=a.getLine(b),e=this._imeOffset-e,a=e+c.length-a.length;e!==a&&this._doContent(c.substring(e,a));this._imeOffset=-1}},_createActions:function(){this.addKeyMode(new p.DefaultKeyMode(this));
var a=this;this._actions={noop:{defaultHandler:function(){return a._doNoop()}},lineUp:{defaultHandler:function(e){return a._doLineUp(b(e,{select:!1}))},actionDescription:{name:k.lineUp}},lineDown:{defaultHandler:function(e){return a._doLineDown(b(e,{select:!1}))},actionDescription:{name:k.lineDown}},lineStart:{defaultHandler:function(e){return a._doHome(b(e,{select:!1,ctrl:!1}))},actionDescription:{name:k.lineStart}},lineEnd:{defaultHandler:function(e){return a._doEnd(b(e,{select:!1,ctrl:!1}))},actionDescription:{name:k.lineEnd}},
charPrevious:{defaultHandler:function(e){return a._doCursorPrevious(b(e,{select:!1,unit:"character"}))},actionDescription:{name:k.charPrevious}},charNext:{defaultHandler:function(e){return a._doCursorNext(b(e,{select:!1,unit:"character"}))},actionDescription:{name:k.charNext}},pageUp:{defaultHandler:function(e){return a._doPageUp(b(e,{select:!1}))},actionDescription:{name:k.pageUp}},pageDown:{defaultHandler:function(e){return a._doPageDown(b(e,{select:!1}))},actionDescription:{name:k.pageDown}},scrollPageUp:{defaultHandler:function(e){return a._doScroll(b(e,
{type:"pageUp"}))},actionDescription:{name:k.scrollPageUp}},scrollPageDown:{defaultHandler:function(e){return a._doScroll(b(e,{type:"pageDown"}))},actionDescription:{name:k.scrollPageDown}},scrollLineUp:{defaultHandler:function(e){return a._doScroll(b(e,{type:"lineUp"}))},actionDescription:{name:k.scrollLineUp}},scrollLineDown:{defaultHandler:function(e){return a._doScroll(b(e,{type:"lineDown"}))},actionDescription:{name:k.scrollLineDown}},wordPrevious:{defaultHandler:function(e){return a._doCursorPrevious(b(e,
{select:!1,unit:"word"}))},actionDescription:{name:k.wordPrevious}},wordNext:{defaultHandler:function(e){return a._doCursorNext(b(e,{select:!1,unit:"word"}))},actionDescription:{name:k.wordNext}},textStart:{defaultHandler:function(e){return a._doHome(b(e,{select:!1,ctrl:!0}))},actionDescription:{name:k.textStart}},textEnd:{defaultHandler:function(e){return a._doEnd(b(e,{select:!1,ctrl:!0}))},actionDescription:{name:k.textEnd}},scrollTextStart:{defaultHandler:function(e){return a._doScroll(b(e,{type:"textStart"}))},
actionDescription:{name:k.scrollTextStart}},scrollTextEnd:{defaultHandler:function(e){return a._doScroll(b(e,{type:"textEnd"}))},actionDescription:{name:k.scrollTextEnd}},centerLine:{defaultHandler:function(e){return a._doScroll(b(e,{type:"centerLine"}))},actionDescription:{name:k.centerLine}},selectLineUp:{defaultHandler:function(e){return a._doLineUp(b(e,{select:!0}))},actionDescription:{name:k.selectLineUp}},selectLineDown:{defaultHandler:function(e){return a._doLineDown(b(e,{select:!0}))},actionDescription:{name:k.selectLineDown}},
selectWholeLineUp:{defaultHandler:function(e){return a._doLineUp(b(e,{select:!0,wholeLine:!0}))},actionDescription:{name:k.selectWholeLineUp}},selectWholeLineDown:{defaultHandler:function(e){return a._doLineDown(b(e,{select:!0,wholeLine:!0}))},actionDescription:{name:k.selectWholeLineDown}},selectLineStart:{defaultHandler:function(e){return a._doHome(b(e,{select:!0,ctrl:!1}))},actionDescription:{name:k.selectLineStart}},selectLineEnd:{defaultHandler:function(e){return a._doEnd(b(e,{select:!0,ctrl:!1}))},
actionDescription:{name:k.selectLineEnd}},selectCharPrevious:{defaultHandler:function(e){return a._doCursorPrevious(b(e,{select:!0,unit:"character"}))},actionDescription:{name:k.selectCharPrevious}},selectCharNext:{defaultHandler:function(e){return a._doCursorNext(b(e,{select:!0,unit:"character"}))},actionDescription:{name:k.selectCharNext}},selectPageUp:{defaultHandler:function(e){return a._doPageUp(b(e,{select:!0}))},actionDescription:{name:k.selectPageUp}},selectPageDown:{defaultHandler:function(e){return a._doPageDown(b(e,
{select:!0}))},actionDescription:{name:k.selectPageDown}},selectWordPrevious:{defaultHandler:function(e){return a._doCursorPrevious(b(e,{select:!0,unit:"word"}))},actionDescription:{name:k.selectWordPrevious}},selectWordNext:{defaultHandler:function(e){return a._doCursorNext(b(e,{select:!0,unit:"word"}))},actionDescription:{name:k.selectWordNext}},selectTextStart:{defaultHandler:function(e){return a._doHome(b(e,{select:!0,ctrl:!0}))},actionDescription:{name:k.selectTextStart}},selectTextEnd:{defaultHandler:function(e){return a._doEnd(b(e,
{select:!0,ctrl:!0}))},actionDescription:{name:k.selectTextEnd}},deletePrevious:{defaultHandler:function(e){return a._doBackspace(b(e,{unit:"character"}))},actionDescription:{name:k.deletePrevious}},deleteNext:{defaultHandler:function(e){return a._doDelete(b(e,{unit:"character"}))},actionDescription:{name:k.deleteNext}},deleteWordPrevious:{defaultHandler:function(e){return a._doBackspace(b(e,{unit:"word"}))},actionDescription:{name:k.deleteWordPrevious}},deleteWordNext:{defaultHandler:function(e){return a._doDelete(b(e,
{unit:"word"}))},actionDescription:{name:k.deleteWordNext}},deleteLineStart:{defaultHandler:function(e){return a._doBackspace(b(e,{unit:"line"}))},actionDescription:{name:k.deleteLineStart}},deleteLineEnd:{defaultHandler:function(e){return a._doDelete(b(e,{unit:"line"}))},actionDescription:{name:k.deleteLineEnd}},tab:{defaultHandler:function(){return a._doTab()},actionDescription:{name:k.tab}},shiftTab:{defaultHandler:function(){return a._doShiftTab()},actionDescription:{name:k.shiftTab}},enter:{defaultHandler:function(){return a._doEnter()},
actionDescription:{name:k.enter}},enterNoCursor:{defaultHandler:function(e){return a._doEnter(b(e,{noCursor:!0}))},actionDescription:{name:k.enterNoCursor}},selectAll:{defaultHandler:function(){return a._doSelectAll()},actionDescription:{name:k.selectAll}},copy:{defaultHandler:function(){return a._doCopy()},actionDescription:{name:k.copy}},cut:{defaultHandler:function(){return a._doCut()},actionDescription:{name:k.cut}},paste:{defaultHandler:function(){return a._doPaste()},actionDescription:{name:k.paste}},
uppercase:{defaultHandler:function(e){return a._doCase(b(e,{type:"upper"}))},actionDescription:{name:k.uppercase}},lowercase:{defaultHandler:function(e){return a._doCase(b(e,{type:"lower"}))},actionDescription:{name:k.lowercase}},capitalize:{defaultHandler:function(e){return a._doCase(b(e,{unit:"word",type:"capitalize"}))},actionDescription:{name:k.capitalize}},reversecase:{defaultHandler:function(e){return a._doCase(b(e,{type:"reverse"}))},actionDescription:{name:k.reversecase}},toggleOverwriteMode:{defaultHandler:function(){return a._doOverwriteMode()},
actionDescription:{name:k.toggleOverwriteMode}},toggleTabMode:{defaultHandler:function(){return a._doTabMode()},actionDescription:{name:k.toggleTabMode}},toggleWrapMode:{defaultHandler:function(){return a._doWrapMode()},actionDescription:{name:k.toggleWrapMode}}}},_createRulerParent:function(a){var b=f.createElement(document,"div");b.className=a;b.tabIndex=-1;b.style.overflow="hidden";b.style.MozUserSelect="none";b.style.WebkitUserSelect="none";b.style.position="absolute";b.style.top="0px";b.style.bottom=
"0px";b.style.cursor="default";b.style.display="none";b.setAttribute("aria-hidden","true");this._rootDiv.appendChild(b);return b},_createRuler:function(a,b){if(this._clientDiv){var e=this._getRulerParent(a);if(e){if(e!==this._marginDiv||this._marginOffset)e.style.display="block";var c=f.createElement(e.ownerDocument,"div");c._ruler=a;c.rulerChanged=!0;c.style.position="relative";c.style.cssFloat="left";c.style.styleFloat="left";c.style.outline="none";if(b===void 0||b<0||b>=e.children.length)e.appendChild(c);
else{for(var l=e.firstChild;l&&b-- >0;)l=l.nextSibling;e.insertBefore(c,l)}}}},_createView:function(){if(!this._clientDiv){for(var a=this._parent;a.hasChildNodes();)a.removeChild(a.lastChild);var b=a.ownerDocument,e=f.createElement(b,"div");this._rootDiv=e;e.tabIndex=-1;e.style.position="relative";e.style.overflow="hidden";e.style.width="100%";e.style.height="100%";e.style.overflow="hidden";e.style.WebkitTextSizeAdjust="100%";e.setAttribute("role","application");a.appendChild(e);this._leftDiv=this._createRulerParent("textviewLeftRuler");
a=f.createElement(b,"div");a.className="textviewScroll";this._viewDiv=a;a.tabIndex=-1;a.style.position="absolute";a.style.top="0px";a.style.bottom="0px";a.style.borderWidth="0px";a.style.margin="0px";a.style.outline="none";a.style.background="transparent";if(f.isMac&&f.isWebkit)a.style.pointerEvents="none",a.style.zIndex="2";e.appendChild(a);var c=this._createRulerParent("textviewRightRuler");this._rightDiv=c;c.style.right="0px";this._scrollDiv=c=f.createElement(b,"div");c.style.margin="0px";c.style.borderWidth=
"0px";c.style.padding="0px";a.appendChild(c);(this._marginDiv=this._createRulerParent("textviewMarginRuler")).style.zIndex="4";if(!f.isIE&&!f.isIOS)this._clipDiv=a=f.createElement(b,"div"),a.style.position="absolute",a.style.overflow="hidden",a.style.margin="0px",a.style.borderWidth="0px",a.style.padding="0px",a.style.background="transparent",e.appendChild(a),this._clipScrollDiv=c=f.createElement(b,"div"),c.style.position="absolute",c.style.height="1px",c.style.top="-1000px",c.style.background="transparent",
a.appendChild(c);this._setFullSelection(this._fullSelection,!0);a=f.createElement(b,"div");a.className="textviewContent";this._clientDiv=a;a.tabIndex=0;a.style.position="absolute";a.style.borderWidth="0px";a.style.margin="0px";a.style.padding="0px";a.style.outline="none";a.style.zIndex="1";a.style.WebkitUserSelect="text";a.setAttribute("spellcheck","false");if(f.isIOS||f.isAndroid)a.style.WebkitTapHighlightColor="transparent";(this._clipDiv||e).appendChild(a);if(f.isIOS||f.isAndroid)this._vScrollDiv=
c=f.createElement(b,"div"),c.style.position="absolute",c.style.borderWidth="1px",c.style.borderColor="white",c.style.borderStyle="solid",c.style.borderRadius="4px",c.style.backgroundColor="black",c.style.opacity="0.5",c.style.margin="0px",c.style.padding="0px",c.style.outline="none",c.style.zIndex="3",c.style.width="8px",c.style.display="none",e.appendChild(c),this._hScrollDiv=c=f.createElement(b,"div"),c.style.position="absolute",c.style.borderWidth="1px",c.style.borderColor="white",c.style.borderStyle=
"solid",c.style.borderRadius="4px",c.style.backgroundColor="black",c.style.opacity="0.5",c.style.margin="0px",c.style.padding="0px",c.style.outline="none",c.style.zIndex="3",c.style.height="8px",c.style.display="none",e.appendChild(c);if(f.isFirefox&&!a.setCapture)this._overlayDiv=b=f.createElement(b,"div"),b.style.position=a.style.position,b.style.borderWidth=a.style.borderWidth,b.style.margin=a.style.margin,b.style.padding=a.style.padding,b.style.cursor="text",b.style.zIndex="2",(this._clipDiv||
e).appendChild(b);a.contentEditable="true";a.setAttribute("role","textbox");a.setAttribute("aria-multiline","true");this._setWrapMode(this._wrapMode,!0);this._setReadOnly(this._readonly);this._setThemeClass(this._themeClass,!0);this._setTabSize(this._tabSize,!0);this._setMarginOffset(this._marginOffset,!0);this._hookEvents();e=this._rulers;for(b=0;b<e.length;b++)this._createRuler(e[b]);this._update()}},_defaultOptions:function(){return{parent:{value:void 0,update:null},model:{value:void 0,update:this.setModel},
...
this._unhookEvents();var a=this._getWindow();if(this._autoScrollTimerID)a.clearTimeout(this._autoScrollTimerID),this._autoScrollTimerID=null;if(this._updateTimer)a.clearTimeout(this._updateTimer),this._updateTimer=null;a=this._rootDiv;a.parentNode.removeChild(a);this._hScrollDiv=this._vScrollDiv=this._cursorDiv=this._marginDiv=this._rightDiv=this._leftDiv=this._overlayDiv=this._clientDiv=this._clipScrollDiv=this._clipDiv=this._viewDiv=this._scrollDiv=this._rootDiv=this._clipboardDiv=this._selDiv3=
this._selDiv2=this._selDiv1=null}},_doAutoScroll:function(a,b,e){this._autoScrollDir=a;this._autoScrollX=b;this._autoScrollY=e;this._autoScrollTimerID||this._autoScrollTimer()},_endAutoScroll:function(){this._autoScrollTimerID&&this._getWindow().clearTimeout(this._autoScrollTimerID);this._autoScrollTimerID=this._autoScrollDir=void 0},_fixCaret:function(){var a=this._clientDiv;if(a){var b=this._hasFocus;this._ignoreFocus=!0;b&&a.blur();a.contentEditable=!1;a.contentEditable=!0;b&&a.focus();this._ignoreFocus=
!1}},_getBaseText:function(a,b){var e=this._model;e.getBaseModel&&(a=e.mapOffset(a),b=e.mapOffset(b),e=e.getBaseModel());return e.getText(a,b)},_getBottomIndex:function(a){var b=this._bottomChild;if(a&&this._getClientHeight()>this._getLineHeight()){var a=b.getBoundingClientRect(),e=this._clientDiv.getBoundingClientRect();a.bottom>e.bottom&&(b=this._getLinePrevious(b)||b)}return b.lineIndex},_getBoundsAtOffset:function(a){var b=this._getLine(this._model.getLineAtOffset(a)),a=b.getBoundingClientRect(a),
e=this._getLinePixel(b.lineIndex);a.top+=e;a.bottom+=e;b.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getClientWidth:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right)},_getClipboardText:function(a,b){var c=this._model.getLineDelimiter(),l,d,o=this._getWindow(),g=o.clipboardData;if(!g&&a)g=a.clipboardData;if(g)return l=[],d=g.getData(f.isIE?"Text":"text/plain"),
e(d,function(a){l.push(a)},function(){l.push(c)}),d=l.join(""),b&&b(d),d;if(f.isFirefox){this._ignoreFocus=!0;var h=this._clipboardDiv,g=this._rootDiv.ownerDocument;if(!h)this._clipboardDiv=h=f.createElement(g,"div"),h.style.position="fixed",h.style.whiteSpace="pre",h.style.left="-1000px",this._rootDiv.appendChild(h);h.innerHTML="<pre contenteditable=''></pre>";h.firstChild.focus();var n=this,i=function(){var a=n._getTextFromElement(h);h.innerHTML="";l=[];e(a,function(a){l.push(a)},function(){l.push(c)});
return l.join("")},q=!1;this._ignorePaste=!0;if(!f.isLinux||this._lastMouseButton!==2)try{q=g.execCommand("paste",!1,null)}catch(r){q=h.childNodes.length>1||h.firstChild&&h.firstChild.childNodes.length>0}this._ignorePaste=!1;if(!q)return a?(o.setTimeout(function(){n.focus();(d=i())&&b&&b(d);n._ignoreFocus=!1},0),null):(this.focus(),this._ignoreFocus=!1,"");this.focus();this._ignoreFocus=!1;(d=i())&&b&&b(d);return d}return""},_getDOMText:function(a,b){for(var e=a.firstChild,c="",l=0;e;){var f;if(!e.ignore)if(e.ignoreChars){f=
e.lastChild;for(var d=0,o=[],g=-1;f;){var h=f.data;if(h)for(var n=h.length-1;n>=0;n--){var i=h.substring(n,n+1);d<e.ignoreChars&&(i===" "||i==="\u200b"||i==="\ufeff")?d++:o.push(i==="\u00a0"?"\t":i)}if(b===f)g=o.length;f=f.previousSibling}o=o.reverse().join("");g!==-1&&(l=c.length+o.length-g);c+=o}else for(f=e.firstChild;f;){if(b===f)l=c.length;c+=f.data;f=f.nextSibling}e=e.nextSibling}return{text:c,offset:l}},_getTextFromElement:function(a){var b=a.ownerDocument,e=b.defaultView;if(!e.getSelection)return a.innerText||
a.textContent;b=b.createRange();b.selectNode(a);var a=e.getSelection(),e=[],c;for(c=0;c<a.rangeCount;c++)e.push(a.getRangeAt(c));this._ignoreSelect=!0;a.removeAllRanges();a.addRange(b);b=a.toString();a.removeAllRanges();for(c=0;c<e.length;c++)a.addRange(e[c]);this._ignoreSelect=!1;return b},_getViewPadding:function(){return this._metrics.viewPadding},_getLine:function(a){var b=this._getLineNode(a);return b&&!b.lineChanged&&!b.lineRemoved?b._line:new n(this,a)},_getLineHeight:function(a,b){if(a!==
void 0&&this._lineHeight){var e=this._lineHeight[a];if(e)return e;if(b||b===void 0)return this._lineHeight[a]=this._calculateLineHeight(a)}return this._metrics.lineHeight},_getLineNode:function(a){for(var b=this._clientDiv.firstChild;b;){if(a===b.lineIndex)return b;b=b.nextSibling}},_getLineNext:function(a){for(a=a?a.nextSibling:this._clientDiv.firstChild;a&&a.lineIndex===-1;)a=a.nextSibling;return a},_getLinePrevious:function(a){for(a=a?a.previousSibling:this._clientDiv.lastChild;a&&a.lineIndex===
-1;)a=a.previousSibling;return a},_getLinePixel:function(a){a=Math.min(Math.max(0,a),this._model.getLineCount());if(this._lineHeight){var b=this._getTopIndex(),e=-this._topIndexY+this._getScroll().y;if(a>b)for(;b<a;b++)e+=this._getLineHeight(b);else for(b-=1;b>=a;b--)e-=this._getLineHeight(b);return e}return this._getLineHeight()*a},_getLineIndex:function(a){var b,e=0,c=this._model.getLineCount();if(this._lineHeight){var e=this._getTopIndex(),l=-this._topIndexY+this._getScroll().y;if(a!==l)if(a<l)for(;a<
l&&e>0;)a+=this._getLineHeight(--e);else for(b=this._getLineHeight(e);a-b>=l&&e<c-1;)a-=b,b=this._getLineHeight(++e)}else b=this._getLineHeight(),e=Math.floor(a/b);return Math.max(0,Math.min(c-1,e))},_getRulerParent:function(a){switch(a.getLocation()){case "left":return this._leftDiv;case "right":return this._rightDiv;case "margin":return this._marginDiv}return null},_getScroll:function(a){(a===void 0||a)&&this._cancelAnimation();a=this._viewDiv;return{x:a.scrollLeft,y:a.scrollTop}},_getSelection:function(){return this._selection.clone()},
_getTopIndex:function(a){var b=this._topChild;if(a&&this._getClientHeight()>this._getLineHeight()){var a=b.getBoundingClientRect(),e=this._getViewPadding(),c=this._viewDiv.getBoundingClientRect();a.top<c.top+e.top&&(b=this._getLineNext(b)||b)}return b.lineIndex},_hookEvents:function(){var a=this;this._modelListener={onChanging:function(b){a._onModelChanging(b)},onChanged:function(b){a._onModelChanged(b)}};this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",
this._modelListener.onChanged);this._themeListener={onChanged:function(){a._setThemeClass(a._themeClass)}};this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);var b=this._handlers=[],e=this._clientDiv,c=this._viewDiv,l=this._rootDiv,d=this._overlayDiv||e,o=e.ownerDocument,g=this._getWindow(),h=f.isIE?o:g;b.push({target:g,type:"resize",handler:function(b){return a._handleResize(b?b:g.event)}});b.push({target:e,type:"blur",handler:function(b){return a._handleBlur(b?b:g.event)}});
b.push({target:e,type:"focus",handler:function(b){return a._handleFocus(b?b:g.event)}});b.push({target:c,type:"focus",handler:function(){e.focus()}});b.push({target:c,type:"scroll",handler:function(b){return a._handleScroll(b?b:g.event)}});b.push({target:e,type:"textInput",handler:function(b){return a._handleTextInput(b?b:g.event)}});b.push({target:e,type:"keydown",handler:function(b){return a._handleKeyDown(b?b:g.event)}});b.push({target:e,type:"keypress",handler:function(b){return a._handleKeyPress(b?
b:g.event)}});b.push({target:e,type:"keyup",handler:function(b){return a._handleKeyUp(b?b:g.event)}});f.isIE&&b.push({target:o,type:"keyup",handler:function(b){return a._handleDocKeyUp(b?b:g.event)}});b.push({target:e,type:"contextmenu",handler:function(b){return a._handleContextMenu(b?b:g.event)}});b.push({target:e,type:"copy",handler:function(b){return a._handleCopy(b?b:g.event)}});b.push({target:e,type:"cut",handler:function(b){return a._handleCut(b?b:g.event)}});b.push({target:e,type:"paste",
handler:function(b){return a._handlePaste(b?b:g.event)}});if(f.isIOS||f.isAndroid)b.push({target:o,type:"selectionchange",handler:function(b){return a._handleSelectionChange(b?b:g.event)}}),b.push({target:e,type:"touchstart",handler:function(b){return a._handleTouchStart(b?b:g.event)}}),b.push({target:e,type:"touchmove",handler:function(b){return a._handleTouchMove(b?b:g.event)}}),b.push({target:e,type:"touchend",handler:function(b){return a._handleTouchEnd(b?b:g.event)}});else{b.push({target:e,type:"selectstart",
handler:function(b){return a._handleSelectStart(b?b:g.event)}});b.push({target:e,type:"mousedown",handler:function(b){return a._handleMouseDown(b?b:g.event)}});b.push({target:e,type:"mouseover",handler:function(b){return a._handleMouseOver(b?b:g.event)}});b.push({target:e,type:"mouseout",handler:function(b){return a._handleMouseOut(b?b:g.event)}});b.push({target:h,type:"mouseup",handler:function(b){return a._handleMouseUp(b?b:g.event)}});b.push({target:h,type:"mousemove",handler:function(b){return a._handleMouseMove(b?
b:g.event)}});b.push({target:l,type:"mousedown",handler:function(b){return a._handleRootMouseDown(b?b:g.event)}});b.push({target:l,type:"mouseup",handler:function(b){return a._handleRootMouseUp(b?b:g.event)}});b.push({target:d,type:"dragstart",handler:function(b){return a._handleDragStart(b?b:g.event)}});b.push({target:d,type:"drag",handler:function(b){return a._handleDrag(b?b:g.event)}});b.push({target:d,type:"dragend",handler:function(b){return a._handleDragEnd(b?b:g.event)}});b.push({target:d,
type:"dragenter",handler:function(b){return a._handleDragEnter(b?b:g.event)}});b.push({target:d,type:"dragover",handler:function(b){return a._handleDragOver(b?b:g.event)}});b.push({target:d,type:"dragleave",handler:function(b){return a._handleDragLeave(b?b:g.event)}});b.push({target:d,type:"drop",handler:function(b){return a._handleDrop(b?b:g.event)}});b.push({target:this._clientDiv,type:f.isFirefox>26?"wheel":f.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(b){return a._handleMouseWheel(b?
b:g.event)}});this._clipDiv&&b.push({target:this._clipDiv,type:f.isFirefox>26?"wheel":f.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(b){return a._handleMouseWheel(b?b:g.event)}});if(f.isFirefox&&(!f.isWindows||f.isFirefox>=15))(c=g.MutationObserver||g.MozMutationObserver)?(this._mutationObserver=new c(function(b){a._handleDataModified(b)}),this._mutationObserver.observe(e,{subtree:!0,characterData:!0})):b.push({target:this._clientDiv,type:"DOMCharacterDataModified",handler:function(b){return a._handleDataModified(b?
b:g.event)}});this._overlayDiv&&(b.push({target:this._overlayDiv,type:"mousedown",handler:function(b){return a._handleMouseDown(b?b:g.event)}}),b.push({target:this._overlayDiv,type:"mouseover",handler:function(b){return a._handleMouseOver(b?b:g.event)}}),b.push({target:this._overlayDiv,type:"mouseout",handler:function(b){return a._handleMouseOut(b?b:g.event)}}),b.push({target:this._overlayDiv,type:"contextmenu",handler:function(b){return a._handleContextMenu(b?b:g.event)}}));this._isW3CEvents||b.push({target:this._clientDiv,
type:"dblclick",handler:function(b){return a._handleDblclick(b?b:g.event)}})}this._hookRulerEvents(this._leftDiv,b);this._hookRulerEvents(this._rightDiv,b);this._hookRulerEvents(this._marginDiv,b);for(c=0;c<b.length;c++)l=b[c],u(l.target,l.type,l.handler,l.capture)},_hookRulerEvents:function(a,b){if(a){var e=this,c=this._getWindow();f.isIE&&b.push({target:a,type:"selectstart",handler:function(){return!1}});b.push({target:a,type:f.isFirefox>26?"wheel":f.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(a){return e._handleMouseWheel(a?
a:c.event)}});b.push({target:a,type:"click",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,type:"dblclick",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,type:"mousemove",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,type:"mouseover",handler:function(a){e._handleRulerEvent(a?a:c.event)}});b.push({target:a,type:"mouseout",handler:function(a){e._handleRulerEvent(a?a:c.event)}})}},_getWindow:function(){return this._parent.ownerDocument.defaultView||
this._parent.ownerDocument.parentWindow},_ignoreEvent:function(a){for(a=a.target;a&&a!==this._clientDiv;){if(a.ignore)return!0;a=a.parentNode}return!1},_init:function(a){var b=a.parent;typeof b==="string"&&(b=(a.document||document).getElementById(b));if(!b)throw"no parent";a.parent=b;a.model=a.model||new m.TextModel;var e=this._defaultOptions(),c;for(c in e)e.hasOwnProperty(c)&&(this["_"+c]=a[c]!==void 0?a[c]:e[c].value);this._keyModes=[];this._rulers=[];this._selection=new q(0,0,!1);this._linksVisible=
!1;this._maxLineWidth=this._redrawCount=0;this._maxLineIndex=-1;this._ignoreSelect=!0;this._hasFocus=this._ignoreFocus=!1;this._dragOffset=this._columnX=-1;this._isRangeRects=(!f.isIE||f.isIE>=9)&&typeof b.ownerDocument.createRange().getBoundingClientRect==="function";this._isW3CEvents=b.addEventListener;this._autoScrollTimerID=this._autoScrollY=this._autoScrollX=null;this._AUTO_SCROLL_RATE=50;this._mouseUpClosure=this._moseMoveClosure=this._grabControl=null;this._clickCount=this._lastMouseTime=this._lastMouseY=
...
"ModelChanging";this.onModelChanging(a);a.type="Changing"},_queueUpdate:function(){if(!this._updateTimer&&!this._ignoreQueueUpdate){var a=this;this._updateTimer=this._getWindow().setTimeout(function(){a._updateTimer=null;a._update()},0)}},_resetLineHeight:function(a,b){if(this._wrapMode||this._variableLineHeight){if(a!==void 0&&b!==void 0)for(var e=a;e<b;e++)this._lineHeight[e]=void 0;else this._lineHeight=Array(this._model.getLineCount());this._calculateLineHeightTimer()}else this._lineHeight=null},
_resetLineWidth:function(){var a=this._clientDiv;if(a)for(a=a.firstChild;a;)a.lineWidth=void 0,a=a.nextSibling},_reset:function(){this._maxLineIndex=-1;this._maxLineWidth=0;this._columnX=-1;this._bottomChild=this._topChild=null;this._topIndexY=0;this._variableLineHeight=!1;this._resetLineHeight();this._setSelection(new q(0,0,!1),!1,!1);if(this._viewDiv)this._viewDiv.scrollLeft=0,this._viewDiv.scrollTop=0;var a=this._clientDiv;if(a){for(var b=a.firstChild;b;)b.lineRemoved=!0,b=b.nextSibling;if(f.isFirefox)this._ignoreFocus=
!1,(b=this._hasFocus)&&a.blur(),a.contentEditable=!1,a.contentEditable=!0,b&&a.focus(),this._ignoreFocus=!1}},_scrollViewAnimated:function(a,b,e){var c=this._getWindow();if(e&&this._scrollAnimation){var l=this;this._animation=new v({window:c,duration:this._scrollAnimation,curve:[b,0],onAnimate:function(a){a=b-Math.floor(a);l._scrollView(0,a);b-=a},onEnd:function(){l._animation=null;l._scrollView(a,b);e&&c.setTimeout(e,0)}});this._animation.play()}else this._scrollView(a,b),e&&c.setTimeout(e,0)},_scrollView:function(a,
b){this._ensureCaretVisible=!1;var e=this._viewDiv;a&&(e.scrollLeft+=a);b&&(e.scrollTop+=b)},_setClipboardText:function(a,b){var c,l=this._getWindow(),d=l.clipboardData;if(!d&&b)d=b.clipboardData;if(d&&(c=[],e(a,function(a){c.push(a)},function(){c.push(f.platformDelimiter)}),d.setData(f.isIE?"Text":"text/plain",c.join(""))))return!0;var o=this._parent.ownerDocument,g=f.createElement(o,"pre");g.style.position="fixed";g.style.left="-1000px";e(a,function(a){g.appendChild(o.createTextNode(a))},function(){g.appendChild(f.createElement(o,
"br"))});g.appendChild(o.createTextNode(" "));this._clientDiv.appendChild(g);d=o.createRange();d.setStart(g.firstChild,0);d.setEndBefore(g.lastChild);var h=l.getSelection();h.rangeCount>0&&h.removeAllRanges();h.addRange(d);var n=this,d=function(){g&&g.parentNode===n._clientDiv&&n._clientDiv.removeChild(g);n._updateDOMSelection()},h=!1;this._ignoreCopy=!0;try{h=o.execCommand("copy",!1,null)}catch(i){}this._ignoreCopy=!1;if(!h&&b)return l.setTimeout(d,0),!1;d();return!0},_setDOMSelection:function(a,
b,e,c,l){for(var d,o,g,h,n=0,i=a.firstChild,q,r,t=this._model.getLine(a.lineIndex).length;i;){if(!i.ignore){q=i.firstChild;r=q.length;i.ignoreChars&&(r-=i.ignoreChars);if(n+r>b||n+r>=t){d=q;o=b-n;i.ignoreChars&&r>0&&o===r&&(o+=i.ignoreChars);break}n+=r}i=i.nextSibling}for(var n=0,i=e.firstChild,s=this._model.getLine(e.lineIndex).length;i;){if(!i.ignore){q=i.firstChild;r=q.length;i.ignoreChars&&(r-=i.ignoreChars);if(r+n>c||n+r>=s){g=q;h=c-n;i.ignoreChars&&r>0&&h===r&&(h+=i.ignoreChars);break}n+=r}i=
i.nextSibling}this._setDOMFullSelection(a,b,t,e,c,s);a=this._getWindow();b=this._parent.ownerDocument;if(a.getSelection){e=a.getSelection();a=b.createRange();a.setStart(d,o);a.setEnd(g,h);if(this._hasFocus&&(e.anchorNode!==d||e.anchorOffset!==o||e.focusNode!==g||e.focusOffset!==h||e.anchorNode!==g||e.anchorOffset!==h||e.focusNode!==d||e.focusOffset!==o))this._anchorNode=d,this._anchorOffset=o,this._focusNode=g,this._focusOffset=h,this._ignoreSelect=!1,e.rangeCount>0&&e.removeAllRanges(),e.addRange(a),
this._ignoreSelect=!0;if(this._cursorDiv&&(a=b.createRange(),l?(a.setStart(d,o),a.setEnd(d,o)):(a.setStart(g,h),a.setEnd(g,h)),g=a.getClientRects()[0],h=this._cursorDiv.parentNode,d=h.getBoundingClientRect(),g&&d))this._cursorDiv.style.top=g.top-d.top+h.scrollTop+"px",this._cursorDiv.style.left=g.left-d.left+h.scrollLeft+"px"}else if(b.selection&&this._hasFocus)l=b.body,a=f.createElement(b,"div"),l.appendChild(a),l.removeChild(a),a=l.createTextRange(),a.moveToElementText(d.parentNode),a.moveStart("character",
...
g=this._viewDiv.getBoundingClientRect(),e=g.left+d.left,h=o.right,d=g.top+d.top,i=o.bottom,g=o=0;this._clipDiv?(g=this._clipDiv.getBoundingClientRect(),o=g.left-this._clipDiv.scrollLeft):(g=this._rootDiv.getBoundingClientRect(),o=g.left);g=g.top;this._ignoreDOMSelection=!0;var q=(new n(this,a.lineIndex,a)).getBoundingClientRect(f.getLineStart(a.lineIndex)+b,!1),r=q.left,b=(new n(this,c.lineIndex,c)).getBoundingClientRect(f.getLineStart(c.lineIndex)+l,!1),f=b.left;this._ignoreDOMSelection=!1;var t=
this._selDiv1,r=Math.min(h,Math.max(e,r)),s=Math.min(i,Math.max(d,q.top)),v=h,l=Math.min(i,Math.max(d,q.bottom));t.style.left=r-o+"px";t.style.top=s-g+"px";t.style.width=Math.max(0,v-r)+"px";t.style.height=Math.max(0,l-s)+"px";if(a.lineIndex===c.lineIndex)v=Math.min(f,h),t.style.width=Math.max(0,v-r)+"px";else if(q=Math.min(i,Math.max(d,b.top)),f=Math.min(h,Math.max(e,f)),d=Math.min(i,Math.max(d,b.bottom)),i=this._selDiv3,i.style.left=e-o+"px",i.style.top=q-g+"px",i.style.width=Math.max(0,f-e)+"px",
i.style.height=Math.max(0,d-q)+"px",Math.abs(a.lineIndex-c.lineIndex)>1)a=this._selDiv2,a.style.left=e-o+"px",a.style.top=l-g+"px",a.style.width=Math.max(0,h-e)+"px",a.style.height=Math.max(0,q-l)+"px"}},_setGrab:function(a){if(a!==this._grabControl)a?(a.setCapture&&a.setCapture(),this._grabControl=a):(this._grabControl.releaseCapture&&this._grabControl.releaseCapture(),this._grabControl=null)},_setLinksVisible:function(a){if(this._linksVisible!==a){this._linksVisible=a;if(f.isIE&&a)this._hadFocus=
this._hasFocus;var b=this._clientDiv;b.contentEditable=!a;this._hadFocus&&!a&&b.focus();if(this._overlayDiv)this._overlayDiv.style.zIndex=a?"-1":"1";for(a=this._getLineNext();a;){if(a.hasLink)for(b=a.firstChild;b;)if(b.ignore)b=b.nextSibling;else{var e=b.nextSibling,c=b.viewStyle;c&&c.tagName&&c.tagName.toLowerCase()==="a"&&a.replaceChild(a._line._createSpan(a,b.firstChild.data,c),b);b=e}a=this._getLineNext(a)}this._updateDOMSelection()}},_setSelection:function(a,b,e,c,l){if(a){this._columnX=-1;e===
void 0&&(e=!0);var f=this._selection;this._selection=a;b!==!1&&this._showCaret(!1,c,b,l);e&&this._updateDOMSelection();if(!f.equals(a))this.onSelection({type:"Selection",oldValue:{start:f.start,end:f.end},newValue:{start:a.start,end:a.end}})}},_setSelectionTo:function(a,b,e,c){var l=this._model,f=this._getSelection(),b=this.convert({x:a,y:b},"page","document"),a=this._getLineIndex(b.y);if(this._clickCount===1){l=this._getLine(a);a=l.getOffset(b.x,b.y-this._getLinePixel(a));l.destroy();if(c&&!e&&f.start<=
a&&a<f.end)return this._dragOffset=a,!1;f.extend(a);e||f.collapse()}else(this._clickCount&1)===0?(l=this._getLine(a),a=l.getOffset(b.x,b.y-this._getLinePixel(a)),this._doubleClickSelection?a>=this._doubleClickSelection.start?(e=this._doubleClickSelection.start,c=l.getNextOffset(a,{unit:"wordend",count:1})):(e=l.getNextOffset(a,{unit:"word",count:-1}),c=this._doubleClickSelection.end):(e=l.getNextOffset(a,{unit:"word",count:-1}),c=l.getNextOffset(e,{unit:"wordend",count:1})),l.destroy()):this._doubleClickSelection?
(c=l.getLineAtOffset(this._doubleClickSelection.start),a>=c?(e=l.getLineStart(c),c=l.getLineEnd(a)):(e=l.getLineStart(a),c=l.getLineEnd(c))):(e=l.getLineStart(a),c=l.getLineEnd(a)),f.setCaret(e),f.extend(c);this._setSelection(f,!0,!0);return!0},_setFullSelection:function(a,b){this._fullSelection=a;if(f.isWebkit)this._fullSelection=!0;var e=this._clipDiv||this._rootDiv;if(e)if(this._fullSelection){if(!this._selDiv1&&this._fullSelection&&!f.isIOS){var c=e.ownerDocument;this._highlightRGB=f.isWebkit?
"transparent":"Highlight";var l=f.createElement(c,"div");this._selDiv1=l;l.style.position="absolute";l.style.borderWidth="0px";l.style.margin="0px";l.style.padding="0px";l.style.outline="none";l.style.background=this._highlightRGB;l.style.width="0px";l.style.height="0px";l.style.zIndex="0";e.appendChild(l);var d=f.createElement(c,"div");this._selDiv2=d;d.style.position="absolute";d.style.borderWidth="0px";d.style.margin="0px";d.style.padding="0px";d.style.outline="none";d.style.background=this._highlightRGB;
d.style.width="0px";d.style.height="0px";d.style.zIndex="0";e.appendChild(d);this._selDiv3=c=f.createElement(c,"div");c.style.position="absolute";c.style.borderWidth="0px";c.style.margin="0px";c.style.padding="0px";c.style.outline="none";c.style.background=this._highlightRGB;c.style.width="0px";c.style.height="0px";c.style.zIndex="0";e.appendChild(c);if(f.isFirefox&&f.isMac){e=this._getWindow().getComputedStyle(c,null).getPropertyValue("background-color");switch(e){case "rgb(119, 141, 168)":e="rgb(199, 208, 218)";
break;case "rgb(127, 127, 127)":e="rgb(198, 198, 198)";break;case "rgb(255, 193, 31)":e="rgb(250, 236, 115)";break;case "rgb(243, 70, 72)":e="rgb(255, 176, 139)";break;case "rgb(255, 138, 34)":e="rgb(255, 209, 129)";break;case "rgb(102, 197, 71)":e="rgb(194, 249, 144)";break;case "rgb(140, 78, 184)":e="rgb(232, 184, 255)";break;default:e="rgb(180, 213, 255)"}this._highlightRGB=e;l.style.background=e;d.style.background=e;c.style.background=e}b||this._updateDOMSelection()}}else{if(this._selDiv1)e.removeChild(this._selDiv1),
this._selDiv1=null;if(this._selDiv2)e.removeChild(this._selDiv2),this._selDiv2=null;if(this._selDiv3)e.removeChild(this._selDiv3),this._selDiv3=null}},_setBlockCursor:function(a){this._blockCursorVisible=a;this._updateBlockCursorVisible()},_setOverwriteMode:function(a){this._overwriteMode=a;this._updateBlockCursorVisible()},_updateBlockCursorVisible:function(){if(this._blockCursorVisible||this._overwriteMode){if(!this._cursorDiv){var a=f.createElement(document,"div");a.className="textviewBlockCursor";
this._cursorDiv=a;a.tabIndex=-1;a.style.zIndex="2";a.style.color="transparent";a.style.position="absolute";a.style.pointerEvents="none";a.innerHTML="&nbsp;";this._viewDiv.appendChild(a);this._updateDOMSelection()}}else if(this._cursorDiv)this._cursorDiv.parentNode.removeChild(this._cursorDiv),this._cursorDiv=null},_setMarginOffset:function(a,b){this._marginOffset=a;this._marginDiv.style.display=a?"block":"none";if(!b)this._metrics=this._calculateMetrics(),this._queueUpdate()},_setWrapOffset:function(a,
b){this._wrapOffset=a;if(!b)this._metrics=this._calculateMetrics(),this._queueUpdate()},_setReadOnly:function(a){this._readonly=a;this._clientDiv.setAttribute("aria-readonly",a?"true":"false")},_setSingleMode:function(a,b){this._singleMode=a;this._updateOverflow();this._updateStyle(b)},_setTabSize:function(a,b){this._tabSize=a;this._customTabSize=void 0;var e=this._clientDiv;if(f.isOpera){if(e)e.style.OTabSize=this._tabSize+""}else if(f.isWebkit>=537.1){if(e)e.style.tabSize=this._tabSize+""}else if(f.isFirefox>=
4){if(e)e.style.MozTabSize=this._tabSize+""}else if(this._tabSize!==8)this._customTabSize=this._tabSize;b||(this.redrawLines(),this._resetLineWidth())},_setTheme:function(a){this._theme&&this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);(this._theme=a)&&this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);this._setThemeClass(this._themeClass)},_setThemeClass:function(a,b){this._themeClass=a;var e="textview",c=this._theme.getThemeClass();c&&(e+=" "+
c);this._themeClass&&c!==this._themeClass&&(e+=" "+this._themeClass);this._rootDiv.className=e;this._updateStyle(b)},_setWrapMode:function(a,b){this._wrapMode=a&&this._wrappable;var e=this._clientDiv;this._wrapMode?(e.style.whiteSpace="pre-wrap",e.style.wordWrap="break-word"):(e.style.whiteSpace="pre",e.style.wordWrap="normal");this._updateOverflow();b||(this.redraw(),this._resetLineWidth());this._resetLineHeight()},_showCaret:function(a,b,e,c){if(this._clientDiv){var l=this._model,f=this._getSelection(),
d=this._getScroll(),o=f.getCaret(),g=f.start,h=f.end,n=l.getLineAtOffset(h),i=Math.max(Math.max(g,l.getLineStart(n)),h-1),l=this._getClientWidth(),n=this._getClientHeight(),q=l/4,r=this._getBoundsAtOffset(o===g?g:i),t=r.left,s=r.right,v=r.top,u=r.bottom;a&&!f.isEmpty()&&(r=this._getBoundsAtOffset(o===h?g:i),r.top===v?o===g?s=t+Math.min(r.right-t,l):t=s-Math.min(s-r.left,l):o===g?u=v+Math.min(r.bottom-v,n):v=u-Math.min(u-r.top,n));a=0;t<d.x&&(a=Math.min(t-d.x,-q));s>d.x+l&&(a=Math.max(s-d.x-l,q));
f=0;v<d.y?f=v-d.y:u>d.y+n&&(f=u-d.y-n);c&&(c>0?f>0&&(f=Math.max(f,c)):f<0&&(f=Math.min(f,c)));if(a!==0||f!==0)return f!==0&&typeof e==="number"&&(e<0&&(e=0),e>1&&(e=1),f+=Math.floor(f>0?e*n:-e*n)),this._scrollViewAnimated(a,f,b),n!==this._getClientHeight()||l!==this._getClientWidth()?this._showCaret():this._ensureCaretVisible=!0,!0;else b&&b();return!1}},_startIME:function(){if(this._imeOffset===-1){var a=this._getSelection();a.isEmpty()||this._modifyContent({text:"",start:a.start,end:a.end},!0);
this._imeOffset=a.start}},_unhookEvents:function(){this._model.removeEventListener("preChanging",this._modelListener.onChanging);this._model.removeEventListener("postChanged",this._modelListener.onChanged);this._theme.removeEventListener("ThemeChanged",this._themeListener.onChanged);this._modelListener=null;for(var a=0;a<this._handlers.length;a++){var b=this._handlers[a];t(b.target,b.type,b.handler)}this._handlers=null;if(this._mutationObserver)this._mutationObserver.disconnect(),this._mutationObserver=
null},_updateDOMSelection:function(){if(!(this._redrawCount>0)&&!this._ignoreDOMSelection&&this._clientDiv){var a=this._getSelection(),b=this._model,e=b.getLineAtOffset(a.start),c=b.getLineAtOffset(a.end),l=this._getLineNext();if(l){var f=this._getLinePrevious(),d;e<l.lineIndex?(d=l,e=0):e>f.lineIndex?(d=f,e=0):(d=this._getLineNode(e),e=a.start-b.getLineStart(e));c<l.lineIndex?b=0:c>f.lineIndex?(l=f,b=0):(l=this._getLineNode(c),b=a.end-b.getLineStart(c));this._setDOMSelection(d,e,l,b,a.caret)}}},
_update:function(a){if(!(this._redrawCount>0)){if(this._updateTimer)this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1;var b=this._clientDiv,e=this._viewDiv;if(b){if(this._metrics.invalid)this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1;var c=this._model,l=this._getScroll(!1),d=this._getViewPadding(),o=c.getLineCount(),g=this._getLineHeight(),h=!1,i=!1,q=!1,r=this._metrics.scrollWidth;if(this._wrapMode)b.style.width=(this._metrics.wrapWidth||this._getClientWidth())+
"px";var t,s,v,u,k=0,p=0,m;if(this._lineHeight){for(;p<o;){m=this._getLineHeight(p);if(k+m>l.y)break;k+=m;p++}t=p;s=Math.max(0,t-1);v=c=l.y-k;t>0&&(c+=this._getLineHeight(t-1))}else u=Math.max(0,l.y)/g,t=Math.floor(u),s=Math.max(0,t-1),c=Math.round((u-s)*g),v=Math.round((u-t)*g);this._topIndexY=v;u=this._rootDiv;var I=u.clientWidth,F=u.clientHeight;if(a){g=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),g=t.right-t.left);t=this._getClientWidth();u=this._getClientHeight();i=t;if(this._wrapMode){if(this._metrics.wrapWidth)i=
this._metrics.wrapWidth}else i=Math.max(this._maxLineWidth,i);for(;p<o;)m=this._getLineHeight(p,!1),k+=m,p++;o=k}else{u=this._getClientHeight();v=Math.min(t+Math.floor((u+v)/g),o-1);var l=Math.min(v+1,o-1),A;for(m=b.firstChild;m;){A=m.lineIndex;var z=m.nextSibling;if(!(s<=A&&A<=l)||m.lineRemoved||m.lineIndex===-1)this._mouseWheelLine===m?(m.style.display="none",m.lineIndex=-1):b.removeChild(m);m=z}m=this._getLineNext();var z=e.ownerDocument,C=z.createDocumentFragment();for(A=s;A<=l;A++)if(!m||m.lineIndex>
A)(new n(this,A)).create(C,null);else{C.firstChild&&(b.insertBefore(C,m),C=z.createDocumentFragment());if(m&&m.lineChanged)m=(new n(this,A)).create(C,m),m.lineChanged=!1;m=this._getLineNext(m)}C.firstChild&&b.insertBefore(C,m);if(f.isWebkit&&!this._wrapMode)b.style.width="0x7fffffffpx";m=this._getLineNext();A=u+c;for(C=!1;m;){s=m.lineWidth;if(s===void 0)if(z=m._line.getBoundingClientRect(),s=m.lineWidth=Math.ceil(z.right-z.left),z=z.bottom-z.top,this._lineHeight)this._lineHeight[m.lineIndex]=z;else if(g!==
0&&z!==0&&Math.ceil(g)!==Math.ceil(z))this._variableLineHeight=!0,this._lineHeight=[],this._lineHeight[m.lineIndex]=z;if(this._lineHeight&&!C&&(A-=this._lineHeight[m.lineIndex],A<0))v=m.lineIndex,C=!0;if(!this._wrapMode){if(s>=this._maxLineWidth)this._maxLineWidth=s,this._maxLineIndex=m.lineIndex;if(this._checkMaxLineIndex===m.lineIndex)this._checkMaxLineIndex=-1}if(m.lineIndex===t)this._topChild=m;if(m.lineIndex===v)this._bottomChild=m;m=this._getLineNext(m)}if(this._checkMaxLineIndex!==-1&&(A=this._checkMaxLineIndex,
this._checkMaxLineIndex=-1,0<=A&&A<o)){g=new n(this,A);z=g.getBoundingClientRect();s=z.right-z.left;if(s>=this._maxLineWidth)this._maxLineWidth=s,this._maxLineIndex=A;g.destroy()}for(;p<o;)m=this._getLineHeight(p,p<=v),k+=m,p++;o=k;this._updateRuler(this._leftDiv,t,l,F);this._updateRuler(this._rightDiv,t,l,F);this._updateRuler(this._marginDiv,t,l,F);g=0;this._leftDiv&&(t=this._leftDiv.getBoundingClientRect(),g=t.right-t.left);l=0;this._rightDiv&&(l=this._rightDiv.getBoundingClientRect(),l=l.right-
l.left);e.style.left=g+"px";e.style.right=l+"px";l=this._scrollDiv;l.style.height=o+"px";t=this._getClientWidth();if(!this._singleMode&&!this._wrapMode){k=h=u;(p=e.style.overflowX==="scroll")?h+=r:k-=r;m=v=t;(s=e.style.overflowY==="scroll")?v+=r:m-=r;u=h;t=v;o>u&&(q=!0,t=m);this._maxLineWidth>t&&(i=!0,u=k,o>u&&(q=!0,t=m));if(p!==i)e.style.overflowX=i?"scroll":"hidden";if(s!==q)e.style.overflowY=q?"scroll":"hidden";h=p!==i||s!==q}q=t;if(this._wrapMode){if(this._metrics.wrapWidth)q=this._metrics.wrapWidth}else q=
Math.max(this._maxLineWidth,q);i=q;if((!f.isIE||f.isIE>=9)&&this._maxLineWidth>t)q+=d.right+d.left;l.style.width=q+"px";if(this._clipScrollDiv)this._clipScrollDiv.style.width=q+"px";l=this._getScroll(!1)}if(this._vScrollDiv)q=u-8,k=Math.max(15,Math.ceil(Math.min(1,q/(o+d.top+d.bottom))*q)),this._vScrollDiv.style.left=g+t-8+"px",this._vScrollDiv.style.top=Math.floor(Math.max(0,l.y*q/o))+"px",this._vScrollDiv.style.height=k+"px";if(!this._wrapMode&&this._hScrollDiv)q=t-8,k=Math.max(15,Math.ceil(Math.min(1,
q/(this._maxLineWidth+d.left+d.right))*q)),this._hScrollDiv.style.left=g+Math.floor(Math.max(0,Math.floor(l.x*q/this._maxLineWidth)))+"px",this._hScrollDiv.style.top=u-9+"px",this._hScrollDiv.style.width=k+"px";p=l.x;k=this._clipDiv;q=this._overlayDiv;if(v=this._marginDiv)v.style.left=-p+g+this._metrics.marginWidth+d.left+"px",v.style.bottom=(e.style.overflowX==="scroll"?r:0)+"px";if(k){k.scrollLeft=p;k.scrollTop=0;e=g+d.left;r=d.top;a=t;g=u;p=0;v=-c;if(l.x===0)e-=d.left,a+=d.left,p=d.left;l.x+t===
i&&(a+=d.right);l.y===0&&(r-=d.top,g+=d.top,v+=d.top);l.y+u===o&&(g+=d.bottom);k.style.left=e+"px";k.style.top=r+"px";k.style.right=I-a-e+"px";k.style.bottom=F-g-r+"px";b.style.left=p+"px";b.style.top=v+"px";b.style.width=i+"px";b.style.height=u+c+"px";if(q)q.style.left=b.style.left,q.style.top=b.style.top,q.style.width=b.style.width,q.style.height=b.style.height}else{e=p;r=c;I=p+t;F=c+u;e===0&&(e-=d.left);r===0&&(r-=d.top);I===i&&(I+=d.right);l.y+u===o&&(F+=d.bottom);b.style.clip="rect("+r+"px,"+
I+"px,"+F+"px,"+e+"px)";b.style.left=-p+g+d.left+"px";b.style.width=(this._wrapMode||f.isWebkit?i:t+p)+"px";if(!a)b.style.top=-c+d.top+"px",b.style.height=u+c+"px";if(q&&(q.style.clip=b.style.clip,q.style.left=b.style.left,q.style.width=b.style.width,!a))q.style.top=b.style.top,q.style.height=b.style.height}this._updateDOMSelection();if(h)b=this._ensureCaretVisible,this._ensureCaretVisible=!1,b&&this._showCaret(),this._queueUpdate()}}},_updateOverflow:function(){var a=this._viewDiv;this._wrapMode?
(a.style.overflowX="hidden",a.style.overflowY="scroll"):a.style.overflow="hidden"},_updateRuler:function(a,b,e,c){if(a)for(var l=this._parent.ownerDocument,d=this._getLineHeight(),o=this._getViewPadding(),a=a.firstChild;a;){var g=a._ruler,n=d,i=g.getOverview();i==="page"&&(n+=this._topIndexY);a.style.top=-n+"px";a.style.height=c+n+"px";a.rulerChanged&&h(g.getRulerStyle(),a);var q,r=a.firstChild;r?(q=r,r=r.nextSibling):(q=f.createElement(l,"div"),q.style.visibility="hidden",a.appendChild(q));var t;
if(a.rulerChanged&&q){n=-1;if(t=g.getWidestAnnotation())if(h(t.style,q),t.html)q.innerHTML=t.html;q.lineIndex=n;q.style.height=d+o.top+"px"}var s;if(i==="page"){for(g=g.getAnnotations(b,e+1);r;)n=r.lineIndex,t=r.nextSibling,(!(b<=n&&n<=e)||r.lineChanged)&&a.removeChild(r),r=t;r=a.firstChild.nextSibling;s=l.createDocumentFragment();for(n=b;n<=e;n++)if(!r||r.lineIndex>n){q=f.createElement(l,"div");if(t=g[n]){h(t.style,q);if(t.html)q.innerHTML=t.html;q.annotation=t}q.lineIndex=n;q.style.height=this._getLineHeight(n)+
"px";s.appendChild(q)}else if(s.firstChild&&(a.insertBefore(s,r),s=l.createDocumentFragment()),r)r=r.nextSibling;s.firstChild&&a.insertBefore(s,r)}else{t=this._getClientHeight();n=this._model.getLineCount();r=t+o.top+o.bottom-2*this._metrics.scrollWidth;i=d*n<r?d:r/n;if(a.rulerChanged){for(t=a.childNodes.length;t>1;)a.removeChild(a.lastChild),t--;g=g.getAnnotations(0,n);s=l.createDocumentFragment();for(var v in g)if(n=v>>>0,!(n<0)){q=f.createElement(l,"div");t=g[v];h(t.style,q);q.style.position="absolute";
q.style.top=this._metrics.scrollWidth+d+Math.floor(n*i)+"px";if(t.html)q.innerHTML=t.html;q.annotation=t;q.lineIndex=n;s.appendChild(q)}a.appendChild(s)}else if(a._oldTrackHeight!==r)for(q=a.firstChild?a.firstChild.nextSibling:null;q;)q.style.top=this._metrics.scrollWidth+d+Math.floor(q.lineIndex*i)+"px",q=q.nextSibling;a._oldTrackHeight=r}a.rulerChanged=!1;a=a.nextSibling}},_updateStyleSheet:function(){var a="";f.isWebkit&&this._metrics.scrollWidth>0&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");
f.isFirefox&&f.isMac&&this._highlightRGB&&this._highlightRGB!=="Highlight"&&(a+="\n.textview ::-moz-selection {background: "+this._highlightRGB+";}");if(a){var b=document.getElementById("_textviewStyle");if(b)b.removeChild(b.firstChild),b.appendChild(document.createTextNode(a));else{b=f.createElement(document,"style");b.id="_textviewStyle";var e=document.getElementsByTagName("head")[0]||document.documentElement;b.appendChild(document.createTextNode(a));e.insertBefore(b,e.firstChild)}}},_updateStyle:function(a){if(!a&&
f.isIE)this._rootDiv.style.lineHeight="normal";var b=this._metrics=this._calculateMetrics();this._rootDiv.style.lineHeight=f.isIE?b.lineHeight-(b.lineTrim.top+b.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();a||(this.redraw(),this._resetLineWidth())}};i.EventTarget.addMixin(s.prototype);return{TextView:s}});
define("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(k,m){function p(i){this._model=i;this._projections=[];var c=this;this._listener={onChanged:function(d){c._onChanged(d)},onChanging:function(d){c._onChanging(d)}};i.addEventListener("postChanged",this._listener.onChanged);i.addEventListener("preChanging",this._listener.onChanging)}p.prototype={destroy:function(){if(this._model)this._model.removeEventListener("postChanged",this._listener.onChanged),
this._model.removeEventListener("preChanging",this._listener.onChanging),this._model=null},addProjection:function(i){if(i){var c=this._model,d=this._projections;i._lineIndex=c.getLineAtOffset(i.start);i._lineCount=c.getLineAtOffset(i.end)-i._lineIndex;var f=i.text;f||(f="");i._model=typeof f==="string"?new k.TextModel(f,c.getLineDelimiter()):f;var c=this.mapOffset(i.start,!0),f=i.end-i.start,h=i._lineCount,g=i._model.getCharCount(),b=i._model.getLineCount()-1;this.onChanging({type:"Changing",text:i._model.getText(),
start:c,removedCharCount:f,addedCharCount:g,removedLineCount:h,addedLineCount:b});var a=this._binarySearch(d,i.start);d.splice(a,0,i);this.onChanged({type:"Changed",start:c,removedCharCount:f,addedCharCount:g,removedLineCount:h,addedLineCount:b})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(i,c){var d=this._projections,f=0,h,g;if(c){for(h=0;h<d.length;h++){g=d[h];if(g.start>i)break;if(g.end>i)return-1;f+=g._model.getCharCount()-
(g.end-g.start)}return i+f}for(h=0;h<d.length;h++){g=d[h];if(g.start>i-f)break;var b=g._model.getCharCount();if(g.start+b>i-f)return-1;f+=b-(g.end-g.start)}return i-f},removeProjection:function(i){var c,d=0;for(c=0;c<this._projections.length;c++){var f=this._projections[c];if(f===i){i=f;break}d+=f._model.getCharCount()-(f.end-f.start)}if(c<this._projections.length){var f=this._model,d=i.start+d,h=i.end-i.start,g=i._lineCount,b=i._model.getCharCount(),a=i._model.getLineCount()-1;this.onChanging({type:"Changing",
text:f.getText(i.start,i.end),start:d,removedCharCount:b,addedCharCount:h,removedLineCount:a,addedLineCount:g});this._projections.splice(c,1);this.onChanged({type:"Changed",start:d,removedCharCount:b,addedCharCount:h,removedLineCount:a,addedLineCount:g})}},_binarySearch:function(i,c){for(var d=i.length,f=-1,h;d-f>1;)h=Math.floor((d+f)/2),c<=i[h].start?d=h:f=h;return d},getCharCount:function(){for(var i=this._model.getCharCount(),c=this._projections,d=0;d<c.length;d++){var f=c[d];i+=f._model.getCharCount()-
(f.end-f.start)}return i},getLine:function(i,c){if(i<0)return null;var d=this._model,f=this._projections,h=0,g=[],b=0,a,e,l;for(a=0;a<f.length;a++){l=f[a];if(l._lineIndex>=i-h)break;e=l._model.getLineCount()-1;if(l._lineIndex+e>=i-h)if(b=i-(l._lineIndex+h),b<e)return l._model.getLine(b,c);else g.push(l._model.getLine(e));b=l.end;h+=e-l._lineCount}for(b=Math.max(b,d.getLineStart(i-h));a<f.length;a++){l=f[a];if(l._lineIndex>i-h)break;g.push(d.getText(b,l.start));e=l._model.getLineCount()-1;if(l._lineIndex+
e>i-h)return g.push(l._model.getLine(0,c)),g.join("");g.push(l._model.getText());b=l.end;h+=e-l._lineCount}f=d.getLineEnd(i-h,c);b<f&&g.push(d.getText(b,f));return g.join("")},getLineAtOffset:function(i){for(var c=this._model,d=this._projections,f=0,h=0,g=0;g<d.length;g++){var b=d[g];if(b.start>i-f)break;var a=b._model.getCharCount();if(b.start+a>i-f){d=i-(b.start+f);h+=b._model.getLineAtOffset(d);f+=d;break}h+=b._model.getLineCount()-1-b._lineCount;f+=a-(b.end-b.start)}return c.getLineAtOffset(i-
f)+h},getLineCount:function(){for(var i=this._projections,c=this._model.getLineCount(),d=0;d<i.length;d++){var f=i[d];c+=f._model.getLineCount()-1-f._lineCount}return c},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(i,c){if(i<0)return-1;for(var d=this._model,f=this._projections,h=0,g=0,b=0;b<f.length;b++){var a=f[b];if(a._lineIndex>i-h)break;var e=a._model.getLineCount()-1;if(a._lineIndex+e>i-h)return a._model.getLineEnd(i-(a._lineIndex+h),c)+a.start+g;g+=
a._model.getCharCount()-(a.end-a.start);h+=e-a._lineCount}return d.getLineEnd(i-h,c)+g},getLineStart:function(i){if(i<0)return-1;for(var c=this._model,d=this._projections,f=0,h=0,g=0;g<d.length;g++){var b=d[g];if(b._lineIndex>=i-f)break;var a=b._model.getLineCount()-1;if(b._lineIndex+a>=i-f)return b._model.getLineStart(i-(b._lineIndex+f))+b.start+h;h+=b._model.getCharCount()-(b.end-b.start);f+=a-b._lineCount}return c.getLineStart(i-f)+h},getText:function(i,c){i===void 0&&(i=0);var d=this._model,f=
this._projections,h=0,g=[],b,a,e;for(b=0;b<f.length;b++){a=f[b];if(a.start>i-h)break;e=a._model.getCharCount();if(a.start+e>i-h)if(c!==void 0&&a.start+e>c-h)return a._model.getText(i-(a.start+h),c-(a.start+h));else g.push(a._model.getText(i-(a.start+h))),i=a.end+h+e-(a.end-a.start);h+=e-(a.end-a.start)}var l=i-h;if(c!==void 0){for(;b<f.length;b++){a=f[b];if(a.start>c-h)break;g.push(d.getText(l,a.start));e=a._model.getCharCount();if(a.start+e>c-h)return g.push(a._model.getText(0,c-(a.start+h))),g.join("");
g.push(a._model.getText());l=a.end;h+=e-(a.end-a.start)}g.push(d.getText(l,c-h))}else{for(;b<f.length;b++)a=f[b],g.push(d.getText(l,a.start)),g.push(a._model.getText()),l=a.end;g.push(d.getText(l))}return g.join("")},_onChanged:function(){var i=this._change,c=i.baseStart,d=i.baseEnd,f,h,g=this._projections;for(f=0;f<g.length;f++)if(h=g[f],h.end>c)break;var b=f;for(f=0;f<g.length;f++)if(h=g[f],h.start>=d)break;var a=f,e=this._model,c=i.baseText.length-(d-c);for(f=a;f<g.length;f++)h=g[f],h.start+=c,
h.end+=c,h._lineIndex=e.getLineAtOffset(h.start);h=g.splice(b,a-b);for(f=0;f<h.length;f++)h[f].annotation&&h[f].annotation._expand();this.onChanged({type:"Changed",start:i.start,removedCharCount:i.removedCharCount,addedCharCount:i.addedCharCount,removedLineCount:i.removedLineCount,addedLineCount:i.addedLineCount});this._change=void 0},_onChanging:function(i){var c=!!this._change,d=this._change||{},f=i.start,h=f+i.removedCharCount;d.baseStart=f;d.baseEnd=h;d.baseText=i.text;d.addedLineCount=i.addedLineCount;
if(!c){this._change=d;d.text=i.text;var g=this._projections,b,a,e,i=function(c){for(a=0,b=0;a<g.length;a++){e=g[a];if(e.start>c)break;if(e.end>c)return-1;b+=e._model.getCharCount()-(e.end-e.start)}return c+b};d.start=i(f);if(d.start===-1)d.text=this._model.getText(e.start,f)+d.text,d.addedLineCount+=this._model.getLineAtOffset(f)-this._model.getLineAtOffset(e.start),d.start=e.start+b;d.end=i(h);if(d.end===-1)d.text+=this._model.getText(h,e.end),d.addedLineCount+=this._model.getLineAtOffset(e.end)-
this._model.getLineAtOffset(h),d.end=e.start+b}d.addedCharCount=d.text.length;d.removedCharCount=d.end-d.start;d.removedLineCount=this.getLineAtOffset(d.end)-this.getLineAtOffset(d.start);this.onChanging({type:"Changing",text:d.text,start:d.start,removedCharCount:d.removedCharCount,addedCharCount:d.addedCharCount,removedLineCount:d.removedLineCount,addedLineCount:d.addedLineCount})},onChanging:function(i){return this.dispatchEvent(i)},onChanged:function(i){return this.dispatchEvent(i)},setLineDelimiter:function(i){this._model.setLineDelimiter(i)},
setText:function(i,c,d){function f(e){for(b=0,g=0;b<h.length;b++){a=h[b];if(a.start>e-g)break;var c=a._model.getCharCount();if(a.start+c>e-g)return-1;g+=c-(a.end-a.start)}return e-g}this._change={text:i||"",start:c||0,end:d===void 0?this.getCharCount():d};var h=this._projections,g,b,a,e,l,i=f(this._change.start);if(i===-1)e={projection:a,start:this._change.start-(a.start+g)},i=a.end;c=f(this._change.end);if(c===-1)l={projection:a,end:this._change.end-(a.start+g)},c=a.start;if(e&&l&&e.projection===
l.projection)a._model.setText(this._change.text,e.start,l.end);else{this._model.setText(this._change.text,i,c);if(e)a=e.projection,a._model.setText("",e.start);if(l)a=l.projection,a._model.setText("",0,l.end),a.start=a.end,a._lineCount=0}this._change=void 0}};m.EventTarget.addMixin(p.prototype);return{ProjectionTextModel:p}});
define("orion/editor/annotations",["i18n!orion/editor/nls/messages","orion/editor/eventTarget"],function(k,m){function p(b,a,e){this.start=b;this.end=a;this._projectionModel=e;this.html=this._expandedHTML;this.style=this._expandedStyle;this.expanded=!0}function i(){}function c(b,a){var e=b.lastIndexOf("."),e=b.substring(e+1),c={title:k[e],style:{styleClass:"annotation "+e},html:"<div class='annotationHTML "+e+"'></div>",overviewStyle:{styleClass:"annotationOverview "+e}};a?c.lineStyle={styleClass:"annotationLine "+
...
"orion.annotation.currentBlame";var g={};i.registerType=function(b,a){var e=a;if(typeof e!=="function")e=function(a,b,e){this.start=a;this.end=b;if(e!==void 0)this.title=e},e.prototype=a;e.prototype.type=b;g[b]=e;return b};i.createAnnotation=function(b,a,e,c){return new (this.getType(b))(a,e,c)};i.getType=function(b){return g[b]};c(i.ANNOTATION_ERROR);c(i.ANNOTATION_WARNING);c(i.ANNOTATION_TASK);c(i.ANNOTATION_BREAKPOINT);c(i.ANNOTATION_BOOKMARK);c(i.ANNOTATION_CURRENT_BRACKET);c(i.ANNOTATION_MATCHING_BRACKET);
c(i.ANNOTATION_CURRENT_SEARCH);c(i.ANNOTATION_MATCHING_SEARCH);c(i.ANNOTATION_READ_OCCURRENCE);c(i.ANNOTATION_WRITE_OCCURRENCE);c(i.ANNOTATION_SELECTED_LINKED_GROUP);c(i.ANNOTATION_CURRENT_LINKED_GROUP);c(i.ANNOTATION_LINKED_GROUP);c(i.ANNOTATION_CURRENT_LINE,!0);c(i.ANNOTATION_BLAME,!0);c(i.ANNOTATION_CURRENT_BLAME,!0);i.registerType(i.ANNOTATION_FOLDING,p);d.addMixin=function(b){var a=d.prototype,e;for(e in a)a.hasOwnProperty(e)&&(b[e]=a[e])};d.prototype={addAnnotationType:function(b){if(!this._annotationTypes)this._annotationTypes=
...
g._oldEnd=g.end,g.start+=b,g.end+=b,f.changed.push(g);else if(!(g.end<=a))g.start<a&&d<g.end?(g._oldStart=g.start,g._oldEnd=g.end,g.end+=b,f.changed.push(g)):(c.splice(e,1),f.removed.push(g),g._annotationModel=null,g.expand&&g.expand(),e--)}if(f.added.length>0||f.removed.length>0||f.changed.length>0)this.onChanged(f)}}};m.EventTarget.addMixin(f.prototype);h.prototype={destroy:function(){var b=this._view;if(b)b.removeEventListener("Destroy",this._listener.onDestroy),b.removeEventListener("LineStyle",
...
e.mapOffset(g,!0));b.ranges=this._mergeStyleRanges(b.ranges,{start:f,end:g,style:d.rangeStyle})}if(d.lineStyle)b.style=this._mergeStyle({},b.style),b.style=this._mergeStyle(b.style,d.lineStyle)}}};d.addMixin(h.prototype);return{FoldingAnnotation:p,AnnotationType:i,AnnotationTypeList:d,AnnotationModel:f,AnnotationStyler:h}});
define("orion/editor/tooltip","i18n!orion/editor/nls/messages,orion/editor/textView,orion/editor/textModel,orion/editor/projectionTextModel,orion/editor/util,orion/util".split(","),function(k,m,p,i,c,d){function f(c){this._view=c;this._fadeDelay=500;this._hideDelay=200;this._showDelay=500;this._autoHideDelay=5E3;this._create(c.getOptions("parent").ownerDocument)}f.getTooltip=function(c){if(!c._tooltip)c._tooltip=new f(c);return c._tooltip};f.prototype={_create:function(f){if(!this._tooltipDiv){var g=
this._tooltipDiv=d.createElement(f,"div");g.tabIndex=0;g.className="textviewTooltip";g.setAttribute("aria-live","assertive");g.setAttribute("aria-atomic","true");var b=this._tooltipContents=d.createElement(f,"div");g.appendChild(b);f.body.appendChild(g);var a=this;c.addEventListener(g,"mouseover",function(){if(a._hideDelay){var b=a._getWindow();if(a._delayedHideTimeout)b.clearTimeout(a._delayedHideTimeout),a._delayedHideTimeout=null;if(a._hideTimeout)b.clearTimeout(a._hideTimeout),a._hideTimeout=
null;a._nextTarget=null}},!1);c.addEventListener(g,"mouseout",function(b){b=b.relatedTarget||b.toElement;b===g||a._hasFocus()||(!b||!c.contains(g,b))&&a._hide()},!1);c.addEventListener(g,"keydown",function(b){b.keyCode===27&&a._hide()},!1);c.addEventListener(f,"mousedown",this._mouseDownHandler=function(b){a.isVisible()&&(c.contains(g,b.target||b.srcElement)||a._hide())},!0);this._view.addEventListener("Destroy",function(){a.destroy()});this._hide()}},_getWindow:function(){var c=this._tooltipDiv.ownerDocument;
...
n=this._getWindow();r._hideTimeout=n.setTimeout(function(){r._hideTimeout=null;var a=parseFloat(r._getNodeStyle(b,"opacity","1"));r._fadeTimeout=n.setInterval(function(){b.style.visibility==="visible"&&a>0?(a-=0.1,b.style.opacity=a):r._hide()},r._fadeDelay/10)},r._autoHideDelay)}}}},_getAnnotationContents:function(f){function g(a,b){var e=s.getLineStart(s.getLineAtOffset(a)),c=s.getLineEnd(s.getLineAtOffset(b),!0);return s.getText(e,c)}function b(a){var b=a.title,e=d.createElement(q,"div");e.className=
"tooltipRow";if(a.html)e.innerHTML=a.html,e.lastChild&&c.addEventListener(e.lastChild,"click",function(){var b=a.start,e=a.end;n.getBaseModel&&(b=n.mapOffset(b,!0),e=n.mapOffset(e,!0));r.setSelection(b,e,1/3,function(){o._hide()})},!1),e.appendChild(q.createTextNode("\u00a0"));b||(b=g(a.start,a.end));typeof b==="function"&&(b=a.title());if(typeof b==="string"){var l=d.createElement(q,"span");l.appendChild(q.createTextNode(b));b=l}e.appendChild(b);return e}for(var a,e=[],l=0;l<f.length;l++)a=f[l],
a.title!==""&&!a.groupAnnotation&&e.push(a);f=e;if(f.length===0)return null;var o=this,q=this._tooltipDiv.ownerDocument,r=this._view,n=r.getModel(),s=n.getBaseModel?n.getBaseModel():n;if(f.length===1)if(a=f[0],a.title!==void 0){a=b(a);if(a.firstChild)(f=a.firstChild.className)&&(f+=" "),f+="single",a.firstChild.className=f;return a}else return f=new i.ProjectionTextModel(s),e=s.getLineStart(s.getLineAtOffset(a.start)),l=s.getCharCount(),a.end!==l&&f.addProjection({start:a.end,end:l}),e>0&&f.addProjection({start:0,
...
define("orion/editor/rulers",["i18n!orion/editor/nls/messages","orion/editor/annotations","orion/editor/tooltip","orion/util"],function(k,m,p,i){function c(b,a,e,c){this._location=a||"left";this._overview=e||"page";this._rulerStyle=c;this._view=null;var d=this;this._listener={onTextModelChanged:function(a){d._onTextModelChanged(a)},onAnnotationModelChanged:function(a){d._onAnnotationModelChanged(a)}};this.setAnnotationModel(b)}function d(b,a,e,l,d){c.call(this,b,a,"page",e);this._oddStyle=l||{style:{backgroundColor:"white"}};
this._evenStyle=d||{style:{backgroundColor:"white"}};this._numOfDigits=0;this._firstLine=1}function f(b,a,e){c.call(this,b,a,"page",e)}function h(b,a,e){c.call(this,b,a,"document",e)}function g(b,a,e){f.call(this,b,a,e)}c.prototype={getAnnotations:function(b,a){var e=this._annotationModel;if(!e)return[];var c=this._view.getModel(),d=c.getLineStart(b),f=c.getLineEnd(a-1),g=c;c.getBaseModel&&(g=c.getBaseModel(),d=c.mapOffset(d),f=c.mapOffset(f));for(var n=[],e=this.getAnnotationsByType(e,d,f),d=0;d<
e.length;d++)for(var f=e[d],h=g.getLineAtOffset(f.start),i=g.getLineAtOffset(Math.max(f.start,f.end-1)),t=h;t<=i;t++){var v=t;if(c!==g){v=g.getLineStart(t);v=c.mapOffset(v,!0);if(v===-1)continue;v=c.getLineAtOffset(v)}if(b<=v&&v<a){var j=this._mergeAnnotation(n[v],f,t-h,i-h+1);j&&(n[v]=j)}}if(!this._multiAnnotation&&this._multiAnnotationOverlay)for(var k in n)n[k]._multiple&&(n[k].html+=this._multiAnnotationOverlay.html);return n},getAnnotationModel:function(){return this._annotationModel},getLocation:function(){return this._location},
...
b.styleClass+=" "+a.styleClass:b.styleClass=a.styleClass;var e;if(a.style){if(!b.style)b.style={};for(e in a.style)b.style[e]===void 0&&(b.style[e]=a.style[e])}if(a.attributes){if(!b.attributes)b.attributes={};for(e in a.attributes)b.attributes[e]===void 0&&(b.attributes[e]=a.attributes[e])}}return b},_setCurrentGroup:function(b){var a=this._annotationModel,e=null,c=a.getTextModel(),d,f=this._currentGroupAnnotation;if(b!==-1){var g=c.getLineStart(b),n=c.getLineEnd(b);c.getBaseModel&&(g=c.mapOffset(g),
n=c.mapOffset(n));for(d=a.getAnnotations(g,n);d.hasNext();)if(c=d.next(),this.isAnnotationTypeVisible(c.type)&&c.start<=g&&c.end>=n&&c.groupId!==void 0){e=c;break}if(f&&e&&f.groupId===e.groupId)return}this._currentGroupAnnotation=null;f&&a.removeAnnotations(f.groupType);if(e&&b!==-1){this._currentGroupAnnotation=e;d=a.getAnnotations();for(b=[];d.hasNext();)c=d.next(),delete c.groupAnnotation,c.groupId===e.groupId&&(c=c.createGroupAnnotation(),b.push(c));a.replaceAnnotations(null,b)}}};m.AnnotationTypeList.addMixin(c.prototype);
...
function(b){this._firstLine=b!==void 0?b:1};d.prototype._onTextModelChanged=function(b){var b=b.start,a=this._view.getModel(),e=(this._firstLine+(a.getBaseModel?a.getBaseModel().getLineCount():a.getLineCount())-1+"").length;if(this._numOfDigits!==e)this._numOfDigits=e,this._view.redrawLines(a.getLineAtOffset(b),a.getLineCount(),this)};f.prototype=new c;h.prototype=new c;h.prototype.getRulerStyle=function(){var b={style:{lineHeight:"1px",fontSize:"1px"}};return b=this._mergeStyle(b,this._rulerStyle)};
h.prototype._getTooltipContents=function(b,a){if(a.length===0){var e=this._view.getModel(),d=b;e.getBaseModel&&(d=e.getLineStart(d),d=e.getBaseModel().getLineAtOffset(e.mapOffset(d)));return i.formatMessage(k.line,d+1)}return c.prototype._getTooltipContents.call(this,b,a)};h.prototype._mergeAnnotation=function(b,a,e,c){if(e===0){if(!b)b={html:"&nbsp;",style:{style:{height:3*c+"px"}}},b.style=this._mergeStyle(b.style,a.overviewStyle);return b}};g.prototype=new f;g.prototype.onClick=function(b){if(b!==
void 0){var a=this._annotationModel;if(a){var e=this._view.getModel(),c=e.getLineStart(b),b=e.getLineEnd(b,!0);e.getBaseModel&&(c=e.mapOffset(c),b=e.mapOffset(b),e=e.getBaseModel());for(var d,a=a.getAnnotations(c,b);!d&&a.hasNext();)b=a.next(),this.isAnnotationTypeVisible(b.type)&&(d=b);d&&e.getLineAtOffset(d.start)===e.getLineAtOffset(c)&&((e=p.Tooltip.getTooltip(this._view))&&e.setTarget(null),d.expanded?d.collapse():d.expand())}}};g.prototype._getTooltipContents=function(b,a){return a.length===
1&&a[0].expanded?null:f.prototype._getTooltipContents.call(this,b,a)};g.prototype._onAnnotationModelChanged=function(b){function a(a){for(g=0;g<a.length;g++)if(d.isAnnotationTypeVisible(a[g].type)){var b=a[g].start;c.getBaseModel&&(b=c.mapOffset(b,!0));b!==-1&&(n=Math.min(n,c.getLineAtOffset(b)))}}if(b.textModelChangedEvent)f.prototype._onAnnotationModelChanged.call(this,b);else{var e=this._view;if(e){var c=e.getModel(),d=this,g,h=c.getLineCount(),n=h;a(b.added);a(b.removed);a(b.changed);b=e.getRulers();
for(g=0;g<b.length;g++)e.redrawLines(n,h,b[g])}}};return{Ruler:c,AnnotationRuler:f,LineNumberRuler:d,OverviewRuler:h,FoldingRuler:g}});
define("orion/editor/undoStack",[],function(){function k(i,c,d,f,h){this.model=i;this.offset=c;this.text=d;this.previousText=f;this.type=h}function m(i){this.owner=i;this.changes=[]}function p(i,c){this.size=c!==void 0?c:100;this.reset();var d=this;this._listener={onChanging:function(c){d._onChanging(c)},onDestroy:function(c){d._onDestroy(c)}};if(i.getModel){var f=i.getModel();f.getBaseModel&&(f=f.getBaseModel());this.model=f;this.setView(i)}else this.shared=!0,this.model=i;this.model.addEventListener("Changing",
this._listener.onChanging)}k.prototype={getRedoChanges:function(){return[{start:this.offset,end:this.offset+this.previousText.length,text:this.text}]},getUndoChanges:function(){return[{start:this.offset,end:this.offset+this.text.length,text:this.previousText}]},undo:function(i,c){this._doUndoRedo(this.offset,this.previousText,this.text,i,c);return!0},redo:function(i,c){this._doUndoRedo(this.offset,this.text,this.previousText,i,c);return!0},merge:function(i,c,d,f,h){if(f===this.type)if(f===1&&i===
this.offset+this.text.length)return this.text+=c,!0;else if(f===-1&&h===this.offset)return this.offset=i,this.previousText=d+this.previousText,!0;else if(f===-1&&i===this.offset)return this.previousText+=d,!0;return!1},_doUndoRedo:function(i,c,d,f,h){this.model.setText(c,i,i+d.length);h&&f&&(d=f.getModel(),d!==this.model&&(i=d.mapOffset(i,!0)),f.setSelection(i,i+c.length))}};m.prototype={getRedoChanges:function(){for(var i=[],c=0;c<this.changes.length;c++)i=i.concat(this.changes[c].getRedoChanges());
...
_onDestroy:function(i){(!i||!this.shared)&&this.model.removeEventListener("Changing",this._listener.onChanging);if(this.view)this.view.removeEventListener("Destroy",this._listener.onDestroy),this.view=null},_onChanging:function(i){if(!this._ignoreUndo){var c=i.text,d=i.start,f=i.addedCharCount,h=i.removedCharCount,i=d+h,g=0;f===0&&h===1?g=-1:f===1&&h===0&&(g=1);f=this.stack.length;h=this.model.getText(d,i);(!(f>0&&this.index===f)||!this.stack[f-1].merge(d,c,h,g,i))&&this.add(new k(this.model,d,c,
h,g))}}};return{UndoStack:p}});
...
c.getModel(),f=a?d.getLineAtOffset(a.start):-1,h=d.getLineAtOffset(b.start),c=b.start===b.end,n=!a||a.start===a.end,i=d.getLineStart(h),k=d.getLineEnd(h);d.getBaseModel&&(i=d.mapOffset(i),k=d.mapOffset(k));d=this._currentLineAnnotation;if(!(f===h&&n&&c&&d&&d.start===i&&d.end===k)){var f=d?[d]:null,t;c&&(d=g.createAnnotation(g.ANNOTATION_CURRENT_LINE,i,k),t=[d]);this._currentLineAnnotation=d;e.replaceAnnotations(f,t)}}}},installTextView:function(){this.install()},install:function(){if(!this._textView){this._textView=
...
a=b.mapOffset(e.getLineEnd(a)),e=c.getAnnotations(d,a),f=null;e.hasNext();){var l=e.next();if(l.type===g.ANNOTATION_BOOKMARK){f=l;break}}f?c.removeAnnotation(f):(f=g.createAnnotation(g.ANNOTATION_BOOKMARK,d,a),f.title=void 0,c.addAnnotation(f))}};if(this._annotationFactory){var d=a.getModel();d.getBaseModel&&(d=d.getBaseModel());if(this._annotationModel=this._annotationFactory.createAnnotationModel(d))if(d=this._annotationStyler=this._annotationFactory.createAnnotationStyler(a,this._annotationModel))d.addAnnotationType(g.ANNOTATION_CURRENT_SEARCH),
d.addAnnotationType(g.ANNOTATION_MATCHING_SEARCH),d.addAnnotationType(g.ANNOTATION_ERROR),d.addAnnotationType(g.ANNOTATION_WARNING),d.addAnnotationType(g.ANNOTATION_MATCHING_BRACKET),d.addAnnotationType(g.ANNOTATION_CURRENT_BRACKET),d.addAnnotationType(g.ANNOTATION_CURRENT_LINE),d.addAnnotationType(g.ANNOTATION_READ_OCCURRENCE),d.addAnnotationType(g.ANNOTATION_WRITE_OCCURRENCE),d.addAnnotationType(g.ANNOTATION_SELECTED_LINKED_GROUP),d.addAnnotationType(g.ANNOTATION_CURRENT_LINKED_GROUP),d.addAnnotationType(g.ANNOTATION_LINKED_GROUP),
d.addAnnotationType("orion.annotation.highlightError");var d=this._annotationFactory.createAnnotationRulers(this._annotationModel),h=this._annotationRuler=d.annotationRuler;if(h)h.onDblClick=c,h.setMultiAnnotationOverlay({html:"<div class='annotationHTML overlay'></div>"}),h.addAnnotationType(g.ANNOTATION_ERROR),h.addAnnotationType(g.ANNOTATION_WARNING),h.addAnnotationType(g.ANNOTATION_TASK),h.addAnnotationType(g.ANNOTATION_BOOKMARK);this.setAnnotationRulerVisible(this._annotationRulerVisible||this._annotationRulerVisible===
void 0,!0);if(h=this._overviewRuler=d.overviewRuler)h.addAnnotationType(g.ANNOTATION_CURRENT_SEARCH),h.addAnnotationType(g.ANNOTATION_MATCHING_SEARCH),h.addAnnotationType(g.ANNOTATION_READ_OCCURRENCE),h.addAnnotationType(g.ANNOTATION_WRITE_OCCURRENCE),h.addAnnotationType(g.ANNOTATION_CURRENT_BLAME),h.addAnnotationType(g.ANNOTATION_ERROR),h.addAnnotationType(g.ANNOTATION_WARNING),h.addAnnotationType(g.ANNOTATION_TASK),h.addAnnotationType(g.ANNOTATION_BOOKMARK),h.addAnnotationType(g.ANNOTATION_MATCHING_BRACKET),
h.addAnnotationType(g.ANNOTATION_CURRENT_BRACKET),h.addAnnotationType(g.ANNOTATION_CURRENT_LINE);this.setOverviewRulerVisible(this._overviewRulerVisible||this._overviewRulerVisible===void 0,!0)}if(this._lineNumberRulerFactory)this._lineNumberRuler=this._lineNumberRulerFactory.createLineNumberRuler(this._annotationModel),this._lineNumberRuler.addAnnotationType(g.ANNOTATION_CURRENT_BLAME),this._lineNumberRuler.addAnnotationType(g.ANNOTATION_BLAME),this._lineNumberRuler.onDblClick=c,this.setLineNumberRulerVisible(this._lineNumberRulerVisible||
...
this.getModel(),a=this.getCaretOffset(),e=b.getLineAtOffset(a),b=b.getLineStart(e);a-=b;for(var b=this.getKeyModes(),c=0;c<b.length;c++){var f=b[c];if(f.isActive()&&f.isStatusActive&&f.isStatusActive())return}this.reportStatus(d.formatMessage(k.lineColumn,e+1,a+1))},showAnnotations:function(b,a,e,c){var d=this._annotationModel;if(d){for(var f=[],h=[],n=d.getTextModel(),i=d.getAnnotations(),k;i.hasNext();)k=i.next(),a.indexOf(k.type)!==-1&&k.creatorID===this&&f.push(k);if(b)for(a=0;a<b.length;a++)if(k=
b[a]){if(e)k=e(k);else{var t;typeof k.line==="number"?(t=n.getLineStart(k.line-1),i=t+k.start-1,t=t+k.end-1):(i=k.start,t=k.end);var v=c(k);if(!v)continue;k=g.createAnnotation(v,i,t,k.description)}k.creatorID=this;h.push(k)}d.replaceAnnotations(f,h)}},showProblems:function(b){this.showAnnotations(b,[g.ANNOTATION_ERROR,g.ANNOTATION_WARNING,g.ANNOTATION_TASK],null,function(a){switch(a.severity){case "error":return g.ANNOTATION_ERROR;case "warning":return g.ANNOTATION_WARNING;case "task":return g.ANNOTATION_TASK}return null})},
showOccurrences:function(b){this.showAnnotations(b,[g.ANNOTATION_READ_OCCURRENCE,g.ANNOTATION_WRITE_OCCURRENCE],null,function(a){return a.readAccess?g.ANNOTATION_READ_OCCURRENCE:g.ANNOTATION_WRITE_OCCURRENCE})},showBlame:function(b){var a=this._blameRGB,e=this.getTextView().getOptions("parent").ownerDocument;if(!a){var f=d.createElement(e,"div");f.className="annotation blame";e.body.appendChild(f);var h=(e.defaultView||e.parentWindow).getComputedStyle(f).getPropertyValue("background-color");f.parentNode.removeChild(f);
var f=h.indexOf("("),q=h.indexOf(")"),h=h.substring(f+1,q);this._blameRGB=a=h.split(",").slice(0,3)}var r=function(){var a=i.AnnotationType.createAnnotation(this.groupType,this.start,this.end,this.title);a.style=c.mixin({},a.style);a.style.style=c.mixin({},a.style.style);a.style.style.backgroundColor="";this.groupAnnotation=a;a.blame=this.blame;a.html=this.html;a.creatorID=this.creatorID;return a},n=function(){var a=d.createElement(e,"div");a.className="tooltipTitle";var b=this.blame.Message.indexOf("\n");
if(b===-1)b=this.blame.Message.length;var c=d.createElement(e,"a");c.href=this.blame.CommitLink;c.appendChild(e.createTextNode(this.blame.Message.substring(0,b)));a.appendChild(c);a.appendChild(d.createElement(e,"br"));a.appendChild(e.createTextNode(d.formatMessage(k.committerOnTime,this.blame.AuthorName,this.blame.Time)));return a},s=this.getModel();this.showAnnotations(b,[g.ANNOTATION_BLAME,g.ANNOTATION_CURRENT_BLAME],function(b){var e=s.getLineStart(b.Start-1),d=s.getLineEnd(b.End-1,!0),e=i.AnnotationType.createAnnotation(g.ANNOTATION_BLAME,
e,d,n),d=a.slice(0);d.push(b.Shade);e.style=c.mixin({},e.style);e.style.style=c.mixin({},e.style.style);e.style.style.backgroundColor="rgba("+d.join()+")";e.groupId=b.Name;e.groupType=g.ANNOTATION_CURRENT_BLAME;e.createGroupAnnotation=r;e.html='<img class="annotationHTML blame" src="'+b.AuthorImage+'"/>';e.blame=b;return e})},showSelection:function(b,a,e,c,d){typeof b==="number"?(typeof a!=="number"&&(a=b),this.moveSelection(b,a)):typeof e==="number"&&(b=this.getModel().getLineStart(e-1),typeof c===
...
this._doReplace(b.start,b.end,a,c),this.endUndo()}this._findAfterReplace&&a&&this._doFind(a,this.getStartOffset())},replaceAll:function(){var a=this.getFindString();if(a){this._replacingAll=!0;var b=this._editor,c=b.getTextView();b.reportStatus(k.replaceAll);var d=this._processReplaceString(this.getReplaceString()),g=this;window.setTimeout(function(){for(var h=0,n=0;;){var i=g._doFind(a,h,null,!0);if(!i)break;n++;n===1&&(c.setRedraw(!1),g.startUndo());g._doReplace(i.start,i.end,a,d);h=g.getStartOffset()}n>
0&&(g.endUndo(),c.setRedraw(!0));h>0?b.reportStatus(f.formatMessage(k.replacedMatches,n)):b.reportStatus(k.nothingReplaced,"error");g._replacingAll=!1},100)}},setOptions:function(a){if(a){if((a.showAll===!0||a.showAll===!1)&&this._showAll!==a.showAll)if(this._showAll=a.showAll,this.isVisible())if(this._showAll)this._markAllOccurrences();else{var b=this._editor.getAnnotationModel();b&&b.removeAnnotations(i.AnnotationType.ANNOTATION_MATCHING_SEARCH)}if(a.caseInsensitive===!0||a.caseInsensitive===!1)this._caseInsensitive=
...
b=b.getText(f,c)+b.getText(d,f),i+=c-f);this.startUndo();a.setText("",d,c);a.setText(b,h,h);a.setSelection(h+i,h+i+b.length);this.endUndo();return!0},moveLinesUp:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getModel(),c=a.getSelection(),d=b.getLineAtOffset(c.start);if(d===0)return!0;var f=b.getLineAtOffset(c.end>c.start?c.end-1:c.end),g=b.getLineCount(),c=b.getLineStart(d-1),h=b.getLineStart(d),i=b.getLineEnd(f,!0),k=b.getText(h,i),t=0;f===g-1&&(f=b.getLineEnd(d-
1),d=b.getLineEnd(d-1,!0),k+=b.getText(f,d),h=f,t=d-f);this.startUndo();a.setText("",h,i);a.setText(k,c,c);a.setSelection(c,c+k.length-t);this.endUndo();return!0},nextAnnotation:function(a){function b(a){return!!a.lineStyle||a.type===g.ANNOTATION_MATCHING_BRACKET||a.type===g.ANNOTATION_CURRENT_BRACKET||!f.isAnnotationTypeVisible(a.type)}var c=this.editor,d=c.getAnnotationModel();if(!d)return!0;var f=c.getOverviewRuler()||c.getAnnotationStyler();if(!f)return!0;for(var h=c.getModel(),n=c.getCaretOffset(),
k=d.getAnnotations(a?n:0,a?h.getCharCount():n),u=null;k.hasNext();){var t=k.next();if(a){if(t.start<=n)continue}else if(t.start>=n)continue;if(!b(t)&&(u=t,a))break}if(u){for(var v=[u],k=d.getAnnotations(u.start,u.start);k.hasNext();)t=k.next(),t!==u&&!b(t)&&v.push(t);var j=c.getTextView(),m=h.getLineAtOffset(u.start),p=i.Tooltip.getTooltip(j);if(!p)return c.moveSelection(u.start),!0;c.moveSelection(u.start,u.start,function(){p.setTarget({getTooltipInfo:function(){var a=j.convert({x:j.getLocationAtOffset(u.start).x,
y:j.getLocationAtOffset(h.getLineStart(m)).y},"document","page");return{contents:v,x:a.x,y:a.y+Math.floor(j.getLineHeight(m)*1.33)}}},0)})}return!0},unindentLines:function(){var a=this.editor,b=a.getTextView();if(b.getOptions("readonly"))return!1;if(b.getOptions("tabMode")){for(var c=a.getModel(),d=a.getSelection(),f=c.getLineAtOffset(d.start),g=c.getLineAtOffset(d.end>d.start?d.end-1:d.end),h=b.getOptions("tabSize"),i=Array(h+1).join(" "),k=[],t=b=0,v=f;v<=g;v++){var j=c.getLine(v,!0);if(c.getLineStart(v)!==
c.getLineEnd(v))if(j.indexOf("\t")===0)j=j.substring(1),b++;else if(j.indexOf(i)===0)j=j.substring(h),b+=h;else return!0;v===f&&(t=b);k.push(j)}f=c.getLineStart(f);h=c.getLineEnd(g,!0);c=c.getLineStart(g);a.setText(k.join(""),f,h);g=f===d.start?d.start:d.start-t;d=Math.max(g,d.end-b+(d.end===c+1&&d.start!==d.end?1:0));a.setSelection(g,d);return!0}},startUndo:function(){this.undoStack&&this.undoStack.startCompoundChange()},endUndo:function(){this.undoStack&&this.undoStack.endCompoundChange()}};b.TextActions=
f;h.prototype={init:function(){var a=this.editor.getTextView();a.setAction("lineStart",function(){return this.lineStart()}.bind(this));a.setAction("enter",function(){return this.autoIndent()}.bind(this));a.setKeyBinding(new m.KeyBinding("t",!0,!1,!0),"trimTrailingWhitespaces");a.setAction("trimTrailingWhitespaces",function(){return this.trimTrailingWhitespaces()}.bind(this),{name:k.trimTrailingWhitespaces});a.setKeyBinding(new m.KeyBinding(191,!0),"toggleLineComment");a.setAction("toggleLineComment",
...
h,t;i<k&&((t=g.charCodeAt(i))===32||t===9);)i++;var h=g.substring(0,i),b=b.getOptions("tabSize","expandTab"),v=b.expandTab?Array(b.tabSize+1).join(" "):"\t",b=d.getLineDelimiter(),j=/^[\s]*\/\*[\*]*[\s]*$/,m=/^[\s]*\*/,p=/\*\/[\s]*$/,D=g.substring(0,k),y=g.substring(k),K;if(this.smartIndentation&&g.charCodeAt(K=D.trimRight().length-1)===123)return d=k-K-1,y=y.length-y.trimLeft().length,g=g.charCodeAt(k+y)===125?b+h+v+b+h:b+h+v,a.setText(g,c.start-d,c.end+y),a.setCaretOffset(c.start+b.length+h.length+
v.length-d),!0;else if(this.autoCompleteComments&&!p.test(D)&&(j.test(D)||m.test(D))){if(i=j.exec(D)){g=b+h+" * ";g+=p.test(y)?y.substring(0,y.length-2).trim():y.trim();if(d.getLineCount()===f+1||!m.test(d.getLine(f+1)))g+=b+h+" */";a.setText(g,c.start,c.end+y.length);a.setCaretOffset(c.start+b.length+h.length+3);return!0}if(i=m.exec(D))for(f-=1;f>=0;f--)if(i=d.getLine(f,!1),j.test(i))return p.test(y)||g.charCodeAt(k)===47?(g=b+h+"*"+y,h=c.start+b.length+h.length+1):(g=b+h+"* "+y,h=c.start+b.length+
h.length+2),a.setText(g,c.start,c.end+y.length),a.setCaretOffset(h),!0;else if(!m.test(i))break}else if(p.test(D)&&h.charCodeAt(h.length-1)===32)return g=b+h.substring(0,h.length-1),a.setText(g,c.start,c.end),a.setCaretOffset(c.start+g.length),!0;else if(i>0){for(i=k;i<g.length&&((t=g.charCodeAt(i++))===32||t===9);)c.end++;a.setText(d.getLineDelimiter()+h,c.start,c.end);return!0}}return!1},addBlockComment:function(){var a=this.editor;if(a.getTextView().getOptions("readonly"))return!1;var b=a.getModel(),
...
1);return!1},_findEnclosingComment:function(a,b,c){var d=a.getLineAtOffset(b),f=a.getLineAtOffset(c),g,h,i,k,t,v;for(g=d;g>=0;g--)if(h=a.getLine(g),i=g===d?b-a.getLineStart(d):h.length,k=h.lastIndexOf("/*",i),h=h.lastIndexOf("*/",i),h>k)break;else if(k!==-1){t=a.getLineStart(g)+k;break}for(g=f;g<a.getLineCount();g++)if(h=a.getLine(g),i=g===f?c-a.getLineStart(f):0,k=h.indexOf("/*",i),h=h.indexOf("*/",i),k!==-1&&k<h)break;else if(h!==-1){v=a.getLineStart(g)+h;break}return{commentStart:t,commentEnd:v}},
...
f=b.getLineAtOffset(c.end>c.start?c.end-1:c.end),g=!0,h=[],i,k,t=d;t<=f;t++)if(i=b.getLine(t,!0),h.push(i),!g||(k=i.indexOf("//"))===-1)g=!1;else if(k!==0){var v;for(v=0;v<k;v++)if(g=i.charCodeAt(v),!(g===32||g===9))break;g=v===k}t=b.getLineStart(d);v=b.getLineEnd(f,!0);if(g){for(g=0;g<h.length;g++)i=h[g],k=i.indexOf("//"),h[g]=i.substring(0,k)+i.substring(k+2);h=h.join("");i=b.getLineStart(f);b=t===c.start?c.start:c.start-2;c=c.end-2*(f-d+1)+(c.end===i+1?2:0)}else h.splice(0,0,""),h=h.join("//"),
b=t===c.start?c.start:c.start+2,c=c.end+2*(f-d+1);a.setText(h,t,v);a.setSelection(b,c);return!0},trimTrailingWhitespaces:function(){var a=this.editor,b=a.getModel(),c=a.getSelection();a.getTextView().setRedraw(!1);a.getUndoStack().startCompoundChange();for(var d=/(\s+$)/,f=b.getLineCount(),g=0;g<f;g++){var h=b.getLine(g),i=d.exec(h);if(i){var k=b.getLineStart(g),h=i[0].length,i=k+i.index;b.setText("",i,i+h);if(c.start>i)c.start=Math.max(i,c.start-h);if(c.start!==c.end&&c.end>i)c.end=Math.max(i,c.end-
...
setAutoPairParentheses:function(a){this.autoPairParentheses=a},setAutoPairBraces:function(a){this.autoPairBraces=a},setAutoPairSquareBrackets:function(a){this.autoPairSquareBrackets=a},setAutoPairAngleBrackets:function(a){this.autoPairAngleBrackets=a},setAutoPairQuotations:function(a){this.autoPairQuotation=a},setAutoCompleteComments:function(a){this.autoCompleteComments=a},setSmartIndentation:function(a){this.smartIndentation=a}};b.SourceCodeActions=h;if(!String.prototype.trimLeft)String.prototype.trimLeft=
...
define("orion/editor/templates",[],function(){function k(k,i,c,d){this.prefix=k;this.description=i;this.template=c;this.name=d;this._parse()}function m(k,i){this._keywords=k||[];this._templates=[];this.addTemplates(i||[])}k.prototype={getProposal:function(k,i,c){var k=i-k.length,i={},d,f=c.delimiter!==void 0?c.delimiter:"\n";c.indentation&&(f+=c.indentation);for(var h=c.tab!==void 0?c.tab:"\t",g=0,b=this.variables,a=this.segments,c=[],e=0;e<a.length;e++){var l=a[e],o=b[l];if(o!==void 0)switch(l){case "${tab}":l=
h;break;case "${delimiter}":l=f;break;case "${cursor}":l="";d=g;break;default:var q=i[l];q||(q=i[l]={data:o.data,positions:[]});l=o.substitution;q.data&&q.data.values&&(l=q.data.values[0]);q.positions.push({offset:k+g,length:l.length})}c.push(l);g+=l.length}var f=[],r;for(r in i)i.hasOwnProperty(r)&&f.push(i[r]);c=c.join("");if(d===void 0)d=c.length;return{proposal:c,name:this.name,description:this.description,groups:f,escapePosition:k+d,style:"noemphasis"}},match:function(k){return this.prefix.indexOf(k)===
0},_parse:function(){var k=this.template,i=[],c={},d,f=0,k=k.replace(/\n/g,"${delimiter}"),k=k.replace(/\t/g,"${tab}");k.replace(/\$\{((?:[^\\}]+|\\.))*\}/g,function(h,g,b){var a=h.substring(2,h.length-1),g=h,e=a,l=null,o=e.indexOf(":");o!==-1&&(e=e.substring(0,o),g="${"+e+"}",l=JSON.parse(a.substring(o+1).replace("\\}","}").trim()));(a=c[g])||(a=c[g]={});a.substitution=e;if(l)a.data=l;(d=k.substring(f,b))&&i.push(d);i.push(g);f=b+h.length;return e});(d=k.substring(f,k.length))&&i.push(d);this.segments=
...
0&&i.push({proposal:c[d].substring(k.length),description:c[d],style:"noemphasis_keyword"});0<i.length&&i.splice(0,0,{proposal:"",description:"Keywords",style:"noemphasis_title_keywords",unselectable:!0})}return i},getPrefix:function(k,i,c){return c.prefix},getTemplates:function(){return this._templates},getTemplateProposals:function(k,i,c){for(var d=[],f=this.getTemplates(),h=0;h<f.length;h++){var g=f[h];g.match(k)&&(g=g.getProposal(k,i,c),this.removePrefix(k,g),d.push(g))}0<d.length&&(d.sort(function(b,
...
e.getSelection();return b.start===b.end&&(b=e.getCaretOffset(),a.offset<=b&&b<=a.offset+a.length)?e.getText(a.offset,b):""},b.offset=a.offset,b.deactivate(),b.activate();else if(this._groupContentAssistProvider)this._groupContentAssistProvider=null,b.deactivate()}this._updateAnnotations()},_getModelPositions:function(c,b,a){for(var e=b.groups,d=0;d<e.length;d++)for(var f=e[d].positions,h=0;h<f.length;h++){var i=f[h];a&&(i={offset:i.offset+a,length:i.length});i={index:h,group:d,count:f.length,model:b,
position:i};c.push(i);if(b.nextModel&&b.nextModel.parentGroup===d)i.ansestor=!0,this._getModelPositions(c,b.nextModel,(a||0)+f[h].offset-f[0].offset)}},_getSortedPositions:function(c){var b=this._sortedPositions;if(!b){for(b=[];c.previousModel;)c=c.previousModel;for(this._getModelPositions(b,c);c;)c.escapePosition!==void 0&&b.push({escape:!0,model:c,position:{offset:c.escapePosition,length:0}}),c=c.nextModel;b.sort(function(a,b){return a.position.offset-b.position.offset});this._sortedPositions=b}return b},
...
this.linkedModeModel)for(var c=c||this._getSortedPositions(d),h=0;h<c.length;h++)if(f=c[h],f.model===d){var k=i.AnnotationType.ANNOTATION_LINKED_GROUP;f.group===d.selectedGroupIndex&&(k=f.index===0?i.AnnotationType.ANNOTATION_SELECTED_LINKED_GROUP:i.AnnotationType.ANNOTATION_CURRENT_LINKED_GROUP);f=f.position;f=i.AnnotationType.createAnnotation(k,f.offset,f.offset+f.length,"");e.push(f)}b.replaceAnnotations(a,e)}}});h.LinkedMode=f;return h});
define("orion/editor/factories","orion/editor/actions,orion/editor/undoStack,orion/editor/rulers,orion/editor/annotations,orion/editor/textDND,orion/editor/linkedMode".split(","),function(k,m,p,i,c,d){function f(){}function h(){}function g(){}function b(){}function a(){}function e(){}var l={};f.prototype={createKeyBindings:function(a,b,c,e){var e=new k.TextActions(a,b,e),f=new d.LinkedMode(a,b,c),a=new k.SourceCodeActions(a,b,c,f);return{textActions:e,linkedMode:f,sourceCodeActions:a}}};l.KeyBindingsFactory=
f;h.prototype={createUndoStack:function(a){a=a.getTextView();return new m.UndoStack(a,200)}};l.UndoFactory=h;g.prototype={createLineNumberRuler:function(a){return new p.LineNumberRuler(a,"left",{styleClass:"ruler lines"},{styleClass:"rulerLines odd"},{styleClass:"rulerLines even"})}};l.LineNumberRulerFactory=g;b.prototype={createFoldingRuler:function(a){return new p.FoldingRuler(a,"left",{styleClass:"ruler folding"})}};l.FoldingRulerFactory=b;a.prototype={createAnnotationModel:function(a){return new i.AnnotationModel(a)},
createAnnotationStyler:function(a,b){return new i.AnnotationStyler(a,b)},createAnnotationRulers:function(a){var b=new p.AnnotationRuler(a,"left",{styleClass:"ruler annotations"}),a=new p.OverviewRuler(a,"right",{styleClass:"ruler overview"});return{annotationRuler:b,overviewRuler:a}}};l.AnnotationFactory=a;e.prototype={createTextDND:function(a,b){return new c.TextDND(a.getTextView(),b)}};l.TextDNDFactory=e;return l});
define("orion/editor/editorFeatures",["orion/editor/factories","orion/editor/actions","orion/editor/linkedMode","orion/objects"],function(k,m,p,i){return i.mixin({},k,m,p)});
(function(k,m){typeof define==="function"&&define.amd?define("orion/Deferred",m):typeof exports==="object"?module.exports=m():(k.orion=k.orion||{},k.orion.Deferred=m())})(this,function(){function k(){for(var f;f=c.shift();)f();d=!1}function m(f){c.push(f);d||(d=!0,setTimeout(k,0))}function p(c){return function(){c.apply(void 0,arguments)}}function i(){function d(){for(var b;b=l.shift();){var f=b.deferred,g=e==="fulfilled"?"resolve":"reject";if(typeof b[g]==="function")try{var h=(0,b[g])(a),i=h&&(typeof h===
"object"||typeof h==="function")&&h.then;if(typeof i==="function")if(h===f.promise)f.reject(new TypeError);else{var k=h.cancel;typeof k==="function"?f._protected(c).parentCancel=k.bind(h):delete f._protected(c).parentCancel;i.call(h,p(f.resolve),p(f.reject),p(f.progress))}else f.resolve(h)}catch(j){f.reject(j)}else f[g](a)}}function h(b){delete q.parentCancel;e="rejected";a=b;l.length&&m(d)}function g(b){function c(a){return function(b){s||(s=!0,a(b))}}var s=!1;delete q.parentCancel;try{var u=b&&
(typeof b==="object"||typeof b==="function")&&b.then;if(typeof u==="function")if(b===k)h(new TypeError);else{e="assumed";var t=b&&b.cancel;if(typeof t!=="function"){var v=new i,b=v.promise;try{u(v.resolve,v.reject,v.progress)}catch(j){v.reject(j)}t=b.cancel;u=b.then}a=b;u.call(b,c(g),c(h));q.parentCancel=t.bind(b)}else e="fulfilled",a=b,l.length&&m(d)}catch(w){c(h)(w)}}function b(){var a=q.parentCancel;if(a)delete q.parentCancel,a();else if(!e)a=Error("Cancel"),a.name="Cancel",h(a)}var a,e,l=[],k=
this,q={};Object.defineProperty(this,"_protected",{value:function(a){if(a!==c)throw Error("protected");return q}});this.resolve=function(a){e||g(a);return k};this.reject=function(a){e||h(a);return k};this.progress=function(a){e||l.forEach(function(b){if(b.progress)try{b.progress(a)}catch(c){}});return k.promise};this.cancel=function(){q.parentCancel?setTimeout(b,0):b();return k};this.then=function(a,b,g){a={resolve:a,reject:b,progress:g,deferred:new i};l.push(a);a.deferred._protected(c).parentCancel=
k.promise.cancel.bind(k);(e==="fulfilled"||e==="rejected")&&m(d);return a.deferred.promise};this.promise={then:k.then,cancel:k.cancel}}var c=[],d=!1;i.all=function(c,d){function g(b,c){l||(e[b]=c,--a===0&&k.resolve(e))}function b(a,b){if(!l){if(d)try{g(a,d(b));return}catch(c){b=c}k.reject(b)}}var a=c.length,e=[],l=!1,k=new i;k.then(void 0,function(){l=!0;c.forEach(function(a){a.cancel&&a.cancel()})});a===0?k.resolve(e):c.forEach(function(a,c){a.then(g.bind(void 0,c),b.bind(void 0,c))});return k.promise};
i.when=function(c,d,g,b){var a;if(!(c&&typeof c.then==="function"))a=new i,a.resolve(c),c=a.promise;return c.then(d,g,b)};return i});
define("orion/webui/littlelib",["orion/util"],function(k){function m(c,b){b||(b=document);return b.querySelectorAll(c)}function p(c){var b=c.tabIndex;b===0&&k.isIE&&!{a:!0,body:!0,button:!0,frame:!0,iframe:!0,img:!0,input:!0,isindex:!0,object:!0,select:!0,textarea:!0}[c.nodeName.toLowerCase()]&&!c.attributes.tabIndex&&(b=-1);return b}function i(c){if(p(c)>=0)return c;if(c.hasChildNodes())for(var b=0;b<c.childNodes.length;b++){var a=i(c.childNodes[b]);if(a)return a}return null}function c(d){if(p(d)>=
0)return d;if(d.hasChildNodes())for(var b=d.childNodes.length-1;b>=0;b--){var a=c(d.childNodes[b]);if(a)return a}return null}function d(c,b){if(c.nodeType===3){var a=f.exec(c.nodeValue);a&&a.length>1&&b(c,a)}if(c.hasChildNodes())for(a=0;a<c.childNodes.length;a++)d(c.childNodes[a],b)}var f=/\$\{([^\}]+)\}/,h=null;return{$:function(c,b){b||(b=document);return b.querySelector(c)},$$:m,$$array:function(c,b){return Array.prototype.slice.call(m(c,b))},node:function(c){var b=c;typeof c==="string"&&(b=document.getElementById(c));
return b},contains:function(c,b){if(!c||!b)return!1;if(c===b)return!0;var a=c.compareDocumentPosition(b);return Boolean(a&16)},bounds:function(c){c=c.getBoundingClientRect();return{left:c.left+document.documentElement.scrollLeft,top:c.top+document.documentElement.scrollTop,width:c.width,height:c.height}},empty:function(c){for(;c.hasChildNodes();)c.removeChild(c.firstChild)},firstTabbable:i,lastTabbable:c,stop:function(c){if(window.document.all)c.keyCode=0;c.preventDefault&&(c.preventDefault(),c.stopPropagation())},
processTextNodes:function(c,b){d(c,function(a,c){a.parentNode.replaceChild(document.createTextNode(b[c[1]]||c[1]),a)})},processDOMNodes:function(c,b){d(c,function(a,c){var d=b[c[1]];if(d){var f=document.createRange(),g=c.index;f.setStart(a,g);f.setEnd(a,g+c[0].length);f.deleteContents();f.insertNode(d)}})},addAutoDismiss:function(c,b){function a(a){h.forEach(function(b){var c=!1,d=b.excludeNodes.some(function(b){return document.body.contains(b)?(c=!0,b.contains(a.target)):!1});if(c&&!d)try{b.dismiss(a)}catch(f){typeof console!==
"undefined"&&console&&console.error(f&&f.message)}});h=h.filter(function(a){return a.excludeNodes.some(function(a){return document.body.contains(a)})})}h===null&&(h=[],document.addEventListener("click",a,!0),k.isIOS&&document.addEventListener("touchend",function(a){function b(){a.target.removeEventListener("click",b)}a.touches.length===0&&a.target.addEventListener("click",b)},!1));h.push({excludeNodes:c,dismiss:b})},setFramesEnabled:function(c){for(var b=document.getElementsByTagName("iframe"),a=
0;a<b.length;a++)b[a].parentNode.style.pointerEvents=c?"":"none"},removeAutoDismiss:function(c){h=h.filter(function(b){return c!==b.dismiss})},KEY:{BKSPC:8,TAB:9,ENTER:13,ESCAPE:27,SPACE:32,PAGEUP:33,PAGEDOWN:34,END:35,HOME:36,LEFT:37,UP:38,RIGHT:39,DOWN:40,INSERT:45,DEL:46}}});
define("orion/editor/contentAssist","i18n!orion/editor/nls/messages,orion/keyBinding,orion/editor/keyModes,orion/editor/eventTarget,orion/Deferred,orion/objects,orion/editor/util,orion/util,orion/webui/littlelib".split(","),function(k,m,p,i,c,d,f,h,g){var b,a,e;function l(c){this.textView=c;this.state=b;this.resetProviderInfoArray();var d=this;this.contentAssistListener={onModelChanging:function(a){this._latestModelChangingEvent=a}.bind(this),onSelection:function(c){this.isDeactivatingChange(this._latestModelChangingEvent,
c)?this.setState(b):this.isActive()&&(this.state===a&&this.setState(e),this.filterProposals(c));this._latestModelChangingEvent=null}.bind(this),onScroll:function(){this.setState(b)}.bind(this)};c.setKeyBinding(h.isMac?new m.KeyBinding(" ",!1,!1,!1,!0):new m.KeyBinding(" ",!0),"contentAssist");c.setKeyBinding(h.isMac?new m.KeyBinding(" ",!1,!1,!0,!0):new m.KeyBinding(" ",!0,!1,!0),"contentAssist");c.setAction("contentAssist",function(){c.getOptions("readonly")||d.activate();return!0},{name:k.contentAssist})}
function o(a,b){var c=a.textView;p.KeyMode.call(this,c);this.contentAssist=a;this.widget=b;this.proposals=[];var d=this;this.contentAssist.addEventListener("ProposalsComputed",function(a){d.proposals=a.data.proposals;if(d.proposals.length===0)d.selectedIndex=-1,d.cancel();else{for(d.selectedIndex=0;d.proposals[d.selectedIndex]&&d.proposals[d.selectedIndex].unselectable;)d.selectedIndex++;if(d.proposals[d.selectedIndex]){if(d.widget){var b=!0;if(a.autoApply){for(a=d.selectedIndex+1;d.proposals[a]&&
...
this.widget.createAccessible())}function q(a,b){this.contentAssist=a;this.textView=this.contentAssist.getTextView();this.isShowing=this.textViewListenerAdded=!1;var c=this.textView.getOptions("parent").ownerDocument;this.parentNode=typeof b==="string"?c.getElementById(b):b;if(!this.parentNode){this.parentNode=h.createElement(c,"div");this.parentNode.className="contentassist";var d=c.getElementsByTagName("body")[0];if(d)d.appendChild(this.parentNode);else throw Error("parentNode is required");}this.parentNode.addEventListener("scroll",
...
this.preserveCloneThroughScroll=!1},createDiv:function(a,b,c){var d=b.ownerDocument,e=h.createElement(d,"div");e.id="contentoption"+c;e.setAttribute("role","option");e.className=r[a.style]?r[a.style]:r.dfault;a.style==="hr"?a=h.createElement(d,"hr"):(a=this._createDisplayNode(e,a,c),e.contentAssistProposalIndex=c);e.appendChild(a);b.appendChild(e)},createAccessible:function(){var a=this._contentAssistMode,b=this;this.parentNode.addEventListener("keydown",function(c){if(!c)c=window.event;c.preventDefault&&
c.preventDefault();if(c.keyCode===g.KEY.ESCAPE)return a.cancel();else if(c.keyCode===g.KEY.UP)return a.lineUp();else if(c.keyCode===g.KEY.DOWN)return a.lineDown();else if(c.keyCode===g.KEY.ENTER)return a.enter();else if(c.keyCode===g.KEY.PAGEDOWN)return a.pageDown();else if(c.keyCode===g.KEY.PAGEUP)return a.pageUp();else if(c.keyCode===g.KEY.HOME)return b.scrollIndex(0,!0),a.lineDown(0);else if(c.keyCode===g.KEY.END)return a.lineUp(a.getProposals().length-1);return!1})},_createDisplayNode:function(a,
...
define("orion/editor/cssContentAssist",["orion/editor/templates","orion/editor/stylers/text_css/syntax"],function(k,m){function p(a){return JSON.stringify(a).replace("}","\\}")}function i(){}for(var c={type:"link",values:"visible,hidden,scroll,auto,no-display,no-content".split(",")},d={type:"link",values:"solid,dashed,dotted,double,groove,ridge,inset,outset".split(",")},f={type:"link",values:[]},h=0;h<10;h++)f.values.push(h.toString());for(var g={type:"link",values:"black,white,red,green,blue,magenta,yellow,cyan,grey,darkred,darkgreen,darkblue,darkmagenta,darkcyan,darkyellow,darkgray,lightgray".split(",")},
b=[{prefix:"rule",description:"rule - class selector rule",template:".${class} {\n\t${cursor}\n}"},{prefix:"rule",description:"rule - id selector rule",template:"#${id} {\n\t${cursor}\n}"},{prefix:"outline",description:"outline - outline style",template:"outline: ${color:"+p(g)+"} ${style:"+p(d)+"} ${width:"+p(f)+"}px;"},{prefix:"background-image",description:"background-image - image style",template:'background-image: url("${uri}");'},{prefix:"url",description:"url - url image",template:'url("${uri}");'},
...
values:c},{prop:"float",values:{type:"link",values:["left","right","none","inherit"]}},{prop:"position",values:{type:"link",values:["absolute","fixed","relative","static","inherit"]}},{prop:"cursor",values:{type:"link",values:"auto,crosshair,default,e-resize,help,move,n-resize,ne-resize,nw-resize,pointer,progress,s-resize,se-resize,sw-resize,text,w-resize,wait,inherit".split(",")}},{prop:"color",values:g},{prop:"border-top-color",values:g},{prop:"border-bottom-color",values:g},{prop:"border-right-color",
values:g},{prop:"border-left-color",values:g},{prop:"background-color",values:g},{prop:"font-style",values:{type:"link",values:["italic","normal","oblique","inherit"]}},{prop:"font-weight",values:{type:"link",values:"bold,normal,bolder,lighter,100,200,300,400,500,600,700,800,900,inherit".split(",")}},{prop:"white-space",values:{type:"link",values:"pre,pre-line,pre-wrap,nowrap,normal,inherit".split(",")}},{prop:"word-wrap",values:{type:"link",values:["normal","break-word"]}},{prop:"visibility",values:{type:"link",
values:["hidden","visible","collapse","inherit"]}}],h=0;h<a.length;h++)c=a[h],b.push({prefix:c.prop,description:c.prop+" - "+c.prop+" style",template:c.prop+": ${value:"+p(c.values)+"};"});a="width,height,top,bottom,left,right,min-width,min-height,max-width,max-height,margin,padding,padding-left,padding-right,padding-top,padding-bottom,margin-left,margin-top,margin-bottom,margin-right".split(",");for(h=0;h<a.length;h++)c=a[h],b.push({prefix:c,description:c+" - "+c+" pixel style",template:c+": ${value}px;"});
a=["padding","margin"];for(h=0;h<a.length;h++)c=a[h],b.push({prefix:c,description:c+" - "+c+" top right bottom left style",template:c+": ${top}px ${left}px ${bottom}px ${right}px;"}),b.push({prefix:c,description:c+" - "+c+" top right,left bottom style",template:c+": ${top}px ${right_left}px ${bottom}px;"}),b.push({prefix:c,description:c+" - "+c+" top,bottom right,left style",template:c+": ${top_bottom}px ${right_left}px"});a=["border","border-top","border-bottom","border-left","border-right"];for(h=
0;h<a.length;h++)c=a[h],b.push({prefix:c,description:c+" - "+c+" style",template:c+": ${width:"+p(f)+"}px ${style:"+p(d)+"} ${color:"+p(g)+"};"});i.prototype=new k.TemplateContentAssist(m.keywords,b);i.prototype.getPrefix=function(a,b){for(var c=b;c&&/[A-Za-z\-\@]/.test(a.charAt(c-1));)c--;return c?a.substring(c,b):""};return{CssContentAssistProvider:i}});
define("orion/editor/htmlContentAssist",["orion/editor/templates"],function(k){function m(){}var p=new k.Template("","Simple HTML document",'<!DOCTYPE html>\n<html lang="en">\n\t<head>\n\t\t<meta charset=utf-8>\n\t\t<title>${title}</title>\n\t</head>\n\t<body>\n\t\t<h1>${header}</h1>\n\t\t<p>\n\t\t\t${cursor}\n\t\t</p>\n\t</body>\n</html>'),i=[{prefix:"<img",name:"<img>",description:" - HTML image element",template:'<img src="${cursor}" alt="${Image}"/>'},{prefix:"<a",name:"<a>",description:" - HTML anchor element",
...
{prefix:"<\!--",name:"<\!-- --\>",description:" - HTML comment",template:"<\!-- ${cursor} --\>"}],c,d,f,h,g="abbr,b,button,canvas,cite,command,dd,del,dfn,dt,em,embed,font,h1,h2,h3,h4,h5,h6,i,ins,kbd,label,li,mark,meter,object,option,output,progress,q,rp,rt,samp,small,strong,sub,sup,td,time,title,tt,u,var".split(",");for(h=0;h<g.length;h++)c=g[h],f="<"+c+"></"+c+">",d="<"+c+">${cursor}</"+c+">",i.push({prefix:"<"+c,description:f,template:d});g="address,article,aside,audio,bdo,blockquote,body,caption,code,colgroup,datalist,details,div,fieldset,figure,footer,form,head,header,hgroup,iframe,legend,map,menu,nav,noframes,noscript,optgroup,p,pre,ruby,script,section,select,span,style,tbody,textarea,tfoot,th,thead,tr,video".split(",");
for(h=0;h<g.length;h++)c=g[h],f="<"+c+"></"+c+">",d="<"+c+">\n\t${cursor}\n</"+c+">",i.push({prefix:"<"+c,description:f,template:d});g="area,base,br,col,hr,input,link,meta,param,keygen,source".split(",");for(h=0;h<g.length;h++)c=g[h],d=f="<"+c+"/>",i.push({prefix:"<"+c,description:f,template:d});m.prototype=new k.TemplateContentAssist([],i);m.prototype.getPrefix=function(b,a){for(var c="",d=a;d&&/[A-Za-z0-9<!-]/.test(b.charAt(d-1));)if(d--,b.charAt(d)==="<"){c=b.substring(d,a);break}return c};m.prototype.computeProposals=
function(b,a,c){return b.length===0?[p.getProposal("",a,c)]:k.TemplateContentAssist.prototype.computeProposals.call(this,b,a,c).sort(function(a,b){var c=a.prefix||a.proposal,d=b.prefix||b.proposal;if(c){if(!d)return 1}else return-1;return c.toLowerCase().localeCompare(d.toLowerCase())})};return{HTMLContentAssistProvider:m}});
...
define("orion/editor/jsTemplateContentAssist",["orion/editor/templates","orion/editor/stylers/application_javascript/syntax"],function(k,m){function p(){}var i=[{prefix:"if",name:"if",description:" - if statement",template:"if (${condition}) {\n\t${cursor}\n}"},{prefix:"if",name:"if",description:" - if else statement",template:"if (${condition}) {\n\t${cursor}\n} else {\n\t\n}"},{prefix:"for",name:"for",description:" - iterate over array",template:"for (var ${i}=0; ${i}<${array}.length; ${i}++) {\n\t${cursor}\n}"},
...
onStyleReady:function(c){var d=c.lineStyles||c.style,c=Number.MAX_VALUE,g=-1,b=this.textView.getModel(),a;for(a in d)Object.prototype.hasOwnProperty.call(d,a)&&(this.lineStyles[a]=d[a],c=Math.min(c,a),g=Math.max(g,a));c=Math.max(c,0);g=Math.min(g,b.getLineCount());if(d=this.annotationModel){for(var e=d.getAnnotations(b.getLineStart(c),b.getLineEnd(g)),i=[];e.hasNext();){var k=e.next();k.type==="orion.annotation.highlightError"&&i.push(k)}e=[];for(k=c;k<=g;k++){a=k;var q=this.lineStyles[a],q=q&&q.errors;
a=b.getLineStart(a);if(q)for(var r=0;r<q.length;r++){var n=q[r];e.push(m.AnnotationType.createAnnotation("orion.annotation.highlightError",n.start+a,n.end+a))}}d.replaceAnnotations(i,e)}this.textView.redrawLines(c,g+1)},onLineStyle:function(c){function d(b,a){for(var c=b.length,f=[],g=0;g<c;g++){var h=b[g];f.push({start:h.start+a,end:h.end+a,style:h.style})}return f}var g=this.lineStyles[c.lineIndex];if(g)if(g.ranges)c.ranges=d(g.ranges,c.lineStart);else if(g.style)c.style=g.style},_getEmptyStyle:function(c){for(var d=
[],g=0;g<c;g++)d.push(null);return d},setContentType:function(c){this.contentType=c;if(this.services)for(c=0;c<this.services.length;c++){var d=this.services[c];if(d.setContentType){var g=this.serviceRegistry.getService("orion.page.progress");g?g.progress(d.setContentType(this.contentType),"Styling content type: "+this.contentType.id?this.contentType.id:this.contentType):d.setContentType(this.contentType)}}},onServiceAdded:function(c,d){p(c)&&this.addServiceListener(d)},onServiceRemoved:function(c,
d){this.services.indexOf(d)!==-1&&this.removeServiceListener(d)},addServiceListener:function(c){if(typeof c.addEventListener==="function"){if(c.addEventListener("orion.edit.highlighter.styleReady",this.listener.onStyleReady),this.services.push(c),c.setContentType&&this.contentType){var h=this.serviceRegistry.getService("orion.page.progress");h?h.progress(c.setContentType(this.contentType),"Styling content type: "+this.contentType.id?this.contentType.id:this.contentType):c.setContentType(this.contentType)}}else typeof console!==
...
define("orion/editor/mirror",["i18n!orion/editor/nls/messages","orion/editor/eventTarget","orion/editor/annotations"],function(k,m,p){function i(b){this.string=b;this.tokenStart=this.pos=0}function c(){return{token:function(b){return b.skipToEnd()}}}function d(){this._modes={};this.mimeModes={};this.options={};this.StringStream=i;this.defineMode("null",c);this.defineMIME("text/plain","null")}function f(b){var a=[],c;for(c in b)Object.prototype.hasOwnProperty.call(b,c)&&a.push(c);return a}function h(b,
a,c){c=c||{};this.model=b;this.codeMirror=a;this.isWhitespaceVisible=typeof c.whitespacesVisible==="undefined"?!1:c.whitespacesVisible;this.mode=null;this.isModeLoaded=!1;this.lines=[];this.dirtyLines=[];this.startLine=Number.MAX_VALUE;this.endLine=-1;this.timer=null;this.initialize(b)}function g(b,a,c){this.init(b,a,c)}i.prototype={eol:function(){return this.pos>=this.string.length},sol:function(){return this.pos===0},peek:function(){return this.string[this.pos]},next:function(){return this.string[this.pos++]},
...
f]},getLineStyle:function(b){return this.lines[b]},getLineStyles:function(){return this.lines}};m.EventTarget.addMixin(h.prototype);p.AnnotationType.registerType("orion.annotation.highlightError",{title:k.syntaxError,html:"<div class='annotationHTML error'></div>",rangeStyle:{styleClass:"annotationRange error"}});g.prototype={init:function(b,a,c){this.textView=b;this.annotationModel=c;this.modeApplier=new h(b.getModel(),a);var d=this;this.listener={onLineStyle:function(a){d.onLineStyle(a)},onDestroy:function(a){d.onDestroy(a)},
...
g[h];i.style.styleClass==="cm-error"&&d.push(p.AnnotationType.createAnnotation("orion.annotation.highlightError",i.start,i.end))}for(a=b.getAnnotations(f.getLineStart(a),f.getLineEnd(a));a.hasNext();)f=a.next(),f.type==="orion.annotation.highlightError"&&c.push(f);b.replaceAnnotations(c,d)}}},onHighlight:function(b){this.textView.redrawLines(b.start,b.end)},onDestroy:function(){this.destroy()}};return{Mirror:d,ModeApplier:h,CodeMirrorStyler:g}});
define("orion/editor/textMateStyler",["orion/regex"],function(k){function m(c){var d;if(c instanceof Array){d=Array(c.length);for(var f=0;f<c.length;f++)d[f]=m(c[f])}else for(f in d={},c)if(Object.prototype.hasOwnProperty.call(c,f)){var h=c[f];d[f]=typeof h==="object"&&h!==null?m(h):h}return d}function p(c,d,f){this.initialize(c);this.grammar=m(d);this.externalGrammars=f?m(f):[];this._styles={};this._tree=null;this._allGrammars={};this.preprocess(this.grammar)}var i={unsupported:[{regex:/\(\?[ims\-]:/,
func:function(){return"option on/off for subexp"}},{regex:/\(\?<([=!])/,func:function(c){return c[1]==="="?"lookbehind":"negative lookbehind"}},{regex:/\(\?>/,func:function(){return"atomic group"}}],toRegExp:function(c){function d(b,a){throw Error('Unsupported regex feature "'+b+'": "'+a[0]+'" at index: '+a.index+" in "+a.input);}var f="",h,c=i.processGlobalFlag("x",c,function(b){for(var a="",c=!1,d=b.length,f=0;f<d;){var g=b.charAt(f);if(!c&&g==="#")for(;f<d&&g!=="\r"&&g!=="\n";)g=b.charAt(++f);
else if(!c&&/\s/.test(g))for(;f<d&&/\s/.test(g);)g=b.charAt(++f);else g==="\\"?(a+=g,/\s/.test(b.charAt(f+1))||(a+=b.charAt(f+1),f+=1)):(g==="["?c=!0:g==="]"&&(c=!1),a+=g),f+=1}return a}),c=i.processGlobalFlag("i",c,function(b){f+="i";return b});for(h=0;h<this.unsupported.length;h++){var g;(g=this.unsupported[h].regex.exec(c))&&d(this.unsupported[h].func(g),g)}return RegExp(c,f)},processGlobalFlag:function(c,d,f){function h(b,a){for(var c=0,d=b.length,f=-1,g=a;g<d&&f===-1;g++)switch(b.charAt(g)){case "\\":g++;
break;case "(":c++;break;case ")":c--,c===0&&(f=g)}return f}var g="(?"+c+")",c="(?"+c+":";if(d.substring(0,g.length)===g)return f(d.substring(g.length));else if(d.substring(0,c.length)===c){g=h(d,0);if(g<d.length-1)throw Error("Only a "+c+") group that encloses the entire regex is supported in: "+d);return f(d.substring(c.length,g))}return d},hasBackReference:function(c){return/\\\d+/.test(c.source)},getSubstitutedRegex:function(c,d,f){for(var f=typeof f==="undefined"?!0:!1,c=c.source.split(/(\\\d+)/g),
h=[],g=0;g<c.length;g++){var b=c[g],a=/\\(\d+)/.exec(b);a?(b=d[a[1]]||"",h.push(f?k.escape(b):b)):h.push(b)}return RegExp(h.join(""))},groupify:function(c,d){for(var f=c.source,h=f.length,g=[],b=0,a=[],e=1,i=1,k=[],m={},p={},n=0;n<h;n++){var s=g[g.length-1],u=f.charAt(n);switch(u){case "(":if(s===4)g.pop(),k.push(")"),a[a.length-1].end=n;var t=n+2<h?f.charAt(n+1)+""+f.charAt(n+2):null;if(t==="?:"||t==="?="||t==="?!"){var v;t==="?:"?v=1:(v=3,b++);g.push(v);a.push({start:n,end:-1,type:v});k.push(u);
k.push(t);n+=t.length}else g.push(2),a.push({start:n,end:-1,type:2,oldNum:e,num:i}),k.push(u),b===0&&(p[i]=null),m[e]=i,e++,i++;break;case ")":s=g.pop();s===3&&b--;a[a.length-1].end=n;k.push(u);break;case "*":case "+":case "?":case "}":var j=u,w=f.charAt(n-1),t=n-1;if(u==="}"){for(v=n-1;f.charAt(v)!=="{"&&v>=0;v--);w=f.charAt(v-1);t=v-1;j=f.substring(v,n+1)}v=a[a.length-1];if(w===")"&&(v.type===2||v.type===4)){k.splice(v.start,0,"(");k.push(j);k.push(")");u={start:v.start,end:k.length-1,type:4,num:v.num};
for(w=0;w<a.length;w++)if(s=a[w],(s.type===2||s.type===4)&&s.start>=v.start&&s.end<=t)if(s.start+=1,s.end+=1,s.num+=1,s.type===2)m[s.oldNum]=s.num;a.push(u);i++;break}default:u!=="|"&&s!==2&&s!==4&&b===0&&(g.push(4),a.push({start:n,end:-1,type:4,num:i}),k.push("("),p[i]=null,i++),k.push(u),u==="\\"&&(u=f.charAt(n+1),k.push(u),n+=1)}}for(;g.length;)g.pop(),k.push(")");var f=RegExp(k.join("")),h={},d=d||m,x;for(x in d)d.hasOwnProperty(x)&&(h[x]="\\"+d[x]);f=this.getSubstitutedRegex(f,h,!1);return[f,
m,p]},complexCaptures:function(c){if(!c)return!1;for(var d in c)if(c.hasOwnProperty(d)&&d!=="0")return!0;return!1}};p.prototype={initialize:function(c){this.textView=c;this.textView.stylerOptions=this;var d=this;this._listener={onModelChanged:function(c){d.onModelChanged(c)},onDestroy:function(c){d.onDestroy(c)},onLineStyle:function(c){d.onLineStyle(c)},onStorage:function(c){d.onStorage(c)}};c.addEventListener("ModelChanged",this._listener.onModelChanged);c.addEventListener("Destroy",this._listener.onDestroy);
...
!d)throw Error("Couldn't find included rule "+c+" in grammar repository");}else if(c==="$self")d=this.grammar;else if(c==="$base")throw Error('Include "$base" is not supported');else if(d=this._allGrammars[c],!d)for(var f=0;f<this.externalGrammars.length;f++){var h=this.externalGrammars[f];if(h.scopeName===c){this.preprocess(h);d=this._allGrammars[c]=h;break}}}return d},ContainerNode:function(){function c(c,f){this.parent=c;this.rule=f;this.children=[];this.end=this.start=null}c.prototype.addChild=
function(c){this.children.push(c)};c.prototype.valueOf=function(){var c=this.rule;return"ContainerNode { "+(c.include||"")+" "+(c.name||"")+(c.comment||"")+"}"};return c}(),BeginEndNode:function(){function c(c,f,h){this.parent=c;this.rule=f;this.children=[];this.setStart(h);this.endMatch=this.end=null;this.endRegexSubstituted=f.endRegexHasBackRef?i.getSubstitutedRegex(f.endRegex,h):null}c.prototype.addChild=function(c){this.children.push(c)};c.prototype.getIndexInParent=function(){return this.parent?
...
"}"};return c}(),push:function(c,d){if(d)for(var f=d.length;f>0;)c.push(d[--f])},exec:function(c,d,f){(d=c.exec(d))&&(d.index+=f);c.lastIndex=0;return d},afterMatch:function(c){return c.index+c[0].length},getEndMatch:function(c,d,f){if(c instanceof this.BeginEndNode){var h=c.rule,c=c.endRegexSubstituted||h.endRegex;return!c?null:this.exec(c,d,f)}return null},initialParse:function(){this.textView.getModel().getCharCount();this._tree=new this.ContainerNode(null,this.grammar._typedRule);this.parse(this._tree,
!1,0)},onModelChanged:function(c){var d=c.addedCharCount,f=c.removedCharCount,c=c.start;if(this._tree){var h=this.textView.getModel(),g=h.getCharCount(),h=h.getLineEnd(h.getLineAtOffset(c)-1),b=this.getFirstDamaged(h,h),h=h===-1?0:h,d=b?this.parse(b,!0,h,c,d,f):g;this.textView.redrawRange(h,d)}else this.initialParse()},getFirstDamaged:function(c,d){if(c<0)return this._tree;for(var f=[this._tree],h=null;f.length;){var g=f.pop();if(!g.parent||this.isDamaged(g,c,d)){g instanceof this.BeginEndNode&&(h=
g);for(var b=0;b<g.children.length;b++)f.push(g.children[b])}}return h||this._tree},isDamaged:function(c,d,f){return c.start<=f&&c.end>d},parse:function(c,d,f,h,g,b){var a=this.textView.getModel(),e=a.getLineStart(a.getLineCount()-1),i=a.getCharCount(),k=this.getInitialExpected(c,f),m=-1;if(d)c.repaired=!0,c.endNeedsUpdate=!0,m=(m=c.children[c.children.length-1])?a.getLineEnd(a.getLineAtOffset(m.end+(g-b))):-1,h=a.getLineEnd(a.getLineAtOffset(h+b)),m=Math.max(m,h);for(var m=m===-1?i:m,h=k,p=c,n=!1,
s=f,u=-1;p&&(!d||s<m);){var t=this.getNextMatch(a,p,s);t||(s=s>=e?i:a.getLineStart(a.getLineAtOffset(s)+1));var v=t&&t.match,j=t&&t.rule,w=t&&t.isEnd;if(t&&t.isSub){if(s=this.afterMatch(v),j instanceof this.BeginEndRule)n=!0,d&&j===h.rule&&p===h.parent?(p=h,p.setStart(v),p.repaired=!0,p.endNeedsUpdate=!0,h=this.getNextExpected(h,"begin")):(d&&(this.prune(p,h),d=!1),v=new this.BeginEndNode(p,j,v),p.addChild(v),p=v)}else if(w||s===i){if(p instanceof this.BeginEndNode)v?(n=!0,u=Math.max(u,p.end),p.setEnd(v),
s=this.afterMatch(v),d&&p===h&&p.parent===h.parent?(p.repaired=!0,delete p.endNeedsUpdate,h=this.getNextExpected(h,"end")):d&&(this.prune(p,h),d=!1)):(p.setEnd(i),delete p.endNeedsUpdate);p=p.parent}d&&s>=m&&!n&&(this.prune(c,k),d=!1)}this.removeUnrepairedChildren(c,d,f);this.cleanup(d,c,f,m,i,g,b);return d?Math.max(u,s):s},removeUnrepairedChildren:function(c,d,f){if(d){for(var d=c.children,h=-1,g=0;g<d.length;g++){var b=d[g];if(!b.repaired&&this.isDamaged(b,f,Number.MAX_VALUE)){h=g;break}}if(h!==
-1)c.children.length=h}},cleanup:function(c,d,f,h,g,b,a){if(c){c=b-a;g=this.getIntersecting(h-c+1,g);d=this.getIntersecting(f,h);for(f=0;f<g.length;f++)h=g[f],!h.repaired&&h instanceof this.BeginEndNode&&(h.shiftEnd(c),h.shiftStart(c));for(f=0;f<d.length;f++)h=d[f],h.repaired&&h.endNeedsUpdate&&h.shiftEnd(c),delete h.endNeedsUpdate,delete h.repaired}else{d=this.getIntersecting(f,h);for(f=0;f<d.length;f++)delete d[f].repaired}},getNextMatch:function(c,d,f,h){var g=c.getLineAtOffset(f),g=c.getLineEnd(g),
b=c.getText(f,g),a=[],e=[],c=[],g=[];for(this.push(a,d.rule.subrules);a.length;){var i=a.length?a.pop():null,i=i&&i._resolvedRule._typedRule;if(i instanceof this.ContainerRule&&e.indexOf(i)===-1)e.push(i),this.push(a,i.subrules);else if(!i||!h||i.matchRegex){var k=i&&this.exec(i.matchRegex||i.beginRegex,b,f);k&&(c.push(k),g.push(i))}}a=Number.MAX_VALUE;e=-1;for(i=0;i<c.length;i++)if(k=c[i],k.index<a)a=k.index,e=i;if(!h&&(f=this.getEndMatch(d,b,f)))if(h=d.rule.applyEndPatternLast,e===-1||f.index<a||
!h&&f.index===a)return{isEnd:!0,rule:d.rule,match:f};return e===-1?null:{isSub:!0,rule:g[e],match:c[e]}},getInitialExpected:function(c,d){var f,h;if(c===this._tree)for(f=0;f<c.children.length;f++){if(h=c.children[f],h.start>=d)return h}else if(c instanceof this.BeginEndNode&&c.endMatch){var g=c.endMatch.index;for(f=0;f<c.children.length;f++)if(h=c.children[f],h.start>=d)break;if(h&&h.start<g)return h}return c},getNextExpected:function(c,d){if(d==="begin"){var f=c.children[0];return f?f:c}else if(d===
"end"&&(f=c.parent)){var h=f.children[f.children.indexOf(c)+1];return h?h:f}return null},prune:function(c,d){if(d.parent===c)c.children.length=d.getIndexInParent();else if(c instanceof this.BeginEndNode)c.endMatch=null,c.end=null;if(c.parent)c.parent.children.length=c.getIndexInParent()+1},onLineStyle:function(c){this._tree||this.initialParse();var d=c.lineStart,f=this.textView.getModel(),h=f.getLineEnd(c.lineIndex),g=f.getLineEnd(f.getLineAtOffset(d)-1),g=this.getFirstDamaged(g,g),d=this.getLineScope(f,
g,d,h);c.ranges=this.toStyleRanges(d);c.ranges.sort(function(b,a){return b.start-a.start})},getLineScope:function(c,d,f,h){for(var g=f,b=this.getInitialExpected(d,f),a=[],e=[];d&&g<h;){var i=this.getNextMatch(c,d,g);if(!i)break;var k=i&&i.match,m=i&&i.rule,p=i&&i.isSub,i=i&&i.isEnd;k.index!==g&&e.push({start:g,end:k.index,node:d});if(p)g=this.afterMatch(k),m instanceof this.BeginEndRule?(this.addBeginScope(a,k,m),d=b,b=this.getNextExpected(b,"begin")):this.addMatchScope(a,k,m);else if(i)g=this.afterMatch(k),
this.addEndScope(a,k,m),b=this.getNextExpected(b,"end"),d=d.parent}g<h&&e.push({start:g,end:h,node:d});c=this.getInheritedLineScope(e,f,h);return a.concat(c)},getInheritedLineScope:function(c){for(var d=[],f=0;f<c.length;f++)for(var h=c[f],g=h.node;g;){var b=g.rule.rule,a=b.name;if(b=b.contentName||a){this.addScopeRange(d,h.start,h.end,b);break}g=g.parent}return d},addBeginScope:function(c,d,f){var h=f.rule;this.addCapturesScope(c,d,h.beginCaptures||h.captures,f.isComplex,f.beginOld2New,f.beginConsuming)},
addEndScope:function(c,d,f){var h=f.rule;this.addCapturesScope(c,d,h.endCaptures||h.captures,f.isComplex,f.endOld2New,f.endConsuming)},addMatchScope:function(c,d,f){var h=f.rule,g=h.name;(h=h.captures)?this.addCapturesScope(c,d,h,f.isComplex,f.matchOld2New,f.matchConsuming):this.addScope(c,d,g)},addScope:function(c,d,f){f&&c.push({start:d.index,end:this.afterMatch(d),scope:f})},addScopeRange:function(c,d,f,h){h&&c.push({start:d,end:f,scope:h})},addCapturesScope:function(c,d,f,h,g,b){if(f)if(h){for(var h=
{1:0},a=0,e=1;d[e]!==void 0;e++)b[e]!==void 0&&(a+=d[e].length),d[e+1]!==void 0&&(h[e+1]=a);b=d.index;for(a=1;f[a];a++){var e=f[a].name,i=g[a],k=b+h[i];typeof d[i]!=="undefined"&&this.addScopeRange(c,k,k+d[i].length,e)}}else this.addScope(c,d,f[0]&&f[0].name)},getIntersecting:function(c,d){for(var f=[],h=this._tree?[this._tree]:[];h.length;){var g=h.pop(),b=!1;g instanceof this.ContainerNode?b=!0:this.isDamaged(g,c,d)&&(b=!0,f.push(g));if(b)for(var b=g.children.length,a=0;a<b;a++)h.push(g.children[a])}return f.reverse()},
toStyleRanges:function(c){for(var d=[],f=0;f<c.length;f++){var h=c[f],g=this._styles[h.scope];if(!g)throw Error("styles not found for "+h.scope);g=g.join(" ");d.push({start:h.start,end:h.end,style:{styleClass:g}})}return d}};return{RegexUtil:i,TextMateStyler:p}});
...
new p({start:0,contentStart:0,end:d,contentEnd:d},null,this,c);this._computeFolding(this._rootBlock.getBlocks());b&&this.detectTasks&&(d=[],u(this._rootBlock,c,d),b.replaceAnnotations([],d));a.redrawLines()}var d={styleClass:"meta annotation currentLine"},f=/$/,h=/\\(\d)/g,g=/(.*)(?:[\r\n]|$)/g,b={regex:/ /g,style:{styleClass:"punctuation separator space",unmergeable:!0}},a={regex:/\t/g,style:{styleClass:"punctuation separator tab",unmergeable:!0}},e=function(a,b,c,d){var e=c,f=a.lastIndex;g.lastIndex=
c;var c=g.exec(b),h,i;a.lastIndex=0;if(c){for(i=c.index;0<=--i;)if(h=b.charAt(i),h==="\n"||h==="\r")break;h=b.substring(i+1,c.index+c[1].length);a.lastIndex=i=c.index-i-1}for(;c&&c.index<b.length;){var k;if(d){var l=a.lastIndex;if(a.test(h))a.lastIndex=l,k=a.exec(h)}else k=a.exec(h);if(k)return k.index+=e,k.index-=i,a.lastIndex=f,k;i=0;e+=c[0].length;if(c=g.exec(b))h=c[1],a.lastIndex=0}a.lastIndex=f;return null},l=function(a,b){var c=a.toString();h.lastIndex=0;if(!h.test(c))return a;h.lastIndex=0;
for(var d=h.exec(c);d;)c=c.replace(d[0],b[d[1]]||""),h.lastIndex=0,d=h.exec(c);return RegExp(c.substring(1,c.length-2),"g")},o=function(a,b,c,d){if(b=e(a.pattern.regex?a.pattern.regex:a.pattern.regexBegin,b,d,!0)){a.result=b;for(d=0;d<c.length;d++)if(b.index<c[d].result.index||b.index===c[d].result.index&&a.pattern.pattern.index<c[d].pattern.pattern.index){c.splice(d,0,a);return}c.push(a)}},q=function(a,b,c,d){if(b[0])d.push({start:c,end:c+a[0].length,style:b[0].name});else for(var e=0,f=1;f<a.length;f++)if(a[f]){var g=
b[f];if(g){var h=c+e;d.push({start:h,end:h+a[f].length,style:g.name})}e+=a[f].length}},r=function(a,b,c){var d=a.start;b.forEach(function(b){d<=b.start&&c.push({start:d,end:b.start,style:a.style});c.push(b);d=b.end});d<a.end&&c.push({start:d,end:a.end,style:a.style})},n=function(a,b,c,d,g){if(c=c.getLinePatterns()){var h=[];c.forEach(function(b){var c=b.regex||b.regexBegin;c.oldLastIndex=c.lastIndex;(c=e(c,a,0))&&h.push({result:c,pattern:b})});h.sort(function(a,b){return a.result.index<b.result.index?
-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var i=0;h.length>0;){var k=h[0];h.splice(0,1);if(!(k.result.index<i)){var m=k.result.index,n,p=[];if(k.pattern.regex){i=k.result;n=m+i[0].length;n={start:b+m,end:b+n,style:k.pattern.pattern.name};if(!g){k.pattern.pattern.captures&&q(i,k.pattern.pattern.captures,b+m,p);p.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(m=0;m<p.length-1;m++)if(p[m+1].start<p[m].end){var s={start:p[m+1].end,
end:p[m].end,style:p[m].style};p[m].end=p[m+1].start;p.splice(m+2,0,s)}}r(n,p,d)}else{i=k.pattern.regexEnd;i=l(i,k.result);i=e(i,a,k.result.index+k.result[0].length);if(!i)f.lastIndex=0,i=f.exec(a);n=i.index+i[0].length;d.push({start:b+m,end:b+n,style:k.pattern.pattern.name})}i=i.index+i[0].length}o(k,a,h,i)}c.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},s=function(a,b,c,d){var g=[];c.getBlockPatterns().forEach(function(a){var c=e(a.regexBegin||a.regex,b,0);c&&g.push({result:c,
pattern:a})}.bind(this));if(!g.length)return g;g.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var h=0,i=[];g.length>0;){var k=g[0];g.splice(0,1);if(!(k.result.index<h)){var m=a.getLineAtOffset(d+k.result.index),q=a.getLine(m),r=[];n(q,a.getLineStart(m),c,r);m=d+k.result.index;for(q=0;q<r.length;q++)if(r[q].start===m){var h=k.result.index,s=null,u=k.pattern.regexEnd;if(u){h+=k.result[0].length;
for(var u=l(u,k.result),B=h;!s;){B=e(u,b,B);if(!B)f.lastIndex=0,B=f.exec(b);var E=[],G=new p({start:m,end:d+B.index+B[0].length,contentStart:d+h,contentEnd:d+B.index},k.pattern,c.getStyler(),a,c);n(b.substring(h,B.index+B[0].length),h,G,E);if(!E.length||E[E.length-1].end<=B.index)s=G;B=B.index+B[0].length}}else s=new p({start:m,end:m+k.result[0].length,contentStart:m,contentEnd:m+k.result[0].length},k.pattern,c.getStyler(),a,c);i.push(s);h=s.end-d;break}q===r.length&&(h=k.result.index+1)}o(k,b,g,
h)}return i},u=function(a,b,c){if(a.getAnnotationModel()){var d=k.AnnotationType.ANNOTATION_TASK;if(a.getLinePatterns().length&&a.pattern&&a.pattern.pattern.name&&a.pattern.pattern.name.indexOf("comment")===0){var e=[];n(b.getText(a.contentStart,a.end),a.contentStart,a,e,!0);for(var f=0;f<e.length;f++)e[f].style==="meta.annotation.task.todo"&&c.push(k.AnnotationType.createAnnotation(d,e[f].start,e[f].end,b.getText(e[f].start,e[f].end)))}a.getBlocks().forEach(function(a){u(a,b,c)}.bind(this))}};m.prototype=
...
else if(!c[a.id])a.index=b[0]++,c[a.id]=a}.bind(this));f.forEach(function(a){this._processInclude(a,b,c)}.bind(this))},_NO_ID:"NoID"};p.prototype={adjustEnd:function(a){this.end+=a;this.contentEnd+=a;this._subBlocks.forEach(function(b){b.adjustEnd(a)})},adjustStart:function(a){this.start+=a;this.contentStart+=a;this._subBlocks.forEach(function(b){b.adjustStart(a)})},computeStyle:function(a,b){if(!this.pattern||!(this.start<=b&&b<this.end))return null;var c={start:this.start,end:this.end,style:this.pattern.pattern.name};
...
a)return d}return null},_getPatternManager:function(){return this.patternManager},_getStyles:function(a,b,c,d){b.getBaseModel&&(d=b.mapOffset(d));for(var f=d+c.length,g=[],h=d,i=a.getBlocks(),k=this._binarySearch(i,d,!0);k<i.length;k++){if(i[k].start>=f)break;var l=i[k].start,m=i[k].end;h<l&&n(c.substring(h-d,l-d),h,a,g);var o=Math.max(h,l);if(o===l&&i[k].pattern.regexBegin){var p=e(i[k].pattern.regexBegin,c.substring(o-d),0);if(p){var r=i[k].pattern.pattern.beginCaptures||i[k].pattern.pattern.captures;
r?q(p,r,o,g):g.push({start:o,end:o+p[0].length,style:i[k].pattern.pattern.name});o+=p[0].length}}var l=Math.min(f,m),s=[];if(l===m&&i[k].pattern.regexEnd&&(h=c.substring(l-h-(i[k].end-i[k].contentEnd)),p=e(i[k].pattern.regexEnd,h,0)))(r=i[k].pattern.pattern.endCaptures||i[k].pattern.pattern.captures)?q(p,r,l-p[0].length,s):i[k].pattern.pattern.name&&s.push({start:l-p[0].length,end:l,style:i[k].pattern.pattern.name}),l-=p[0].length;var h=this._getStyles(i[k],b,c.substring(o-d,l-d),o),u=i[k].pattern.pattern.contentName||
i[k].pattern.pattern.name;if(u){var H=o;h.forEach(function(a){a.start-H&&g.push({start:H,end:a.start,style:u});g.push(a);H=a.end});l-H&&g.push({start:H,end:l,style:u})}else g=g.concat(h);g=g.concat(s);h=m}h<f&&n(c.substring(h-d,f-d),h,a,g);if(b.getBaseModel)for(a=0;a<g.length;a++)c=g[a].end-g[a].start,g[a].start=b.mapOffset(g[a].start,!0),g[a].end=g[a].start+c;return g},_isRenderingWhitespace:function(){return this.whitespacesVisible&&(this.tabsVisible||this.spacesVisible)},_onDestroy:function(){this.destroy()},
...
a&&(d--,a++),b.setSelection(a,d))}}},_onModelChanged:function(a){var b=a.start,c=a.removedCharCount,a=a.addedCharCount-c,d=this.view,e=d.getModel(),f=e.getBaseModel?e.getBaseModel():e,c=b+c,g=f.getCharCount(),h=this._rootBlock.getBlocks(),i=h.length,l=f.getLineStart(f.getLineAtOffset(b)),m=this._binarySearch(h,l,!0),n=this._binarySearch(h,c,!1,m-1,i),o;m<i&&h[m].start<=l&&l<h[m].end?(o=h[m].start,o>b&&(o+=a)):o=m===i&&i>0&&g-a===h[i-1].end?h[i-1].start:l;var p;do n<i?(p=h[n].end,p>b&&(p+=a),n+=1):
(n=i,p=g),l=f.getText(o,p),l=s(f,l,this._rootBlock,o);while(l.length&&h.length&&n<i&&l[l.length-1].pattern.pattern.id!==h[n-1].pattern.pattern.id);for(g=m;g<h.length;g++)i=h[g],i.start>b&&i.adjustStart(a),i.start>b&&i.adjustEnd(a);var q=n-m!==l.length;if(!q)for(g=0;g<l.length;g++){var i=h[m+g],r=l[g];if(i.start!==r.start||i.end!==r.end||i.type!==r.type){q=!0;break}}g=[m,n-m].concat(l);Array.prototype.splice.apply(h,g);q&&(g=o,i=p,e!==f&&(g=e.mapOffset(g,!0),i=e.mapOffset(i,!0)),d.redrawRange(g,i));
if(this.annotationModel){d=[];h=[];m=[];o=this.annotationModel.getAnnotations(o,p);for(p=this.foldingEnabled&&f!==e;o.hasNext();)if(i=o.next(),p&&i.type===k.AnnotationType.ANNOTATION_FOLDING){m.push(i);for(g=0;g<l.length;g++)if(i.start===l[g].start&&i.end===l[g].end)break;g===l.length?(d.push(i),i.expand()):(g=i.start,n=i.end,g>b&&(g-=a),n>b&&(n-=a),g<=b&&b<n&&g<=c&&c<n&&(g=f.getLineAtOffset(i.start),n=f.getLineAtOffset(i.end),g!==n?i.expanded||i.expand():this.annotationModel.removeAnnotation(i)));
for(g=0;g<l.length;g++){i=l[g];for(n=0;n<m.length;n++)if(m[n].start===i.start&&m[n].end===i.end)break;n===m.length&&(i=this._createFoldingAnnotation(e,f,i.start,i.end))&&h.push(i)}}else i.type===k.AnnotationType.ANNOTATION_TASK&&d.push(i);if(this.detectTasks)for(g=0;g<l.length;g++)u(l[g],f,h);this.annotationModel.replaceAnnotations(d,h)}},_spliceStyles:function(a,b,c,d){for(var e=a.regex,f=e.lastIndex=0,g=e.exec(c);g;){for(g=d+g.index;f<b.length;){if(g<b[f].end)break;f++}var i={start:g,end:g+1,style:a.style};
if(f<b.length&&b[f].start<=g){var h={start:g+1,end:b[f].end,style:b[f].style};b[f].end=g;b.splice(f+1,0,h);b.splice(f+1,0,i);f+=2}else b.splice(f,0,i),f++;g=e.exec(c)}}};return{TextStyler:c}});
...
m,p,i,c,d,f,h,g,b,a,e,l,o,q,r,n,s,u,t,v,j,w,x,D,y,K){function O(a){var b=a.firstChild;if(b&&b.tagName==="TEXTAREA")return b.value;var c=a.ownerDocument,d=c.defaultView||c.parentWindow,e;if(!(e=!d.getSelection)){if(!(b=a.childNodes.length===1&&b.nodeType===Node.TEXT_NODE)){for(var f,b=a;b&&b!==c&&f!=="none";)f=d.getComputedStyle?d.getComputedStyle(b,null).getPropertyValue("display"):b.currentStyle.display,b=b.parentNode;b=f==="none"}e=b}if(e)return a.innerText||a.textContent;c=c.createRange();c.selectNode(a);
a=d.getSelection();d=[];for(f=0;f<a.rangeCount;f++)d.push(a.getRangeAt(f));a.removeAllRanges();a.addRange(c);c=a.toString();a.removeAllRanges();for(f=0;f<d.length;f++)a.addRange(d[f]);return c}function P(a){if(a.substring(0,12)==="data-editor-")return a=a.substring(12),a=a.replace(/-([a-z])/ig,function(a,b){return b.toUpperCase()})}function M(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}function Q(a,b){var c={};M(c,b);for(var d,e=0,f=a.attributes,g=f.length;e<g;e++){d=f.item(e);var i=P(d.nodeName);
if(i){d=d.nodeValue;if(d==="true"||d==="false")d=d==="true";c[i]=d}}return c}function R(a,b){if(a.getElementsByClassName)return a.getElementsByClassName(b);b=b.replace(/ *$/,"");return a.querySelectorAll?a.querySelectorAll((" "+b).replace(/ +/g,".")):null}function B(a){var b=a.document||document,e=a.parent;e||(e="editor");typeof e==="string"&&(e=b.getElementById(e));if(!e&&a.className&&(b=R(b,a.className))){a.className=void 0;if(b.length>1&&a.noFocus===void 0)a.noFocus=!0;for(var f=[],g=b.length-
...
void 0||a.showFoldingRuler)}}).highlight(a.contentType||a.lang,l);if(j){var m=new n.CssContentAssistProvider,t=new s.HTMLContentAssistProvider,v=new u.JSTemplateContentAssistProvider;j.addEventListener("Activating",function(){/css$/.test(a.lang)?j.setProviders([m]):/js$/.test(a.lang)?j.setProviders([v]):/html$/.test(a.lang)&&j.setProviders([t])})}if(e.clientHeight<=50)f=l.getTextView().computeSize().height,e.style.height=f+"px";return l}var E=this.orion?this.orion.editor:void 0;if(E)for(var G=0;G<
